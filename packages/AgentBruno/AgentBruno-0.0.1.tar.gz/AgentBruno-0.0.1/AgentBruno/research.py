...
async def initialize_research(state: ResearchState):
    ...
    direct_gen_outline_prompt = ChatPromptTemplate.from_messages(
        [
            (
                "system",
                "You are a Wikipedia writer. Write an outline for a Wikipedia page about a user-provided topic. The Wikipedia page will be read by consultants and senior executives as insights. You can assume that the topic is related to energy & utility sectors. Be comprehensive and specific.",
            ),
            ("user", f"{topic}"),
        ]
    )
    ...
    gen_related_topics_prompt = ChatPromptTemplate.from_template(
        ...
        I'm looking for examples that provide insights to consultants and executives into interesting aspects specifically associated with this topic, or examples that help me understand the typical content and structure included in Wikipedia pages for similar energy or utility sector related topics.
        Remember Wikipedia page will be read by consultants and senior executives as insights working for energy and utility sector.
...
async def conduct_interviews(state: ResearchState):
    ...
    [
        (
            ...
            Besides your identity as a Wikipedia writer, you have a specific focus when researching the topic. While researching on topic, ask questions related to regulations, policies, standards, challenges, solutions and example related to topic. \
            The Wikipedia page you are writing will be read by consultants and executives as insights working for energy and utility sector. 
    ...
    to write a Wikipedia page on the topic you know. You have gathered the related information and will now use the information to form a response. \
        While responding on topic, consider providing supporting regulations, policies, standards, challenges, solutions and example if any. \
