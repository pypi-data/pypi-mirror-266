#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2024-04-07 21:41:19 (ywatanabe)"
...
################################################################################
PACKAGE_NAME = "numpy_fn"
PACKAGES = find_packages(where="src")
DESCRIPTION = "A decorator for seamless numpy calculations from torch.tensor and pd.DataFrame."
KEYWORDS = ["numpy" "torch", "pandas"]
CLASSIFIERS = [
