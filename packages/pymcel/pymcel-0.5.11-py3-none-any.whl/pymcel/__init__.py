...
#############################################################
def consulta_horizons(id='399',location='@0',epochs=None,datos='vectors',propiedades=None):
    ...
    Opciones:
        ...
        Puede pasarse lista predefinidas así:
            'estado': vector de estado en SI.
            'elementos': elementos orbitales clásicos (a, e, I, W, w, f, M, P, to)
