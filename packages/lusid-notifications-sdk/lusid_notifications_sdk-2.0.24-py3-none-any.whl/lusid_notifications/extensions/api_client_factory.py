...
from lusid_notifications.extensions.retry import (
    RetryingRestWrapper,
...
from lusid_notifications.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    ...
    def build(
        ...
        ----------
        metaclass : Type[T]
            A lusid_notifications.api class.


        Returns
        -------
        T
            An instance of the lusid_notifications.api class with a configured ApiClient
        """
