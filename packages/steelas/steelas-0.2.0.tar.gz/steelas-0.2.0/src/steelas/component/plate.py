...
This module defines the Plate class for representing a structural steel plate, including its dimensions,
material properties, and various capacity calculations based on Australian standards and ASI design handbooks.
"""
...
class Plate():
    ...
    Attributes: Derived Attributes
        ...
        plate_grade (str): Material grade of the plate derived from the `plate` attribute.
        f_ui (int): Ultimate tensile strength of the plate material in MPa.
    ...
    def from_dict(cls, **kwargs):
        """
        Constructs a Plate object from a dictionary of attributes, allowing for dynamic creation
        based on varying specifications. Overrides derived attribute values otherwise calculated in __post_init__.

        Args:
            **kwargs: Arbitrary keyword arguments corresponding to Plate attributes.

        Returns:
            Plate: An initialized Plate object based on the provided attributes.
        """
        o = cls()
    ...
    def from_constr(cls, constructor_str: str) -> Plate:
        """
        Constructs a Plate object from a constructor string that contains a JSON representation
        of the plate's configuration.

        Args:
            constructor_str (str): JSON string representation of the Plate's configuration.

        Returns:
            Plate: An initialized Plate object based on the JSON string.
        """
