...
class KaspadClient(object):
    ...
    async def get_block_dag_info(self):
        ...
        :return:
        """
        return await self.request("getBlockDagInfoRequest", "", "getBlockDagInfoResponse")
    ...
    async def get_current_network(self):
        ...
        :return:
        """
        return await self.request("getCurrentNetworkRequest", "", "getCurrentNetworkResponse")
    ...
    async def submit_block(self, block: dict, allow_non_daa_blocks: bool):
        ...
        :return:
        """
        return await self.request("submitBlockRequest",
    ...
    async def get_block_template(self, pay_address: str, extra_data: bool):
        ...
        :return:
        """
        return await self.request("getBlockTemplateRequest",
                                  {"payAddress": pay_address,
                                   "extraData": extra_data}, "getBlockTemplateResponse")
    ...
    async def get_peer_addresses(self):
        ...
        :return:
        """
        return await self.request("getPeerAddressesRequest",
                                  wait_for_response_key="getPeerAddressesResponse")
    ...
    async def get_sink(self):
        ...
        :return:
        """
        return await self.request("getSinkRequest",
                                  wait_for_response_key="getSinkResponse")

    async def get_mempool_entry(self, tx_id: str, include_orphan_pool: bool, filter_transaction_pool: bool):
        """
        ...
        :return:
        """
        return await self.request("getMempoolEntryRequest",
                                  {
                                      "txId": tx_id,
    ...
    async def get_mempool_entries(self, include_orphan_pool: bool, filter_transaction_pool: bool):
        """
        ...
        :return:
        """
        return await self.request("getMempoolEntriesRequest",
                                  {
                                      "includeOrphanPool": include_orphan_pool,
                                      "filterTransactionPool": filter_transaction_pool
                                  },
    ...
    async def get_connected_peer_info(self):
        ...
        :return:
        """
        return await self.request("getConnectedPeerInfoRequest",
    ...
    async def add_peer(self, address: str, is_permanent: bool):
        ...
        :return:
        """
        return await self.request("addPeerRequest",
                                  {
                                      "address": address,
    ...
    async def submit_transaction(self, transaction: dict, allow_orphan: bool = False):
        ...
        :return:
        """
        return await self.request("submitTransactionRequest",
                                  {
                                      "transaction": transaction,
                                      "allowOrphan": allow_orphan
                                  },
    ...
    async def get_block(self, hash: str, include_transactions: bool):
        ...
        :return:
        """
        return await self.request("getBlockRequest",
                                  {
                                      "hash": hash,
    ...
    async def get_subnetwork(self, subnetwork_id: str):
        ...
        :return:
        """
        return await self.request("getSubnetworkRequest",
                                  {
                                      "subnetworkId": subnetwork_id
                                  },
                                  wait_for_response_key="getSubnetworkResponse")

    async def get_virtual_chain_from_block(self, start_hash: str, include_accepted_transaction_ids: bool):
        """
        ...
        :return:
        """
        return await self.request("getVirtualChainFromBlockRequest",
                                  {
    ...
    async def get_blocks(self, low_hash: str, include_blocks: bool, include_transactions: bool):
        """
        ...
        :return:
        """
        return await self.request("getBlocksRequest",
                                  {
                                      "lowHash": low_hash,
    ...
    async def get_block_count(self):
        ...
        :return:
        """
        return await self.request("getBlockCountRequest",
                                  wait_for_response_key="getBlockCountResponse")
    ...
    async def get_headers(self, start_hash: str, limit: int, is_ascending: bool):
        ...
        :return:
        """
        return await self.request("getHeadersRequest",
                                  {
                                      "startHash": start_hash,
                                      "limit": limit,
    ...
    async def get_utxos_by_addresses(self, addresses: list[str]):
        ...
        :return:
        """
        return await self.request("getUtxosByAddressesRequest",
                                  {
                                      "addresses": addresses
                                  },
    ...
    async def get_balance_by_address(self, address: str):
        ...
        :return:
        """
        return await self.request("getBalanceByAddressRequest",
                                  {
                                      "address": address
                                  },
    ...
    async def get_balances_by_addresses(self, addresses: list[str]):
        ...
        :return:
        """
        return await self.request("getBalancesByAddressesRequest",
                                  {
                                      "addresses": addresses
                                  },
    ...
    async def get_sink_blue_score(self):
        ...
        :return:
        """
        return await self.request("getSinkBlueScoreRequest",
                                  wait_for_response_key="getSinkBlueScoreResponse")
    ...
    async def ban(self, ip: str):
        ...
        :return:
        """
        return await self.request("banRequest",
                                  {"ip": ip},
                                  wait_for_response_key="banResponse")
    ...
    async def get_info(self):
        ...
        :return:
        """
        return await self.request("getInfoRequest",
                                  wait_for_response_key="getInfoResponse")
    ...
    async def get_coin_supply(self):
        ...
        :return:
        """
        return await self.request("getCoinSupplyRequest",
                                  wait_for_response_key="getCoinSupplyResponse")
    ...
    async def ping(self):
        ...
        return await self.request("pingRequest",
                                  wait_for_response_key="pingResponse")
    ...
    async def get_server_info(self):
        ...
        :return:
        """
        return await self.request("getServerInfoRequest",
                                  wait_for_response_key="getServerInfoResponse")
    ...
    async def get_sync_status(self):
        ...
        :return:
        """
        return await self.request("getSyncStatusRequest",
                                  wait_for_response_key="getSyncStatusResponse")
