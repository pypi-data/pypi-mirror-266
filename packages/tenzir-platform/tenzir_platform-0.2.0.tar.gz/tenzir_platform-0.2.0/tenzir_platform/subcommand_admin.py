"""Usage:
  ...
  tenzir-platform admin create-workspace <workspace_name> --owner=<str> [--owner-namespace=str] [--name=<str>]
...
Options:
  ...
  --owner       The owner id of the new workspace owner
  --owner-namespace The namespace for the owner id [default: user]
"""
