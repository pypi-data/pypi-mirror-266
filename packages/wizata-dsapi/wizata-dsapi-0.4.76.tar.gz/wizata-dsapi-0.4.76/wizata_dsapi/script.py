    ...
    def copy(self, myfunction):
        ...
        for line in inspect.getsourcelines(myfunction)[0]:
            ...
            if line.startswith("from ") or line.startswith("import "):
                parts = list_to_dict_odds(line.split())
                if 'import' not in parts:
                    raise ValueError(f'from/import statement missing import {line}')
                definition = {}
                if 'from' in parts:
                    definition['module'] = parts['from']
                    definition['class'] = parts['import']
                    if 'as' in parts:
                        definition['var'] = parts['as']
                    else:
                        definition['var'] = parts['import']
                else:
                    definition['module'] = parts['import']
                    if 'as' in parts:
                        definition['var'] = parts['as']
                    else:
                        definition['var'] = parts['import']
