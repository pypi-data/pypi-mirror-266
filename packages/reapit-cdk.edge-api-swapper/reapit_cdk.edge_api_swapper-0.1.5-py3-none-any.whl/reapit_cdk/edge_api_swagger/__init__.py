...
class EdgeAPISwaggerEndpoint(
    ...
    def endpoint(self) -> _reapit_cdk_edge_api_55b0061f.FrontendEndpoint:
        return typing.cast(_reapit_cdk_edge_api_55b0061f.FrontendEndpoint, jsii.get(self, "endpoint"))

    @endpoint.setter
    def endpoint(self, value: _reapit_cdk_edge_api_55b0061f.FrontendEndpoint) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__674257f0e7fa4381d84acddffbbccb1f21fa05ea809bd54e47ab7b22d3a89602)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__674257f0e7fa4381d84acddffbbccb1f21fa05ea809bd54e47ab7b22d3a89602(
    value: _reapit_cdk_edge_api_55b0061f.FrontendEndpoint,
) -> None:
    """Type checking stubs"""
    pass
