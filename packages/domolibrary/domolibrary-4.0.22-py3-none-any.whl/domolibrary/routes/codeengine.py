...
# %% auto 0
__all__ = ['CodeEngine_Package_Parts', 'remove_javascript_comments', 'parse_javascript_before_functions',
...
def parse_javascript_before_functions(code):
    code = remove_javascript_comments(code)
    pattern = r"(.*?)(?=(static\s)?async?\s*function)"
