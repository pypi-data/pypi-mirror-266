...
class GENERATOR():
    ...
    def create_pose_video_from_MP(self,img_centre,min_size,FPS,pose_tensor,GAN_model):
        ...
        crops,maps=[],[]
        for i, input_frame in enumerate(reader):
            ...
            MP_results = copy.deepcopy(pose_tensor[i])  
            ...
            heat_maps, hand_crops = HEATMAPS().get_heatmaps_crops(input_frame=input_frame,
                                                                ...
                                                                opt=self.args.opt,
                                                                iii=i,
                                                                hand_mask= hand_mask[i],
                                                                face_mask= face_mask[i]
                                                                )
            ...
            if i==0 and (self.args.opt.num_frames)>0:
