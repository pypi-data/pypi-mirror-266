...
def parallel_computing(input_video_path,NUM_WORKERS,img_centre, min_size, opt):
    ...
    reader.close()
    return pose_tensor[NUM_WORKERS:],MP_scales[NUM_WORKERS:], MP_centres[NUM_WORKERS:], i+1
...
def serial_computing(input_video_path, img_centre, min_size, opt):
    ...
    reader.close()
    return pose_tensor,MP_scales, MP_centres, i+1
