...
class UserApiMixin:
    ...
    def get_user_data(self, user_id, api_version="v1"):
        ...
        url = "{endpoint}/{version}/{tenant}/users/{user}".format(
    ...
    def change_user_password(
        ...
        url = "{endpoint}/{version}/{tenant}/users/{user}/password".format(
            endpoint=self.user_api_url,
    ...
    def get_users_password_policy(self):
        ...
        url = "{endpoint}/{version}/{tenant}/users/password_policy".format(
            endpoint=self.user_api_url,
            version=self.version,
            tenant=self.tenant,
        )
    ...
    def new_grant(self, user_id, type, for_client_id=None, project_permissions=None):
        ...
        url = "{ep}/{version}/{tenant}/users/{user}/grants".format(
            ep=self.user_api_url,
            version=self.version,
            tenant=self.tenant,
            user=user_id,
    ...
    def get_users(self, include_config=None):
        ...
        url = "{ep}/{version}/{tenant}/users".format(
            ep=self.user_api_url,
            version=self.version,
            tenant=self.tenant,
        )
    ...
    def delete_user(self, user_id):
        ...
        """
        url = "{ep}/{version}/{tenant}/users/{user_id}".format(
            ep=self.user_api_url,
            version=self.version,
            tenant=self.tenant,
            user_id=user_id,
    ...
    def get_groups(self):
        ...
        """
        url = "{ep}/{version}/{tenant}/groups".format(
            ep=self.user_api_url,
            version=self.version,
            tenant=self.tenant,
        )
    ...
    def get_group(self, group_id):
        ...
        """
        url = "{ep}/{version}/{tenant}/groups/{group}".format(
            ep=self.user_api_url,
            version=self.version,
            tenant=self.tenant,
            group=group_id,
