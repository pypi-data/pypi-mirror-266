...
def main():
    parser = argparse.ArgumentParser(description="Get an API Key for advcalc")
    subparsers = parser.add_subparsers(title="Subcommands", dest="command", required=True)

    # Subcommand: getapi
    parser_getapi = subparsers.add_parser("getapi", help="Fetch API")
    parser_getapi.set_defaults(func=get_api)

    args = parser.parse_args()
    args.func()  # Call the function associated with the subcommand
