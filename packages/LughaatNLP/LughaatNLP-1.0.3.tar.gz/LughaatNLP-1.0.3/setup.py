...
setup(
    ...
    package_data={'LughaatNLP': ['Urdu_Lemma.json', 'stopwords.json', 'tokenizer.json']},
    entry_points={
        'console_scripts': [
    ...
    description='A Python package for natural language processing tasks for the Urdu language, including stemming, lemmatization, tokenization, and stopword removal.',
