...
if 'PYZMQ_BACKEND' in os.environ:
    ...
    if platform.python_implementation() == 'PyPy':
        first, second = ('secvision_bindeps.zmq.backend.cffi', 'secvision_bindeps.zmq.backend.cython')
    else:
        first, second = ('secvision_bindeps.zmq.backend.cython', 'secvision_bindeps.zmq.backend.cffi')
