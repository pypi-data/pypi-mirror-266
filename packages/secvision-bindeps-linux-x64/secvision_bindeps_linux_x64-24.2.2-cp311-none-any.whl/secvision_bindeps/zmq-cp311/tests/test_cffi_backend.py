...
from secvision_bindeps.zmq.tests import BaseZMQTestCase, SkipTest

try:
    from secvision_bindeps.zmq.backend.cffi import (
        zmq_version_info,
        PUSH, PULL, IDENTITY,
        REQ, REP, POLLIN, POLLOUT,
    )
    from secvision_bindeps.zmq.backend.cffi._cffi import ffi, C
