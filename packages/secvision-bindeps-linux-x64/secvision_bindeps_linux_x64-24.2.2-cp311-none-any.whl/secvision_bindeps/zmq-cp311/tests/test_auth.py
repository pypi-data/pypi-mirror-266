...
import secvision_bindeps.zmq.auth
from secvision_bindeps.zmq.auth.thread import ThreadAuthenticator

from secvision_bindeps.zmq.utils.strtypes import u
from secvision_bindeps.zmq.tests import BaseZMQTestCase, SkipTest, skip_pypy
...
class TestIOLoopAuthentication(BaseAuthTestCase):
    ...
    def make_auth(self):
        from secvision_bindeps.zmq.auth.ioloop import IOLoopAuthenticator
