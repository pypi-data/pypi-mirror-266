...
from secvision_bindeps.zmq import devices
from secvision_bindeps.zmq.tests import BaseZMQTestCase, SkipTest, have_gevent, GreenTest, PYPY
...
if have_gevent:
    import gevent
    import secvision_bindeps.zmq.green
