...
zmq = importlib.import_module('secvision_bindeps.zmq')
from secvision_bindeps.zmq.backend import Socket as SocketBase
from .poll import Poller
from . import constants
from .attrsettr import AttributeSetter
from secvision_bindeps.zmq.error import ZMQError, ZMQBindError
from secvision_bindeps.zmq.utils import jsonapi
from secvision_bindeps.zmq.utils.strtypes import bytes, unicode, basestring
...
class Socket(SocketBase, AttributeSetter):
    ...
    def shadow(cls, address):
        ...
        .. versionadded:: 14.1
        """
        from secvision_bindeps.zmq.utils.interop import cast_int_addr
