...
..
    ...
    import secvision_bindeps.zmq.green as zmq
...
from secvision_bindeps.zmq.green.core import _Context, _Socket
from secvision_bindeps.zmq.green.poll import _Poller
Context = _Context
Socket = _Socket
Poller = _Poller

from secvision_bindeps.zmq.green.device import device
