...
try:
    import asyncio
    import secvision_bindeps.zmq.asyncio as zaio
    from secvision_bindeps.zmq.auth.asyncio import AsyncioAuthenticator
except ImportError:
...
from secvision_bindeps.zmq.tests.test_auth import TestThreadAuthentication
