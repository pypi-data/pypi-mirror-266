...
public:
    ...
    {
        static_assert(( offsetof( WebsocketHeaderUpdate,m_WebsocketHeaderUpdate_mask) + 0 ) == 16 );
    ...
    {
        static_assert( offsetof( WebsocketHeaderUpdate,m_value ) == 8 );
        static_assert( alignof( std::string ) == 8 );
        static_assert( sizeof( std::string ) == 8 );
...
private:
    ...
    {
        static_assert( offsetof( WebsocketHeaderUpdate, m_WebsocketHeaderUpdate_mask ) == 16 );
    }
};
