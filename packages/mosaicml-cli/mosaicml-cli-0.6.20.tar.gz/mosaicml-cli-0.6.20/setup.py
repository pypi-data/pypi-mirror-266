...
install_requires = [
    'argcomplete>=2.0.0', 'arrow>=1.2.2', 'backoff>=2.2.1', 'gql[websockets]>=3.4.0', 'prompt_toolkit>=3.0.29',
    'protobuf>=3.20.0', 'pyyaml>=5.4.1', 'questionary>=1.10.0', 'rich>=12.6.0', 'ruamel.yaml>=0.17.21',
    'typing_extensions>=4.0.1', 'validators>=0.20.0', 'requests>=2.26.0,<3', 'urllib3>=1.23', 'numpy',
    'termcolor>=1.1.0'
]
