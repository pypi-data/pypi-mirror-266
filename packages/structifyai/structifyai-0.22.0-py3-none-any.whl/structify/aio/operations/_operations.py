...
from ...operations._operations import (
    ...
    build_dataset_query_request,
    build_dataset_structureasync_request,
    build_dataset_structuresync_request,
...
class DatasetOperations:
    ...
    async def query(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
    ...
    async def structureasync(self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any) -> Any:
        """Adds a data source to a given dataset.
    ...
    async def structuresync(self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any) -> Any:
        """Adds a data source to a given dataset.
