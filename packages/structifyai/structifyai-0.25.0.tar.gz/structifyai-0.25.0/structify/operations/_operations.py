...
def build_dataset_query_request(**kwargs: Any) -> HttpRequest:
    # Construct URL
    _url = "/dataset/query"
...
def build_dataset_structureasync_request(*, dataset_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_dataset_structuresync_request(*, dataset_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DatasetOperations:
    ...
    def query(self, **kwargs: Any) -> None:  # pylint: disable=inconsistent-return-statements
        """Query a dataset using conventional mechanisms like filter.
        ...
        _request = build_dataset_query_request(
            headers=_headers,
            params=_params,
        )
        _request.url = self._client.format_url(_request.url)
    ...
    def structureasync(
        ...
        """Adds a data source to a given dataset.
    ...
    def structureasync(self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any) -> Any:
        """Adds a data source to a given dataset.
        ...
        _request = build_dataset_structureasync_request(
    ...
    def structuresync(self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any) -> Any:
        """Adds a data source to a given dataset.
        ...
        _request = build_dataset_structuresync_request(
            dataset_name=dataset_name,
            content_type=content_type,
            json=_json,
            content=_content,
