...
from tg.plugin_models import PluginConfig
...
class BotMessages(BaseModel):
    ...
    bot_help: str = "For details visit https://pypi.org/project/fei-crypto"
...
def setup_mongo(client):
    ...
    if not mycol.find_one({"_id": 0}):
        mycol.insert_one({"_id": 0, "author": "tg", "config": Config().dict()})
...
MONGO_DB_NAME = os.getenv("MONGO_DB_NAME", "tg-config")
MONGO_COL_NAME = os.getenv("MONGO_COL_NAME", "tg-instance-0")
