...
class TextEncoderFactory:
    ...
    @classmethod
    def get_text_encoder(
        cls, text_encoder_type: str, text_encoder_name_or_path: Union[str, os.PathLike], **text_encoder_args: dict
    ) -> PreTrainedModel:
        ...
        try:
            return TEXT_ENCODER_MAPPING[text_encoder_type].get_text_encoder(text_encoder_name_or_path, subfolder)
            ...
            try:
                ...
                return AutoModel.from_pretrained(text_encoder_name_or_path)
