...
class LLMProxyPostDatasetLogsRequest(BaseModel):
    """
    LLMProxyPostDatasetLogsRequest
    """ # noqa: E501
    log_names: Optional[List[StrictStr]] = Field(default=None, alias="logNames")
    __properties: ClassVar[List[str]] = ["logNames"]
