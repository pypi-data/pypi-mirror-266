...
def csv_to_json(rows: Iterable[Iterable[Any]], headers: Optional[Iterable[Any]] = None, orient: str = 'records') -> Union[List[Dict[str, Any]], Dict[str, Any]]:
    """
    Convert CSV data to JSON format.

    Args:
        rows (Iterable[Iterable[Any]]): An iterable of iterables containing the CSV data rows.
        headers (Optional[Iterable[Any]]): An optional iterable containing the CSV headers.
    ...
    Raises:
        ValueError: If the 'orient' value is invalid.
...
def json_to_csv(data: Union[List[Dict[str, Any]], Dict[str, Any]], headers: Optional[Iterable[Any]] = None, output_path: Optional[str] = None) -> List[List[Any]]:
    """
    ...
    Args:
        ...
        headers (Optional[Iterable[Any]]): An optional iterable containing the desired CSV headers.
