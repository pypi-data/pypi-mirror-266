...
import dti_tax_core_vsdc_api_client_swagger.models
from dti_tax_core_vsdc_api_client_swagger import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(dti_tax_core_vsdc_api_client_swagger.models, klass)
