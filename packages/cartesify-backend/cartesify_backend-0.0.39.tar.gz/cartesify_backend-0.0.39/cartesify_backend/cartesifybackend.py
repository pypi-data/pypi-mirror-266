    ...
    def handle_advance(self, data, rollups_url):
        ...
        try:
            ...
            if 'cartesify' in json_data:
                ...
                response = requests.request(url=cartesify_data['fetch']['url'], method=cartesify_data['fetch']['options']['method'], headers=cartesify_data['fetch']['options']['headers'], json=cartesify_data['fetch']['options']['body'])
