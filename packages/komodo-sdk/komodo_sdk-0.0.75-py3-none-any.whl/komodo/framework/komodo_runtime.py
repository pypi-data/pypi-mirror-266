...
class KomodoRuntime():
    def __init__(self, **kwargs):
        ...
        self.set_collection(kwargs.get("collection"))
    ...
    def set_collection(self, collection: KomodoCollection):
...
if __name__ == "__main__":
    ...
    runtime = KomodoRuntime(appliance=appliance, agent=agent, config=config)
    print(runtime)
