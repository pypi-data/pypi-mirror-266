...
class _ColorScheme:
    """
    A container class for neurobeam's color scheme

    .. raises:: :class:`SingletonError` if instance already exists, :class:`ImmutableInstanceWarning` if attribute
    ...
    def __setattr__(self, key: Any, value: Any) -> "ColorScheme":
        """
...
class _TerminalScheme:
    """
    A container class for neurobeam's terminal printing color/font scheme
    ...
    def __str__(self):
        return "Scheme for PROBE terminal printing"
    ...
    @property
    def local_progress(self) -> str:
        return self.GREEN

    @property
    def component(self) -> str:
        return self.BOLD + self.UNDERLINE + self.BLUE

    @property
    def adapter(self) -> str:
        return self.BOLD + self.UNDERLINE + self.GREEN

    @property
    def behavior(self) -> str:
        return self.BOLD + self.UNDERLINE + self.ORANGE

    @property
    def global_progress(self) -> str:
        return self.BLUE
...
# instance persistent color scheme
COLORS = _ColorScheme()
