...
class Scifo:
    ...
    def load(self, path: str, mode: Literal['r', 'r+', 'a', 'a'] = 'a') -> None:
        """
        Load the Scifo instance from a file on disk.

        Args:
            path (str): The path to the Scifo file to load.
            mode (Literal['r', 'r+', 'a', 'a'], optional): The mode in which to open the Scifo file.
                Defaults to 'a'.
        """
    ...
    def save(
        ...
        """
        Save the Scifo instance to a file on disk. This includes creating a pyramid of images,
        and writing the pyramid along with metadata to disk.

        Args:
            path (str): The path to save the Scifo file to.
            attrs (dict, optional): Additional attributes to be saved in the Scifo file. Defaults to None.
            ...
            mode (Literal['r+', 'a', 'w', 'w-'], optional): The mode in which to open the Scifo file. Defaults to 'a'.
    ...
    def numpy(self) -> np.ndarray:
        """
        Get a NumPy array representation of the Scifo instance.

        This method returns a copy of the base array of the Scifo instance as a NumPy array.

        Returns:
            np.ndarray: The NumPy array representation of the Scifo instance.
        """
        return np.array(self.array)

    def close(self) -> None:
        """
        Close the Scifo file associated with the Scifo instance.

        This method closes the underlying ZipStore associated with the Scifo instance.
        """
    ...
    def attrs(self) -> dict:
        """
        Get the attributes of the Scifo instance.

        Returns:
            dict: The attributes of the Scifo instance.
        """
        return dict(self.store.attrs)

    def __getitem__(self, key: Union[int, slice]) -> np.ndarray:
        """
        Get an item or a slice from the base array of the Scifo instance.
    ...
    def __setitem__(self, key: Union[int, slice], value: np.ndarray) -> None:
        """
        Set an item or a slice in the base array of the Scifo instance.
    ...
    def __getattr__(self, name: str) -> Any:
        """
        Get a named attribute from the base array of the Scifo instance.
    ...
    def __repr__(self) -> str:
        """
        Get a string representation of the Scifo instance.

        Returns:
            str: The string representation of the Scifo instance.
        """
    ...
    def _save(self,
        ...
        Args:
            path (str): The path to save the Scifo instance to.
            ...
            channel_axis (Optional[int]): The axis representing channels in the array.
            mode (Literal['r+', 'a', 'w', 'w-']): The mode in which to open the Scifo file. Default is 'a'.
            overwrite (bool): Whether to overwrite an existing Scifo file at the same path.
