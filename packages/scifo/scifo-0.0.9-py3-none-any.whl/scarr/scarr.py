...
class Scarr:
    ...
    def load(self, path: str, mode: Literal['r', 'r+', 'a', 'a'] = 'a') -> None:
        """
        Load the Scarr instance from a file on disk.

        Args:
            path (str): The path to the Scarr file to load.
            mode (Literal['r', 'r+', 'a', 'a'], optional): The mode in which to open the Scarr file.
                Defaults to 'a'.
        """
    ...
    def save(
        ...
        """
        Save the Scarr instance to a file on disk. This includes creating a pyramid of images,
        and writing the pyramid along with metadata to disk.

        Args:
            path (str): The path to save the Scarr file to.
            attrs (dict, optional): Additional attributes to be saved in the Scarr file. Defaults to None.
            ...
            mode (Literal['r+', 'a', 'w', 'w-'], optional): The mode in which to open the Scarr file. Defaults to 'a'.
    ...
    def numpy(self) -> np.ndarray:
        """
        Get a NumPy array representation of the Scarr instance.

        This method returns a copy of the base array of the Scarr instance as a NumPy array.

        Returns:
            np.ndarray: The NumPy array representation of the Scarr instance.
        """
        return np.array(self.array)

    def close(self) -> None:
        """
        Close the Scarr file associated with the Scarr instance.

        This method closes the underlying ZipStore associated with the Scarr instance.
        """
    ...
    def attrs(self) -> dict:
        """
        Get the attributes of the Scarr instance.

        Returns:
            dict: The attributes of the Scarr instance.
        """
        return dict(self.store.attrs)

    def __getitem__(self, key: Union[int, slice]) -> np.ndarray:
        """
        Get an item or a slice from the base array of the Scarr instance.
    ...
    def __setitem__(self, key: Union[int, slice], value: np.ndarray) -> None:
        """
        Set an item or a slice in the base array of the Scarr instance.
    ...
    def __getattr__(self, name: str) -> Any:
        """
        Get a named attribute from the base array of the Scarr instance.
    ...
    def __repr__(self) -> str:
        """
        Get a string representation of the Scarr instance.

        Returns:
            str: The string representation of the Scarr instance.
        """
    ...
    def _save(self,
        ...
        Args:
            path (str): The path to save the Scarr instance to.
            ...
            channel_axis (Optional[int]): The axis representing channels in the array.
            mode (Literal['r+', 'a', 'w', 'w-']): The mode in which to open the Scarr file. Default is 'a'.
            overwrite (bool): Whether to overwrite an existing Scarr file at the same path.
