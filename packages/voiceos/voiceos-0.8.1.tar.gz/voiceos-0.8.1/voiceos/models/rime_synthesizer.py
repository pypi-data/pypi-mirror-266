...
class RimeSynthesizer(BaseModel):
    ...
    speed_alpha: Optional[Union[Annotated[float, Field(le=2, strict=True, ge=0.5)], Annotated[int, Field(le=2, strict=True, ge=1)]]] = Field(default=1, description="Adjusts the speed of speech. Lower is faster. Higher is slower.")
    ...
    def provider_validate_enum(cls, value):
        ...
        if value not in set(['rime']):
            raise ValueError("must be one of enum values ('rime')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "speed_alpha": obj.get("speed_alpha") if obj.get("speed_alpha") is not None else 1
        })
        return _obj
