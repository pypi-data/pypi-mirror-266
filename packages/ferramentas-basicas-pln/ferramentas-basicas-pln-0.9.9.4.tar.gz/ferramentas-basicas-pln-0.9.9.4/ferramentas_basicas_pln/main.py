...
DICIONARIO_CONFIG_PADRAO_TOKENIZACAO = {'removerCaracteresMaisQueEspeciais':True,'removerEspacosEmBrancoExtras':True,'padronizarTextoParaMinuscula':True,'removerCaracteresEspeciais':[True,STRING_CARACTERES_ESPECIAIS_PADRAO]}
