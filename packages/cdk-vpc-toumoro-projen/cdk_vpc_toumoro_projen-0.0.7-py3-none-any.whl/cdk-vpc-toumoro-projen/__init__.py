...
class Vpc(
    ...
    jsii_type="cdk-vpn-toumoro-projen.Vpc",
):
    def __init__(
        self,
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__01edc1e74ec6d72160e79189832fc4939e7a91c964a660b7c80f1e7dcbd91ecc)
...
def _typecheckingstub__01edc1e74ec6d72160e79189832fc4939e7a91c964a660b7c80f1e7dcbd91ecc(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    analytics_reporting: typing.Optional[builtins.bool] = None,
