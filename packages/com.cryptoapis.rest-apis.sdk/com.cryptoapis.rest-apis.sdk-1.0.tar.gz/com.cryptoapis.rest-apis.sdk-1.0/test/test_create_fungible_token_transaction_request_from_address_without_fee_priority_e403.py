...
class TestCreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403:
        ...
        """
        model = CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403()
        if include_optional:
