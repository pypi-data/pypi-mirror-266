...
class TestCoinsForwardingSuccessData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CoinsForwardingSuccessData:
        ...
        """
        model = CoinsForwardingSuccessData()
        if include_optional:
            return CoinsForwardingSuccessData(
                product = 'BLOCKCHAIN_AUTOMATIONS',
                event = 'COINS_FORWARDING_SUCCESS',
                item = com.cryptoapis.rest_apis.sdk.models.coins_forwarding_success_data_item.CoinsForwardingSuccess_data_item(
                    blockchain = 'bitcoin', 
                    network = 'testnet', 
