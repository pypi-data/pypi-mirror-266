...
class TestPrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVoutInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVoutInner:
        ...
        """
        model = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVoutInner()
        if include_optional:
