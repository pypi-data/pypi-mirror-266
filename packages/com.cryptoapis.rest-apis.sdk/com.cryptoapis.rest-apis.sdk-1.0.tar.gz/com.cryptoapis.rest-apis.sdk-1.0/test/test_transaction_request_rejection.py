...
class TestTransactionRequestRejection(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionRequestRejection:
        ...
        """
        model = TransactionRequestRejection()
        if include_optional:
            return TransactionRequestRejection(
                ...
                data = com.cryptoapis.rest_apis.sdk.models.transaction_request_rejection_data.TransactionRequestRejection_data(
