...
class TestListConfirmedTransactionsByAddressRIBSZ(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListConfirmedTransactionsByAddressRIBSZ:
        ...
        """
        model = ListConfirmedTransactionsByAddressRIBSZ()
        if include_optional:
            return ListConfirmedTransactionsByAddressRIBSZ(
                ...
                size = 234,
                v_join_split = [
                    com.cryptoapis.rest_apis.sdk.models.list_confirmed_transactions_by_address_ribsz_v_join_split_inner.ListConfirmedTransactionsByAddressRIBSZ_vJoinSplit_inner(
                ...
                vin = [
                    com.cryptoapis.rest_apis.sdk.models.list_confirmed_transactions_by_address_ribsz_vin_inner.ListConfirmedTransactionsByAddressRIBSZ_vin_inner(
                        addresses = [
