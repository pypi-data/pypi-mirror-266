...
class TestGetWalletTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWalletTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig:
        ...
        """
        model = GetWalletTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig()
        if include_optional:
