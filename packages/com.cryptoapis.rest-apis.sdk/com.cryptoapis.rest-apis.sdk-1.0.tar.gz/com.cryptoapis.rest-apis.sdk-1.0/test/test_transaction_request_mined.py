...
class TestTransactionRequestMined(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionRequestMined:
        ...
        if include_optional:
            return TransactionRequestMined(
                ...
                data = com.cryptoapis.rest_apis.sdk.models.transaction_request_mined_data.TransactionRequestMined_data(
