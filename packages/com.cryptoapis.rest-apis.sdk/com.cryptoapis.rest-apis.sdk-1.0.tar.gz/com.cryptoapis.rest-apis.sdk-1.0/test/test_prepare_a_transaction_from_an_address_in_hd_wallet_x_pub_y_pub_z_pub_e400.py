...
class TestPrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE400(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE400:
        ...
        """
        model = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE400()
        if include_optional:
