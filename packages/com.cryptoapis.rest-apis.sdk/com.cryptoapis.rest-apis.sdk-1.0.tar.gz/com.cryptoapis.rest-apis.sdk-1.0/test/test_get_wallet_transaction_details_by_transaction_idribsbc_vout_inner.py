...
class TestGetWalletTransactionDetailsByTransactionIDRIBSBCVoutInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInner:
        ...
        """
        model = GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInner()
        if include_optional:
