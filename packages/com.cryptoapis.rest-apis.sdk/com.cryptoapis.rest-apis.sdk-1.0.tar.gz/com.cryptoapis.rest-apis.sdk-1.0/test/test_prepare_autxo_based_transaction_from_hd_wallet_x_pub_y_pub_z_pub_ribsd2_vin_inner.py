...
class TestPrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSD2VinInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSD2VinInner:
        ...
        """
        model = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSD2VinInner()
        if include_optional:
