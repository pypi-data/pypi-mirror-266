...
class TestPrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem:
        ...
        """
        model = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem()
        if include_optional:
