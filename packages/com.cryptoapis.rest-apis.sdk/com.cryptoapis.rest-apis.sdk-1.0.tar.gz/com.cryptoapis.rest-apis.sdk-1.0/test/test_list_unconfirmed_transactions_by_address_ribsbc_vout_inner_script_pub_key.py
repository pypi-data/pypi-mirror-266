...
class TestListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey:
        ...
        """
        model = ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey()
        if include_optional:
