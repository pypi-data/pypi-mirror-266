...
class TestGetTransactionDetailsByTransactionIDFromCallbackRIBSEC(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSEC:
        ...
        """
        model = GetTransactionDetailsByTransactionIDFromCallbackRIBSEC()
        if include_optional:
