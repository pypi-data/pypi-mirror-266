...
class TestTransactionMined(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionMined:
        ...
        if include_optional:
            return TransactionMined(
                ...
                data = com.cryptoapis.rest_apis.sdk.models.transaction_mined_data.TransactionMined_data(
                    product = 'BLOCKCHAIN_EVENTS', 
                    event = 'TRANSACTION_MINED', 
                    item = com.cryptoapis.rest_apis.sdk.models.transaction_mined_data_item.TransactionMined_data_item(
                        blockchain = 'bitcoin', 
                        network = 'testnet', 
