...
class TestListConfirmedTokensTransfersByAddressAndTimeRangeRData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListConfirmedTokensTransfersByAddressAndTimeRangeRData:
        ...
        """
        model = ListConfirmedTokensTransfersByAddressAndTimeRangeRData()
        if include_optional:
