...
class TestListTokensForwardingAutomations400Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListTokensForwardingAutomations400Response:
        ...
        """
        model = ListTokensForwardingAutomations400Response()
        if include_optional:
            return ListTokensForwardingAutomations400Response(
                api_version = '2023-04-25',
                request_id = '601c1710034ed6d407996b30',
                context = 'yourExampleString',
                error = com.cryptoapis.rest_apis.sdk.models.list_tokens_forwarding_automations_e400.ListTokensForwardingAutomationsE400()
            )
        else:
            return ListTokensForwardingAutomations400Response(
                api_version = '2023-04-25',
