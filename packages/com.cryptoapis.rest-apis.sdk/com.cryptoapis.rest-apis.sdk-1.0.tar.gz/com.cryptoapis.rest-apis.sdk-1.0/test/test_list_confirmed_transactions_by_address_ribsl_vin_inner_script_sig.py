...
class TestListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig:
        ...
        """
        model = ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig()
        if include_optional:
