...
class TestGetAssetDetailsByAssetIDR(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAssetDetailsByAssetIDR:
        ...
        """
        model = GetAssetDetailsByAssetIDR()
        if include_optional:
            return GetAssetDetailsByAssetIDR(
                api_version = '2023-04-25',
                request_id = '601c1710034ed6d407996b30',
                context = 'yourExampleString',
                data = com.cryptoapis.rest_apis.sdk.models.get_asset_details_by_asset_idr_data.GetAssetDetailsByAssetIDR_data(
                    item = com.cryptoapis.rest_apis.sdk.models.get_asset_details_by_asset_idri.GetAssetDetailsByAssetIDRI(
                        asset_id = '5b1ea92e584bf50020130615', 
                        asset_logo = com.cryptoapis.rest_apis.sdk.models.get_asset_details_by_asset_idri_asset_logo.GetAssetDetailsByAssetIDRI_assetLogo(
                            encoding = 'base64', 
                        ...
                        asset_symbol = 'BTC', 
                        asset_type = 'crypto', 
                        latest_rate = com.cryptoapis.rest_apis.sdk.models.get_asset_details_by_asset_idri_latest_rate.GetAssetDetailsByAssetIDRI_latestRate(
                            amount = '61704.20995670996', 
                            calculation_timestamp = 1636107864, 
                            unit = 'USD', ), 
                        slug = 'bitcoin', 
                        specific_data = com.cryptoapis.rest_apis.sdk.models.get_asset_details_by_asset_idris.GetAssetDetailsByAssetIDRIS(), ), )
            )
        else:
            return GetAssetDetailsByAssetIDR(
                api_version = '2023-04-25',
