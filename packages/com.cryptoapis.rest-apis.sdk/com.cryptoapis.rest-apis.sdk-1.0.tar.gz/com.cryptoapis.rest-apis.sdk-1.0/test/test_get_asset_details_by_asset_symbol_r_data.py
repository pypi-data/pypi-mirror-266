...
class TestGetAssetDetailsByAssetSymbolRData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAssetDetailsByAssetSymbolRData:
        ...
        """
        model = GetAssetDetailsByAssetSymbolRData()
        if include_optional:
            return GetAssetDetailsByAssetSymbolRData(
                item = com.cryptoapis.rest_apis.sdk.models.get_asset_details_by_asset_symbol_ri.GetAssetDetailsByAssetSymbolRI(
                    ...
                    latest_rate = com.cryptoapis.rest_apis.sdk.models.get_asset_details_by_asset_idri_latest_rate.GetAssetDetailsByAssetIDRI_latestRate(
                        ...
                        unit = 'USD', ), 
                    slug = 'bitcoin', 
                    specific_data = com.cryptoapis.rest_apis.sdk.models.get_asset_details_by_asset_symbol_ris.GetAssetDetailsByAssetSymbolRIS(), )
            )
        else:
            return GetAssetDetailsByAssetSymbolRData(
                item = com.cryptoapis.rest_apis.sdk.models.get_asset_details_by_asset_symbol_ri.GetAssetDetailsByAssetSymbolRI(
