...
class TestGetTransactionDetailsByTransactionIDFromCallbackRIBSL(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSL:
        ...
        """
        model = GetTransactionDetailsByTransactionIDFromCallbackRIBSL()
        if include_optional:
            return GetTransactionDetailsByTransactionIDFromCallbackRIBSL(
                ...
                vout = [
                    com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_id_from_callback_ribsl_vout_inner.GetTransactionDetailsByTransactionIDFromCallbackRIBSL_vout_inner(
                        is_spent = False, 
