...
class TestBroadcastLocallySignedTransactionRB(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BroadcastLocallySignedTransactionRB:
        ...
        """
        model = BroadcastLocallySignedTransactionRB()
        if include_optional:
            return BroadcastLocallySignedTransactionRB(
                context = 'yourExampleString',
                data = com.cryptoapis.rest_apis.sdk.models.broadcast_locally_signed_transaction_rb_data.BroadcastLocallySignedTransactionRB_data(
                    item = com.cryptoapis.rest_apis.sdk.models.broadcast_locally_signed_transaction_rb_data_item.BroadcastLocallySignedTransactionRB_data_item(
