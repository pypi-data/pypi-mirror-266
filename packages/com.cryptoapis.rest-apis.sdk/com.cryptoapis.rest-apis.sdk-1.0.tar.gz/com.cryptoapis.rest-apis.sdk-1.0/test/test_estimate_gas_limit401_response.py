...
class TestEstimateGasLimit401Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EstimateGasLimit401Response:
        ...
        """
        model = EstimateGasLimit401Response()
        if include_optional:
            return EstimateGasLimit401Response(
                api_version = '2023-04-25',
                request_id = '601c1710034ed6d407996b30',
                context = 'yourExampleString',
                error = com.cryptoapis.rest_apis.sdk.models.estimate_gas_limit_e401.EstimateGasLimitE401()
            )
        else:
            return EstimateGasLimit401Response(
                api_version = '2023-04-25',
