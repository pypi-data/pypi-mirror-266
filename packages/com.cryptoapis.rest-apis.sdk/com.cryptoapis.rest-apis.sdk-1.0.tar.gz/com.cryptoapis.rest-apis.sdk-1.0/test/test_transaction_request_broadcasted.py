...
class TestTransactionRequestBroadcasted(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionRequestBroadcasted:
        ...
        """
        model = TransactionRequestBroadcasted()
        if include_optional:
            return TransactionRequestBroadcasted(
                ...
                data = com.cryptoapis.rest_apis.sdk.models.transaction_request_broadcasted_data.TransactionRequestBroadcasted_data(
                    product = 'WALLET_AS_A_SERVICE', 
                    event = 'TRANSACTION_REQUEST_BROADCASTED', 
                    item = com.cryptoapis.rest_apis.sdk.models.transaction_request_broadcasted_data_item.TransactionRequestBroadcasted_data_item(
