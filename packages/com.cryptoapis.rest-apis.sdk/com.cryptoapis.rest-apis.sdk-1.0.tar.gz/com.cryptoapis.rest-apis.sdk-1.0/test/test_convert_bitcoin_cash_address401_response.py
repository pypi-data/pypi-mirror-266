...
class TestConvertBitcoinCashAddress401Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConvertBitcoinCashAddress401Response:
        ...
        """
        model = ConvertBitcoinCashAddress401Response()
        if include_optional:
            return ConvertBitcoinCashAddress401Response(
                api_version = '2023-04-25',
                request_id = '601c1710034ed6d407996b30',
                context = 'yourExampleString',
                error = com.cryptoapis.rest_apis.sdk.models.convert_bitcoin_cash_address_e401.ConvertBitcoinCashAddressE401()
            )
        else:
            return ConvertBitcoinCashAddress401Response(
                api_version = '2023-04-25',
