...
class TestGetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner:
        ...
        """
        model = GetTransactionDetailsByTransactionIDRIBSZVShieldedOutputInner()
        if include_optional:
