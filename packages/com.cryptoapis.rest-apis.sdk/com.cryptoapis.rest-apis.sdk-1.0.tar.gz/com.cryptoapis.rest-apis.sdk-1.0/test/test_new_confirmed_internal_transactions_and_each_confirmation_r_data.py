...
class TestNewConfirmedInternalTransactionsAndEachConfirmationRData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NewConfirmedInternalTransactionsAndEachConfirmationRData:
        ...
        """
        model = NewConfirmedInternalTransactionsAndEachConfirmationRData()
        if include_optional:
