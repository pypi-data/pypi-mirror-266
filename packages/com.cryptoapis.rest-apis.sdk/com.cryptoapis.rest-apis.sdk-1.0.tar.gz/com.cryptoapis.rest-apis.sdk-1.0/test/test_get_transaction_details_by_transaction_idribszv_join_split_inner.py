...
class TestGetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner:
        ...
        """
        model = GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner()
        if include_optional:
