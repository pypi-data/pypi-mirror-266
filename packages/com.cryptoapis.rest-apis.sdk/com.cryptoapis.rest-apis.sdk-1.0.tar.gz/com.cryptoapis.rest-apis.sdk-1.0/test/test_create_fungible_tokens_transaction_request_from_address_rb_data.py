...
class TestCreateFungibleTokensTransactionRequestFromAddressRBData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateFungibleTokensTransactionRequestFromAddressRBData:
        ...
        """
        model = CreateFungibleTokensTransactionRequestFromAddressRBData()
        if include_optional:
