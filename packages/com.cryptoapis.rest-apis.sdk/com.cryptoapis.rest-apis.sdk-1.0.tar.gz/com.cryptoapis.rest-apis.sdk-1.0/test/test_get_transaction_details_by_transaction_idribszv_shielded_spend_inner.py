...
class TestGetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner:
        ...
        """
        model = GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner()
        if include_optional:
