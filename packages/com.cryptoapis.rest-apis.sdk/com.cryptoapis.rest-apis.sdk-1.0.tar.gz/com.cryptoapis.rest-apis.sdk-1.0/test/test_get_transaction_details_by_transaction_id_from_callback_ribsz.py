...
class TestGetTransactionDetailsByTransactionIDFromCallbackRIBSZ(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDFromCallbackRIBSZ:
        ...
        """
        model = GetTransactionDetailsByTransactionIDFromCallbackRIBSZ()
        if include_optional:
