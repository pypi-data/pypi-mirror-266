...
class TestListTokensTransfersByTransactionHashRI(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListTokensTransfersByTransactionHashRI:
        ...
        """
        model = ListTokensTransfersByTransactionHashRI()
        if include_optional:
            return ListTokensTransfersByTransactionHashRI(
                ...
                transaction_fee = com.cryptoapis.rest_apis.sdk.models.list_tokens_transfers_by_transaction_hash_ri_transaction_fee.ListTokensTransfersByTransactionHashRI_transactionFee(
                    amount = '0.0000051873', 
                    unit = 'ETH', )
            )
        else:
