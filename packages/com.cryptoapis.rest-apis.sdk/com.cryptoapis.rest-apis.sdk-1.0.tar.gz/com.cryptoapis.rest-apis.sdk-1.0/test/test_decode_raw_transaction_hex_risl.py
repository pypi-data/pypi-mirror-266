...
class TestDecodeRawTransactionHexRISL(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DecodeRawTransactionHexRISL:
        ...
        """
        model = DecodeRawTransactionHexRISL()
        if include_optional:
            return DecodeRawTransactionHexRISL(
                ...
                version = 1,
                vin = [
                    com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risl_vin_inner.DecodeRawTransactionHexRISL_vin_inner(
                        address = 'LZ891CJWn54CpE6yJ4T3mzP8Xxwrg9gDpH', 
                        input_hash = '4c76c153f5de975f94da7526c1b4b4a13380ef93c946f6bed1892f4410600a3d', 
                        output_index = '3', 
                        script_sig = com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risl_vin_inner_script_sig.DecodeRawTransactionHexRISL_vin_inner_scriptSig(
                ...
                vout = [
                    com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risl_vout_inner.DecodeRawTransactionHexRISL_vout_inner(
