...
class TestGetTransactionDetailsByTransactionIDRIBSB(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDRIBSB:
        ...
        """
        model = GetTransactionDetailsByTransactionIDRIBSB()
        if include_optional:
            return GetTransactionDetailsByTransactionIDRIBSB(
                ...
                version = 1,
                vin = [
                    com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_idribsb_vin_inner.GetTransactionDetailsByTransactionIDRIBSB_vin_inner(
                        addresses = [
                ...
                vout = [
                    com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_idribsb_vout_inner.GetTransactionDetailsByTransactionIDRIBSB_vout_inner(
                        is_spent = False, 
                        script_pub_key = com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_idribsb_vout_inner_script_pub_key.GetTransactionDetailsByTransactionIDRIBSB_vout_inner_scriptPubKey(
                            addresses = [
