...
class TestGetWalletTransactionDetailsByTransactionIDRIBS(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetWalletTransactionDetailsByTransactionIDRIBS:
        ...
        """
        model = GetWalletTransactionDetailsByTransactionIDRIBS()
        if include_optional:
            return GetWalletTransactionDetailsByTransactionIDRIBS(
                ...
                version = 1,
                vin = [
                    com.cryptoapis.rest_apis.sdk.models.get_wallet_transaction_details_by_transaction_idribsz_vin_inner.GetWalletTransactionDetailsByTransactionIDRIBSZ_vin_inner(
                        addresses = [
                ...
                vout = [
                    com.cryptoapis.rest_apis.sdk.models.list_transactions_by_block_height_ribsz_vout_inner.ListTransactionsByBlockHeightRIBSZ_vout_inner(
                        is_spent = True, 
