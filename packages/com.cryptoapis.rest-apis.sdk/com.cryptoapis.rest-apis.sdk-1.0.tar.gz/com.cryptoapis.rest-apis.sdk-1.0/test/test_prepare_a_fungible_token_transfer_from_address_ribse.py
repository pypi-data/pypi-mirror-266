...
class TestPrepareAFungibleTokenTransferFromAddressRIBSE(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareAFungibleTokenTransferFromAddressRIBSE:
        ...
        """
        model = PrepareAFungibleTokenTransferFromAddressRIBSE()
        if include_optional:
            return PrepareAFungibleTokenTransferFromAddressRIBSE(
                ...
                fee = com.cryptoapis.rest_apis.sdk.models.prepare_a_fungible_token_transfer_from_address_ribse_fee.PrepareAFungibleTokenTransferFromAddressRIBSE_fee(
                    gas_limit = '552020', 
