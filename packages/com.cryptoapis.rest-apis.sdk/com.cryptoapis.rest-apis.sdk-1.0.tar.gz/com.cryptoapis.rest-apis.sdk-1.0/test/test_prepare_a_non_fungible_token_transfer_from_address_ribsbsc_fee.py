...
class TestPrepareANonFungibleTokenTransferFromAddressRIBSBSCFee(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareANonFungibleTokenTransferFromAddressRIBSBSCFee:
        ...
        """
        model = PrepareANonFungibleTokenTransferFromAddressRIBSBSCFee()
        if include_optional:
