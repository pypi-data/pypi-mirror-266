...
class TestAddressTokensTransactionConfirmedEachConfirmationDataItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddressTokensTransactionConfirmedEachConfirmationDataItem:
        ...
        """
        model = AddressTokensTransactionConfirmedEachConfirmationDataItem()
        if include_optional:
