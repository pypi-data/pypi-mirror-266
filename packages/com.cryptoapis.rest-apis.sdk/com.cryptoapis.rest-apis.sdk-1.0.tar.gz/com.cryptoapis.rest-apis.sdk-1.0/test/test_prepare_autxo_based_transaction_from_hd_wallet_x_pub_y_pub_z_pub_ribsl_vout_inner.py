...
class TestPrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSLVoutInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSLVoutInner:
        ...
        """
        model = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSLVoutInner()
        if include_optional:
