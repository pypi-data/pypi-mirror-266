...
class TestPrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR:
        ...
        """
        model = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR()
        if include_optional:
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR(
                api_version = '2023-04-25',
                request_id = '601c1710034ed6d407996b30',
                context = 'yourExampleString',
                data = com.cryptoapis.rest_apis.sdk.models.prepare_a_transaction_from_an_address_in_hd_wallet_x_pub_y_pub_z_pub_r_data.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubR_data(
