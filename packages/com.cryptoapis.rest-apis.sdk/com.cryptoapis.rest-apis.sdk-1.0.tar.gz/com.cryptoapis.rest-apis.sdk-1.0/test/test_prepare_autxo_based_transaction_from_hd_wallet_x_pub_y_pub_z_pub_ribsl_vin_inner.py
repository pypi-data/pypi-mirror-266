...
class TestPrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSLVinInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSLVinInner:
        ...
        """
        model = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSLVinInner()
        if include_optional:
