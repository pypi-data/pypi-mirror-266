...
class TestPrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB:
        ...
        """
        model = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB()
        if include_optional:
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB(
                context = 'yourExampleString',
                data = com.cryptoapis.rest_apis.sdk.models.prepare_a_transaction_from_an_address_in_hd_wallet_x_pub_y_pub_z_pub_rb_data.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB_data(
                    item = com.cryptoapis.rest_apis.sdk.models.prepare_a_transaction_from_an_address_in_hd_wallet_x_pub_y_pub_z_pub_rb_data_item.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB_data_item(
                        ...
                        fee = com.cryptoapis.rest_apis.sdk.models.prepare_a_transaction_from_an_address_in_hd_wallet_x_pub_y_pub_z_pub_rb_data_item_fee.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRB_data_item_fee(
