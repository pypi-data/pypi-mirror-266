...
class TestListTransactionsByBlockHeightRIBSZVShieldedOutputInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListTransactionsByBlockHeightRIBSZVShieldedOutputInner:
        ...
        """
        model = ListTransactionsByBlockHeightRIBSZVShieldedOutputInner()
        if include_optional:
