...
class TestListConfirmedTransactionsByAddressRIBSZVJoinSplitInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner:
        ...
        """
        model = ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner()
        if include_optional:
