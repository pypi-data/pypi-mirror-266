...
class TestDecodeRawTransactionHexRIS(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DecodeRawTransactionHexRIS:
        ...
        """
        model = DecodeRawTransactionHexRIS()
        if include_optional:
            return DecodeRawTransactionHexRIS(
                ...
                version = 4,
                vin = [
                    com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risz_vin_inner.DecodeRawTransactionHexRISZ_vin_inner(
                        address = 't1ajyFP7GnauoDFaM8MqJx9ouQjKS3tbA7g', 
                        input_hash = '9dcaee77cd1806c4f9b0bac9ba17e4713fd04032f33be27b630ce499f7a35bd7', 
                        output_index = '1', 
                        script_sig = com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risz_vin_inner_script_sig.DecodeRawTransactionHexRISZ_vin_inner_scriptSig(
                ...
                vout = [
                    com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risz_vout_inner.DecodeRawTransactionHexRISZ_vout_inner(
