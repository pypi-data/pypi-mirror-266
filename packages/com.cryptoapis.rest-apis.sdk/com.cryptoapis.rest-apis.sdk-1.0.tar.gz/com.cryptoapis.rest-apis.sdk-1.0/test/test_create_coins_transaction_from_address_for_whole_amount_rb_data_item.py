...
class TestCreateCoinsTransactionFromAddressForWholeAmountRBDataItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateCoinsTransactionFromAddressForWholeAmountRBDataItem:
        ...
        """
        model = CreateCoinsTransactionFromAddressForWholeAmountRBDataItem()
        if include_optional:
