...
class TestAddressTokensTransactionUnconfirmedDataItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AddressTokensTransactionUnconfirmedDataItem:
        ...
        """
        model = AddressTokensTransactionUnconfirmedDataItem()
        if include_optional:
            return AddressTokensTransactionUnconfirmedDataItem(
                ...
                token_type = 'ERC-20',
                token = com.cryptoapis.rest_apis.sdk.models.address_tokens_transaction_unconfirmed_token.AddressTokensTransactionUnconfirmedToken(),
                direction = 'incoming',
