...
class TestGetTransactionDetailsByTransactionIDRIBSLVinInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDRIBSLVinInner:
        ...
        """
        model = GetTransactionDetailsByTransactionIDRIBSLVinInner()
        if include_optional:
            return GetTransactionDetailsByTransactionIDRIBSLVinInner(
                ...
                script_sig = com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_idribsl_vin_inner_script_sig.GetTransactionDetailsByTransactionIDRIBSL_vin_inner_scriptSig(
