...
class TestListUnconfirmedTransactionsByAddressRIBSL(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListUnconfirmedTransactionsByAddressRIBSL:
        ...
        """
        model = ListUnconfirmedTransactionsByAddressRIBSL()
        if include_optional:
            return ListUnconfirmedTransactionsByAddressRIBSL(
                ...
                version = 2,
                vin = [
                    com.cryptoapis.rest_apis.sdk.models.list_unconfirmed_transactions_by_address_ribsl_vin_inner.ListUnconfirmedTransactionsByAddressRIBSL_vin_inner(
                        addresses = [
                ...
                vout = [
                    com.cryptoapis.rest_apis.sdk.models.list_unconfirmed_transactions_by_address_ribsl_vout_inner.ListUnconfirmedTransactionsByAddressRIBSL_vout_inner(
                        is_spent = False, 
