...
class TestListConfirmedTransactionsByAddressAndTimeRangeRIBSEC(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC:
        ...
        """
        model = ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC()
        if include_optional:
