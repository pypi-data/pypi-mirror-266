...
class TestPrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRI(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRI:
        ...
        """
        model = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRI()
        if include_optional:
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRI(
                ...
                blockchain_specific = com.cryptoapis.rest_apis.sdk.models.prepare_a_transaction_from_an_address_in_hd_wallet_x_pub_y_pub_z_pub_ribs.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBS()
            )
        else:
            return PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRI(
                amount = '0.000003',
