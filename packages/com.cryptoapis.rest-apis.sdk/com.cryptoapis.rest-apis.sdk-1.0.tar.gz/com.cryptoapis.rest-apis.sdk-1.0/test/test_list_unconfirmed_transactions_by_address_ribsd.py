...
class TestListUnconfirmedTransactionsByAddressRIBSD(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListUnconfirmedTransactionsByAddressRIBSD:
        ...
        """
        model = ListUnconfirmedTransactionsByAddressRIBSD()
        if include_optional:
            return ListUnconfirmedTransactionsByAddressRIBSD(
                ...
                version = 2,
                vin = [
                    com.cryptoapis.rest_apis.sdk.models.list_unconfirmed_transactions_by_address_ribsd_vin_inner.ListUnconfirmedTransactionsByAddressRIBSD_vin_inner(
                        addresses = [
