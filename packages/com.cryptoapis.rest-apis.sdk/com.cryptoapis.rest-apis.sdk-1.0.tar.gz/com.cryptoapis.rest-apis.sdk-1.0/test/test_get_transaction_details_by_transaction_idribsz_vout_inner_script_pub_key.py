...
class TestGetTransactionDetailsByTransactionIDRIBSZVoutInnerScriptPubKey(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDRIBSZVoutInnerScriptPubKey:
        ...
        """
        model = GetTransactionDetailsByTransactionIDRIBSZVoutInnerScriptPubKey()
        if include_optional:
