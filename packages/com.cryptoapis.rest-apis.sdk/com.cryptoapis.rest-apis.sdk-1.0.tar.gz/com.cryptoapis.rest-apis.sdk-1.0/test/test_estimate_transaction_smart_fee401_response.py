...
class TestEstimateTransactionSmartFee401Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EstimateTransactionSmartFee401Response:
        ...
        """
        model = EstimateTransactionSmartFee401Response()
        if include_optional:
            return EstimateTransactionSmartFee401Response(
                api_version = '2023-04-25',
                request_id = '601c1710034ed6d407996b30',
                context = 'yourExampleString',
                error = com.cryptoapis.rest_apis.sdk.models.estimate_transaction_smart_fee_e401.EstimateTransactionSmartFeeE401()
            )
        else:
            return EstimateTransactionSmartFee401Response(
                api_version = '2023-04-25',
