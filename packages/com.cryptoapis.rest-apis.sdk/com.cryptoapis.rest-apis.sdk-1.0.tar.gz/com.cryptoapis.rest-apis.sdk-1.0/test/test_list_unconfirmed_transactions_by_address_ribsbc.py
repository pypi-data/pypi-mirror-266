...
class TestListUnconfirmedTransactionsByAddressRIBSBC(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListUnconfirmedTransactionsByAddressRIBSBC:
        ...
        """
        model = ListUnconfirmedTransactionsByAddressRIBSBC()
        if include_optional:
            return ListUnconfirmedTransactionsByAddressRIBSBC(
                ...
                version = 1,
                vin = [
                    com.cryptoapis.rest_apis.sdk.models.list_unconfirmed_transactions_by_address_ribsbc_vin_inner.ListUnconfirmedTransactionsByAddressRIBSBC_vin_inner(
                        addresses = [
                ...
                vout = [
                    com.cryptoapis.rest_apis.sdk.models.list_unconfirmed_transactions_by_address_ribsbc_vout_inner.ListUnconfirmedTransactionsByAddressRIBSBC_vout_inner(
                        is_spent = True, 
