...
class TestPrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItemFee(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItemFee:
        ...
        """
        model = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItemFee()
        if include_optional:
