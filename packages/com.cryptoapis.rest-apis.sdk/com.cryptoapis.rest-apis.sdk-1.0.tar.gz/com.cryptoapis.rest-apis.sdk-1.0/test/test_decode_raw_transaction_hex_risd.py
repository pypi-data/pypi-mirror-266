...
class TestDecodeRawTransactionHexRISD(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DecodeRawTransactionHexRISD:
        ...
        """
        model = DecodeRawTransactionHexRISD()
        if include_optional:
            return DecodeRawTransactionHexRISD(
                ...
                version = 1,
                vin = [
                    com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risd_vin_inner.DecodeRawTransactionHexRISD_vin_inner(
                        address = '7W7gfYstwDR6a2ZCxEidAuvshyomqJ8yXT', 
                        input_hash = '5061c34b1c1f40a9328c168f1070915bb9c450dbf2ecd566ae2e34e80651ecb4', 
                        output_index = '1', 
                        script_sig = com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risd_vin_inner_script_sig.DecodeRawTransactionHexRISD_vin_inner_scriptSig(
                ...
                vout = [
                    com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risd_vout_inner.DecodeRawTransactionHexRISD_vout_inner(
                        script_pub_key = com.cryptoapis.rest_apis.sdk.models.decode_raw_transaction_hex_risd_vout_inner_script_pub_key.DecodeRawTransactionHexRISD_vout_inner_scriptPubKey(
