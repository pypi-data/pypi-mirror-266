...
class TestSyncNewHDWalletXPubYPubZPubRB(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SyncNewHDWalletXPubYPubZPubRB:
        ...
        """
        model = SyncNewHDWalletXPubYPubZPubRB()
        if include_optional:
            return SyncNewHDWalletXPubYPubZPubRB(
                context = 'yourExampleString',
                data = com.cryptoapis.rest_apis.sdk.models.sync_hd_wallet_x_pub_y_pub_z_pub_rb_data.SyncHDWalletXPubYPubZPubRB_data(
                    item = com.cryptoapis.rest_apis.sdk.models.sync_hd_wallet_x_pub_y_pub_z_pub_rb_data_item.SyncHDWalletXPubYPubZPubRB_data_item(
