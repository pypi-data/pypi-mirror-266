...
class TestCreateFungibleTokensTransactionRequestFromAddressRIS(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateFungibleTokensTransactionRequestFromAddressRIS:
        ...
        """
        model = CreateFungibleTokensTransactionRequestFromAddressRIS()
        if include_optional:
