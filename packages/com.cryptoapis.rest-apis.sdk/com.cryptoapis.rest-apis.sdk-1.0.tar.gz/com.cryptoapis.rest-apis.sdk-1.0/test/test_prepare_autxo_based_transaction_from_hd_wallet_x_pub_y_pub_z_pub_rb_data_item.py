...
class TestPrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem:
        ...
        """
        model = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem()
        if include_optional:
