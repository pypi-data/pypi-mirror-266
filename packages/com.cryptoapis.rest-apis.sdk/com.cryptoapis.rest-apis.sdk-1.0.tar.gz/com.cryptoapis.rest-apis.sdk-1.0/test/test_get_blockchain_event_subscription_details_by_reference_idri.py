...
class TestGetBlockchainEventSubscriptionDetailsByReferenceIDRI(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBlockchainEventSubscriptionDetailsByReferenceIDRI:
        ...
        """
        model = GetBlockchainEventSubscriptionDetailsByReferenceIDRI()
        if include_optional:
