...
class TestPrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVinInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVinInner:
        ...
        """
        model = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVinInner()
        if include_optional:
