...
class TestPrepareTransactionFromAddress400Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrepareTransactionFromAddress400Response:
        ...
        """
        model = PrepareTransactionFromAddress400Response()
        if include_optional:
            return PrepareTransactionFromAddress400Response(
                api_version = '2023-04-25',
                request_id = '601c1710034ed6d407996b30',
                context = 'yourExampleString',
                error = com.cryptoapis.rest_apis.sdk.models.prepare_transaction_from_address_e400.PrepareTransactionFromAddressE400()
            )
        else:
            return PrepareTransactionFromAddress400Response(
                api_version = '2023-04-25',
