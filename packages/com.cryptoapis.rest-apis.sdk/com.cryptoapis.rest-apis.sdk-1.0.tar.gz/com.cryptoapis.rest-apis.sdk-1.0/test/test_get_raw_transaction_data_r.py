...
class TestGetRawTransactionDataR(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetRawTransactionDataR:
        ...
        """
        model = GetRawTransactionDataR()
        if include_optional:
            return GetRawTransactionDataR(
                api_version = '2023-04-25',
                request_id = '601c1710034ed6d407996b30',
                context = 'yourExampleString',
                data = com.cryptoapis.rest_apis.sdk.models.get_raw_transaction_data_r_data.GetRawTransactionDataR_data(
