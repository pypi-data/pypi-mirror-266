...
class TestGetTransactionDetailsByTransactionIDFromCallbackRIBS(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionDetailsByTransactionIDFromCallbackRIBS:
        ...
        """
        model = GetTransactionDetailsByTransactionIDFromCallbackRIBS()
        if include_optional:
            return GetTransactionDetailsByTransactionIDFromCallbackRIBS(
                ...
                vout = [
                    com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_id_from_callback_ribsz_vout_inner.GetTransactionDetailsByTransactionIDFromCallbackRIBSZ_vout_inner(
                        is_spent = True, 
                        script_pub_key = com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_id_from_callback_ribsz_vout_inner_script_pub_key.GetTransactionDetailsByTransactionIDFromCallbackRIBSZ_vout_inner_scriptPubKey(
                            addresses = [
                                't2UNzUUx8mWBCRYPRezvA363EYXyEpHokyi'
                                ], 
                            asm = 'OP_HASH160 ef775f1f997f122a062fff1a2d7443abd1f9c642 OP_EQUAL', 
                ...
                status = 'tesSUCCESS',
                type = 'Payment',
                value = com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_id_from_callback_ribsx_value.GetTransactionDetailsByTransactionIDFromCallbackRIBSX_value(
                    amount = '0.000001', 
                    unit = 'XRP', ),
                amount = '5',
                bandwidth_used = com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_id_from_callback_ribst_bandwidth_used.GetTransactionDetailsByTransactionIDFromCallbackRIBST_bandwidthUsed(
                    amount = '', 
                    unit = '', ),
                energy_used = com.cryptoapis.rest_apis.sdk.models.get_transaction_details_by_transaction_id_from_callback_ribst_energy_used.GetTransactionDetailsByTransactionIDFromCallbackRIBST_energyUsed(
                    amount = '', 
                    unit = '', ),
