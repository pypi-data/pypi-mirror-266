...
class PrepareAFungibleTokenTransferFromAddressRI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount", "nonce", "recipient", "sender", "blockchainSpecific"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blockchainSpecific": PrepareAFungibleTokenTransferFromAddressRIBS.from_dict(obj["blockchainSpecific"]) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
