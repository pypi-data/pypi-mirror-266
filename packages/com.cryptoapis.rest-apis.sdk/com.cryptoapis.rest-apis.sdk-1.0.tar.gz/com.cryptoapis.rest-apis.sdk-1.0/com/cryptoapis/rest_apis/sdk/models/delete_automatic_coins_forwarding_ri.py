...
class DeleteAutomaticCoinsForwardingRI(BaseModel):
    ...
    from_address: StrictStr = Field(description="Represents the hash of the address that forwards the currency.", alias="fromAddress")
    ...
    __properties: ClassVar[List[str]] = ["callbackUrl", "confirmationsCount", "createdTimestamp", "feePriority", "fromAddress", "minimumTransferAmount", "referenceId", "toAddress"]
