...
class ListWalletTransactionsRISendersInner(BaseModel):
    ...
    label: Optional[StrictStr] = Field(default=None, description="Defines a plain text string as a label for the sender.")
    __properties: ClassVar[List[str]] = ["address", "amount", "label"]
