...
class CreateCoinsTransactionRequestFromAddressRI(BaseModel):
    ...
    """ # noqa: E501
    address_tag: Optional[StrictInt] = Field(default=None, description="Defines a specific Tag that is an additional XRP address feature. It helps identify a transaction recipient beyond a wallet address. The tag that was encoded into the x-Address along with the Source Classic Address.", alias="addressTag")
    ...
    recipients: List[CreateCoinsTransactionRequestFromAddressRIRecipientsInner] = Field(description="Defines the destination for the transaction, i.e. the recipient(s).")
    ...
    transaction_request_status: StrictStr = Field(description="Defines the status of the transaction request, e.g. \"created, \"await_approval\", \"pending\", \"prepared\", \"signed\", \"broadcasted\", \"success\", \"failed\", \"rejected\", mined\".", alias="transactionRequestStatus")
    __properties: ClassVar[List[str]] = ["addressTag", "callbackSecretKey", "callbackUrl", "classicAddress", "feePriority", "note", "recipients", "senders", "transactionRequestId", "transactionRequestStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "note": obj.get("note"),
            "recipients": [CreateCoinsTransactionRequestFromAddressRIRecipientsInner.from_dict(_item) for _item in obj["recipients"]] if obj.get("recipients") is not None else None,
