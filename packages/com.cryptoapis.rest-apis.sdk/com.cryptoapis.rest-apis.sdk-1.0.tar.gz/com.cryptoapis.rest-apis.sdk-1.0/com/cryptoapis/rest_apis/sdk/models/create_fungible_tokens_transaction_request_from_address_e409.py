...
class CreateFungibleTokensTransactionRequestFromAddressE409(BaseModel):
    ...
    actual_instance: Optional[Union[InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough]] = None
    one_of_schemas: List[str] = Field(default=Literal["InvalidData", "WalletAsAServiceAddressBalanceNotEnough", "WalletAsAServiceTokenNotSupported", "WalletAsAServiceWalletBalanceNotEnough"])
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateFungibleTokensTransactionRequestFromAddressE409.model_construct()
        error_messages = []
        match = 0
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough]]:
