...
class GetFeeRecommendationsRI(BaseModel):
    ...
    fee_cushion_multiplier: StrictStr = Field(description="Fee cushion multiplier used to multiply the base fee", alias="feeCushionMultiplier")
    __properties: ClassVar[List[str]] = ["unit", "fast", "slow", "standard", "feeCushionMultiplier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feeCushionMultiplier": obj.get("feeCushionMultiplier")
        })
        return _obj
