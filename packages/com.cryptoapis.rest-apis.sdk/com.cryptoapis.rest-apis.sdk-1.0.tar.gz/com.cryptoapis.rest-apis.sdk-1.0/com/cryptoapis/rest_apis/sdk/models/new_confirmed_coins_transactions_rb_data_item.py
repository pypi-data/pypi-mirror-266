...
class NewConfirmedCoinsTransactionsRBDataItem(BaseModel):
    ...
    allow_duplicates: Optional[StrictBool] = Field(default=False, description="Specifies a flag that permits or denies the creation of duplicate addresses.", alias="allowDuplicates")
    ...
    receive_callback_on: Optional[StrictInt] = Field(default=None, description="Represents the exact confirmation, on which the user wants to receive callback.", alias="receiveCallbackOn")
    __properties: ClassVar[List[str]] = ["address", "allowDuplicates", "callbackSecretKey", "callbackUrl", "receiveCallbackOn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allowDuplicates": obj.get("allowDuplicates") if obj.get("allowDuplicates") is not None else False,
