...
class GetAddressDetailsFromCallbackRITotalReceived(BaseModel):
    ...
    """ # noqa: E501
    amount: StrictStr = Field(description="Defines the total received amount of the address")
    unit: StrictStr = Field(description="Defines the unit of the total received amount of the address")
