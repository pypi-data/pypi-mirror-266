...
class ListUnconfirmedTransactionsByAddressRIBSBSC(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["gasLimit", "gasPrice", "inputData", "nonce", "transactionStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gasPrice": ListConfirmedTransactionsByAddressRIBSBSCGasPrice.from_dict(obj["gasPrice"]) if obj.get("gasPrice") is not None else None,
