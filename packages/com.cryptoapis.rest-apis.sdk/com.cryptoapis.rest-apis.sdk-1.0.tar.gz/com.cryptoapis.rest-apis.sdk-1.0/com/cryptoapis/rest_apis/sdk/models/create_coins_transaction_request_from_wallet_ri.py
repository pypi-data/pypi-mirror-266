...
class CreateCoinsTransactionRequestFromWalletRI(BaseModel):
    ...
    recipients: List[CreateCoinsTransactionRequestFromWalletRIRecipientsInner] = Field(description="Defines the destination of the transaction, whether it is incoming or outgoing.")
    total_transaction_amount: StrictStr = Field(description="Represents the specific amount of the transaction.", alias="totalTransactionAmount")
    ...
    __properties: ClassVar[List[str]] = ["callbackSecretKey", "callbackUrl", "feePriority", "note", "recipients", "totalTransactionAmount", "transactionRequestId", "transactionRequestStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "note": obj.get("note"),
            "recipients": [CreateCoinsTransactionRequestFromWalletRIRecipientsInner.from_dict(_item) for _item in obj["recipients"]] if obj.get("recipients") is not None else None,
