...
class CreateFungibleTokensTransactionRequestFromAddressRIS(BaseModel):
    ...
    actual_instance: Optional[Union[CreateFungibleTokensTransactionRequestFromAddressRISE]] = None
    one_of_schemas: List[str] = Field(default=Literal["CreateFungibleTokensTransactionRequestFromAddressRISE"])
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateFungibleTokensTransactionRequestFromAddressRIS.model_construct()
        error_messages = []
        match = 0
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], CreateFungibleTokensTransactionRequestFromAddressRISE]]:
