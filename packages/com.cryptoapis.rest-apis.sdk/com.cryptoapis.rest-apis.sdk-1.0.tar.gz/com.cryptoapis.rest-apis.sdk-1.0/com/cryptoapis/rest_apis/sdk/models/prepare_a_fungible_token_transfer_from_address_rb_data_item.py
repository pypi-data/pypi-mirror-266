...
class PrepareAFungibleTokenTransferFromAddressRBDataItem(BaseModel):
    ...
    fee: PrepareAFungibleTokenTransferFromAddressRBDataItemFee
    ...
    __properties: ClassVar[List[str]] = ["amount", "contract", "nonce", "recipient", "sender", "fee", "transactionType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fee": PrepareAFungibleTokenTransferFromAddressRBDataItemFee.from_dict(obj["fee"]) if obj.get("fee") is not None else None,
