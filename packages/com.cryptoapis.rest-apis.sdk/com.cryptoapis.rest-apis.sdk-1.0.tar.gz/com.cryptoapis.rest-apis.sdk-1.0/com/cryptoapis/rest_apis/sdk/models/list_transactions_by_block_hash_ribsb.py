...
class ListTransactionsByBlockHashRIBSB(BaseModel):
    ...
    vin: List[ListTransactionsByBlockHashRIBSBVinInner] = Field(description="Represents the transaction inputs.")
    vout: List[ListTransactionsByBlockHashRIBSBVoutInner] = Field(description="Represents the transaction outputs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vin": [ListTransactionsByBlockHashRIBSBVinInner.from_dict(_item) for _item in obj["vin"]] if obj.get("vin") is not None else None,
            "vout": [ListTransactionsByBlockHashRIBSBVoutInner.from_dict(_item) for _item in obj["vout"]] if obj.get("vout") is not None else None
        })
        return _obj
