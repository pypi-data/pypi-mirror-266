...
class GetTransactionDetailsByTransactionIDRIBSZVShieldedSpendInner(BaseModel):
    ...
    spend_auth_sig: StrictStr = Field(description="Used to prove knowledge of the spending key authorizing spending of an input note.", alias="spendAuthSig")
    __properties: ClassVar[List[str]] = ["anchor", "cv", "nullifier", "proof", "rk", "spendAuthSig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proof": obj.get("proof"),
            "rk": obj.get("rk"),
            "spendAuthSig": obj.get("spendAuthSig")
        })
        return _obj
