...
class ListUnconfirmedTokensTransfersByAddressRI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["contractAddress", "recipientAddress", "senderAddress", "tokenDecimals", "tokenId", "tokenName", "tokenSymbol", "tokenType", "tokensAmount", "transactionHash", "transactionTimestamp"]
