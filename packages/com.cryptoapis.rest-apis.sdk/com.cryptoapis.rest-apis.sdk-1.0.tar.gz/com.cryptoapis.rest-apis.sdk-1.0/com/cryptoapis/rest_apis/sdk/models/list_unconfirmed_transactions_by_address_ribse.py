...
class ListUnconfirmedTransactionsByAddressRIBSE(BaseModel):
    ...
    gas_price: ListUnconfirmedTransactionsByAddressRIBSEGasPrice = Field(alias="gasPrice")
    ...
    __properties: ClassVar[List[str]] = ["fee", "gasLimit", "gasPrice", "inputData", "nonce", "transactionStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fee": ListUnconfirmedTransactionsByAddressRIBSEFee.from_dict(obj["fee"]) if obj.get("fee") is not None else None,
            "gasLimit": obj.get("gasLimit"),
            "gasPrice": ListUnconfirmedTransactionsByAddressRIBSEGasPrice.from_dict(obj["gasPrice"]) if obj.get("gasPrice") is not None else None,
