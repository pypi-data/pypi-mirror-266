...
class ListAllAssetsFromAllWalletsRINonFungibleTokensInner(BaseModel):
    ...
    token_id: StrictStr = Field(description="Represents tokens' unique identifier.", alias="tokenId")
    type: StrictStr = Field(description="Defines the specific token type.")
    __properties: ClassVar[List[str]] = ["blockchain", "identifier", "network", "symbol", "tokenId", "type"]
