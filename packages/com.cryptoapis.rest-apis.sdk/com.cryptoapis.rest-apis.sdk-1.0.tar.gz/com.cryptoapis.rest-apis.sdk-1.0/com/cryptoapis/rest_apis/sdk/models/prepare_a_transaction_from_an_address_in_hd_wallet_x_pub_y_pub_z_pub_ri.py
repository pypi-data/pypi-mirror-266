...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount", "recipient", "sender", "sigHash", "blockchainSpecific"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blockchainSpecific": PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBS.from_dict(obj["blockchainSpecific"]) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
