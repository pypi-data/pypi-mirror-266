...
class CreateCoinsTransactionRequestFromAddressRBDataItem(BaseModel):
    ...
    recipient_address: StrictStr = Field(description="Defines the specific recipient address for the transaction. For XRP we also support the X-address format.", alias="recipientAddress")
    __properties: ClassVar[List[str]] = ["amount", "callbackSecretKey", "callbackUrl", "feePriority", "note", "recipientAddress"]
