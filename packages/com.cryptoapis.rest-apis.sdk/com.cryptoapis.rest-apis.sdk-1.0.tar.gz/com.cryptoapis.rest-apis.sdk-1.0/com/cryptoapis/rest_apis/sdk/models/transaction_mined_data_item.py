...
class TransactionMinedDataItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["blockchain", "network", "transactionId", "minedInBlock"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minedInBlock": TransactionMinedDataItemMinedInBlock.from_dict(obj["minedInBlock"]) if obj.get("minedInBlock") is not None else None
        })
        return _obj
