...
class GetBlockDetailsByBlockHeightFromCallbackRI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hash", "height", "previousBlockHash", "timestamp", "transactionsCount", "nextBlockHash", "blockchainSpecific"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blockchainSpecific": GetBlockDetailsByBlockHeightFromCallbackRIBS.from_dict(obj["blockchainSpecific"]) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
