...
class ListTokensTransfersByTransactionHashRI(BaseModel):
    ...
    tokens_amount: StrictStr = Field(description="Defines the token amount of the transfer.", alias="tokensAmount")
    ...
    __properties: ClassVar[List[str]] = ["contractAddress", "minedInBlockHeight", "recipientAddress", "senderAddress", "tokenDecimals", "tokenName", "tokenSymbol", "tokenType", "tokensAmount", "transactionHash", "transactionTimestamp", "transactionFee"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactionFee": ListTokensTransfersByTransactionHashRITransactionFee.from_dict(obj["transactionFee"]) if obj.get("transactionFee") is not None else None
        })
        return _obj
