...
class NewRevertedBlockRI(BaseModel):
    ...
    callback_secret_key: StrictStr = Field(description="Represents the Secret Key value provided by the customer. This field is used for security purposes during the callback notification, in order to prove the sender of the callback as Crypto APIs. For more information please see our Documentation.", alias="callbackSecretKey")
    ...
    __properties: ClassVar[List[str]] = ["address", "callbackSecretKey", "callbackUrl", "createdTimestamp", "eventType", "isActive", "referenceId"]
