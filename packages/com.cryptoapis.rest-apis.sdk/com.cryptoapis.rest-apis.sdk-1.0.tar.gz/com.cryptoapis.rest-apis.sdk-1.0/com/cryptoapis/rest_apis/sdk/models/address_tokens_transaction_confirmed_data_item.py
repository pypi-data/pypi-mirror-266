...
class AddressTokensTransactionConfirmedDataItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["blockchain", "network", "address", "minedInBlock", "transactionId", "tokenType", "token", "direction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "token": AddressTokensTransactionConfirmedToken.from_dict(obj["token"]) if obj.get("token") is not None else None,
