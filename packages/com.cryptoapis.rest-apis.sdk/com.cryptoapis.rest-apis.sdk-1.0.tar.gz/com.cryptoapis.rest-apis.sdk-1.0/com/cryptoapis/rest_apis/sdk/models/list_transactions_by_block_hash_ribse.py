...
class ListTransactionsByBlockHashRIBSE(BaseModel):
    ...
    gas_limit: StrictStr = Field(description="String representation of the transaction Represents the amount of gas used by this specific transaction alone.", alias="gasLimit")
