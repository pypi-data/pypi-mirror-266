...
class DecodeRawTransactionHexRISD2(BaseModel):
    ...
    vin: List[DecodeRawTransactionHexRISD2VinInner] = Field(description="Represents the transaction inputs.")
    vout: List[DecodeRawTransactionHexRISD2VoutInner] = Field(description="Represents the transaction outputs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vin": [DecodeRawTransactionHexRISD2VinInner.from_dict(_item) for _item in obj["vin"]] if obj.get("vin") is not None else None,
            "vout": [DecodeRawTransactionHexRISD2VoutInner.from_dict(_item) for _item in obj["vout"]] if obj.get("vout") is not None else None,
