...
class NewRevertedBlockRBDataItem(BaseModel):
    ...
    """ # noqa: E501
    allow_duplicates: Optional[StrictStr] = Field(default=None, description="Specifies a flag that permits or denies the creation of duplicate addresses.", alias="allowDuplicates")
    ...
    __properties: ClassVar[List[str]] = ["allowDuplicates", "callbackSecretKey", "callbackUrl"]
