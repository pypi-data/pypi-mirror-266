...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC(BaseModel):
    ...
    gas_used: StrictStr = Field(description="Defines the unit of the gas price amount, e.g. BTC, ETH, XRP.", alias="gasUsed")
    ...
    __properties: ClassVar[List[str]] = ["contract", "gasLimit", "gasPrice", "gasUsed", "inputData", "nonce"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gasPrice": GetTransactionDetailsByTransactionIDRIBSBSCGasPrice.from_dict(obj["gasPrice"]) if obj.get("gasPrice") is not None else None,
