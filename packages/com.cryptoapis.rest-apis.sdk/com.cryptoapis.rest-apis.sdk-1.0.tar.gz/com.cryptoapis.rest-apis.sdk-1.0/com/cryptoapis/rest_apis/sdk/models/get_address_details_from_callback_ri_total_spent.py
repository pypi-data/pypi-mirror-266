...
class GetAddressDetailsFromCallbackRITotalSpent(BaseModel):
    ...
    """ # noqa: E501
    amount: StrictStr = Field(description="Defines the total spent amount of the address")
    unit: StrictStr = Field(description="Defines the unit of the total spent amount of the address")
