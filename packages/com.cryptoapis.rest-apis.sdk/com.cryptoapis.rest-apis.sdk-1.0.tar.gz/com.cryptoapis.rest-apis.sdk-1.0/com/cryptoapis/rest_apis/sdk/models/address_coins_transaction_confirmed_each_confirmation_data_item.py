...
class AddressCoinsTransactionConfirmedEachConfirmationDataItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["blockchain", "network", "address", "minedInBlock", "transactionId", "currentConfirmations", "targetConfirmations", "amount", "unit", "direction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minedInBlock": AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock.from_dict(obj["minedInBlock"]) if obj.get("minedInBlock") is not None else None,
