...
class DecodeRawTransactionHexRISE(BaseModel):
    ...
    max_fee_per_gas: Optional[StrictStr] = Field(default=None, description="Defines the maximum amount that customer is willing to pay per unit of gas to get his transaction included in a block.", alias="maxFeePerGas")
    max_fee_priority_per_gas: Optional[StrictStr] = Field(default=None, description="Represents determined by the user value that is paid directly to miners.", alias="maxFeePriorityPerGas")
    ...
    __properties: ClassVar[List[str]] = ["approximateFee", "approximateMinimumRequiredFee", "gasLimit", "gasPaidForData", "gasPrice", "inputData", "maxFeePerGas", "maxFeePriorityPerGas", "nonce", "r", "recipient", "s", "sender", "type", "v", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maxFeePriorityPerGas": obj.get("maxFeePriorityPerGas"),
            "nonce": obj.get("nonce"),
            "r": obj.get("r"),
