...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRITotalAmount(BaseModel):
    ...
    """ # noqa: E501
    unit: Optional[StrictStr] = Field(default=None, description="Defines the unit of the total amount transacted.")
    value: Optional[StrictStr] = Field(default=None, description="Total amount of the transaction")
