...
class ListUnconfirmedTransactionsByAddressRIBSL(BaseModel):
    ...
    vin: List[ListUnconfirmedTransactionsByAddressRIBSLVinInner] = Field(description="Represents the transaction inputs.")
    vout: List[ListUnconfirmedTransactionsByAddressRIBSLVoutInner] = Field(description="Represents the transaction outputs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vin": [ListUnconfirmedTransactionsByAddressRIBSLVinInner.from_dict(_item) for _item in obj["vin"]] if obj.get("vin") is not None else None,
            "vout": [ListUnconfirmedTransactionsByAddressRIBSLVoutInner.from_dict(_item) for _item in obj["vout"]] if obj.get("vout") is not None else None
        })
        return _obj
