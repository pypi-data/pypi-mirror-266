...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem(BaseModel):
    ...
    recipient_address: StrictStr = Field(description="Defines the specific recipient/destination address.", alias="recipientAddress")
    __properties: ClassVar[List[str]] = ["amount", "callbackSecretKey", "callbackUrl", "note", "recipientAddress"]
