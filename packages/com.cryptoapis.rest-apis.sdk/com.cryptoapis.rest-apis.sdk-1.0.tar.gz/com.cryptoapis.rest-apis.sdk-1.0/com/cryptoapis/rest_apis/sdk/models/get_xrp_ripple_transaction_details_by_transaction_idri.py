...
class GetXRPRippleTransactionDetailsByTransactionIDRI(BaseModel):
    ...
    mined_in_block_height: StrictStr = Field(description="Represents the hight of the block where this transaction was mined/confirmed for first time. The height is defined as the number of blocks in the blockchain preceding this specific block.", alias="minedInBlockHeight")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Defines the status of the transaction.")
    ...
    __properties: ClassVar[List[str]] = ["additionalData", "destinationTag", "index", "minedInBlockHash", "minedInBlockHeight", "offer", "receive", "recipients", "senders", "sequence", "status", "timestamp", "transactionHash", "type", "fee", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "fee": GetXRPRippleTransactionDetailsByTransactionIDRIFee.from_dict(obj["fee"]) if obj.get("fee") is not None else None,
            "value": GetXRPRippleTransactionDetailsByTransactionIDRIValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
