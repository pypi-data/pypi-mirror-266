...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSZVinInner(BaseModel):
    ...
    output_index: StrictInt = Field(description="Representation of the output index", alias="outputIndex")
    ...
    __properties: ClassVar[List[str]] = ["address", "change", "derivationIndex", "outputIndex", "satoshis", "script", "sighash", "transactionId"]
