...
class NewConfirmedInternalTransactionsRI(BaseModel):
    ...
    callback_secret_key: StrictStr = Field(description="Represents the Secret Key value provided by the customer. This field is used for security purposes during the callback notification, in order to prove the sender of the callback as Crypto APIs 2.0. For more information please see our [Documentation](https://developers.cryptoapis.io/technical-documentation/general-information/callbacks#callback-security).", alias="callbackSecretKey")
    ...
    receive_callback_on: StrictInt = Field(description="Represents the exact confirmation, on which the user wants to receive callback.", alias="receiveCallbackOn")
    ...
    __properties: ClassVar[List[str]] = ["address", "callbackSecretKey", "callbackUrl", "createdTimestamp", "eventType", "isActive", "receiveCallbackOn", "referenceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "receiveCallbackOn": obj.get("receiveCallbackOn"),
