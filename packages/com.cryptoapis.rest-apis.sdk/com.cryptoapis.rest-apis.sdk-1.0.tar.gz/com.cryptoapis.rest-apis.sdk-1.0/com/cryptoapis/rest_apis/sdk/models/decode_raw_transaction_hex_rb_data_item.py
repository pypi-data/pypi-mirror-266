...
class DecodeRawTransactionHexRBDataItem(BaseModel):
    ...
    """ # noqa: E501
    raw_transaction_hex: StrictStr = Field(description="Represents the raw transaction Hex that has to be decoded.", alias="rawTransactionHex")
    __properties: ClassVar[List[str]] = ["rawTransactionHex"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rawTransactionHex": obj.get("rawTransactionHex")
        })
        return _obj
