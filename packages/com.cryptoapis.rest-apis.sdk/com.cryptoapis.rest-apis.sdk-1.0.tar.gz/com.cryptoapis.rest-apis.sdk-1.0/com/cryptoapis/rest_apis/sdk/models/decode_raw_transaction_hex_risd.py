...
class DecodeRawTransactionHexRISD(BaseModel):
    ...
    vin: List[DecodeRawTransactionHexRISDVinInner] = Field(description="Represents the transaction inputs.")
    vout: List[DecodeRawTransactionHexRISDVoutInner] = Field(description="Represents the transaction outputs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vin": [DecodeRawTransactionHexRISDVinInner.from_dict(_item) for _item in obj["vin"]] if obj.get("vin") is not None else None,
            "vout": [DecodeRawTransactionHexRISDVoutInner.from_dict(_item) for _item in obj["vout"]] if obj.get("vout") is not None else None,
