...
class GetAddressDetailsFromCallbackRIConfirmedBalance(BaseModel):
    ...
    """ # noqa: E501
    amount: StrictStr = Field(description="Representation of the total balance of the address")
    unit: StrictStr = Field(description="Defines the unit of the total balance of the address")
