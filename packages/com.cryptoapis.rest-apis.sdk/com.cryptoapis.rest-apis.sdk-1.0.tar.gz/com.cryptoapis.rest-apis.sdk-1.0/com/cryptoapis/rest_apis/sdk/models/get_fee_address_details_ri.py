...
class GetFeeAddressDetailsRI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "balance", "minimumTransferAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "balance": GetFeeAddressDetailsRIBalance.from_dict(obj["balance"]) if obj.get("balance") is not None else None,
