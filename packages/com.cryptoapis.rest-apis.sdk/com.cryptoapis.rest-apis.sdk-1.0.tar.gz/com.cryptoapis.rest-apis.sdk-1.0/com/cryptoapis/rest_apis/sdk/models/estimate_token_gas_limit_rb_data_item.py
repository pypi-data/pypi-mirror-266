...
class EstimateTokenGasLimitRBDataItem(BaseModel):
    ...
    contract_type: StrictStr = Field(description="Represents the ERC contract type. It can be ERC20 or ERC721", alias="contractType")
    ...
    __properties: ClassVar[List[str]] = ["amount", "contract", "contractType", "recipient", "sender"]
