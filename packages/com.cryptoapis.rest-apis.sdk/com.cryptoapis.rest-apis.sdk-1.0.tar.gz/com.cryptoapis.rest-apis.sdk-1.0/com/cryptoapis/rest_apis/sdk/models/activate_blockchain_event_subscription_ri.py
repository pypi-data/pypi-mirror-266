...
class ActivateBlockchainEventSubscriptionRI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "blockchain", "callbackSecretKey", "callbackUrl", "confirmationsCount", "createdTimestamp", "eventType", "isActive", "network", "referenceId", "transactionId"]
