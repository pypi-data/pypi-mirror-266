...
class ListBlockchainEventsSubscriptionsRI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "callbackSecretKey", "callbackUrl", "confirmationsCount", "createdTimestamp", "deactivationReasons", "eventType", "isActive", "referenceId", "transactionId"]
