...
class DecodeRawTransactionHexRISB(BaseModel):
    ...
    vin: List[DecodeRawTransactionHexRISBVinInner] = Field(description="Represents the transaction inputs.")
    vout: List[DecodeRawTransactionHexRISBVoutInner] = Field(description="Represents the transaction outputs.")
    weight: Optional[StrictInt] = Field(default=None, description="Represents the size of Bitcoin block, measured in weight units and including the segwit discount.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vin": [DecodeRawTransactionHexRISBVinInner.from_dict(_item) for _item in obj["vin"]] if obj.get("vin") is not None else None,
            "vout": [DecodeRawTransactionHexRISBVoutInner.from_dict(_item) for _item in obj["vout"]] if obj.get("vout") is not None else None,
