...
class MetadataApi:
    ...
    def list_supported_assets(
        ...
        asset_type: Annotated[Optional[StrictStr], Field(description="Defines the type of the supported asset. This could be either \"crypto\" or \"fiat\".")] = None,
        ...
        _param = self._list_supported_assets_serialize(
            context=context,
    ...
    @validate_call
    def list_supported_assets_with_http_info(
        self,
        context: Annotated[Optional[StrictStr], Field(description="In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.")] = None,
        asset_type: Annotated[Optional[StrictStr], Field(description="Defines the type of the supported asset. This could be either \"crypto\" or \"fiat\".")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Defines how many items should be returned in the response per page basis.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListSupportedAssetsR]:
        """List Supported Assets
    ...
    @validate_call
    def list_supported_assets_without_preload_content(
        self,
        context: Annotated[Optional[StrictStr], Field(description="In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.")] = None,
        asset_type: Annotated[Optional[StrictStr], Field(description="Defines the type of the supported asset. This could be either \"crypto\" or \"fiat\".")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Defines how many items should be returned in the response per page basis.")] = None,
    ...
    def _list_supported_assets_serialize(
        self,
        context,
        asset_type,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/market-data/assets/supported',
