...
class GetWalletTransactionDetailsByTransactionIDRISendersInner(BaseModel):
    ...
    """ # noqa: E501
    address: Optional[StrictStr] = Field(default=None, description="String array representation of the sender address")
    amount: Optional[StrictStr] = Field(default=None, description="String representation of the amount")
