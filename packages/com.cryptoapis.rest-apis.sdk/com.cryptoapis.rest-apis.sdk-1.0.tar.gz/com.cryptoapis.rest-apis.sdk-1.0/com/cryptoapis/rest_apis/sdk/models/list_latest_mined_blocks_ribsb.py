...
class ListLatestMinedBlocksRIBSB(BaseModel):
    ...
    nonce: Optional[StrictInt] = Field(default=None, description="Represents a random value that can be adjusted to satisfy the proof of work")
    size: Optional[StrictInt] = Field(default=None, description="Represents the block size")
