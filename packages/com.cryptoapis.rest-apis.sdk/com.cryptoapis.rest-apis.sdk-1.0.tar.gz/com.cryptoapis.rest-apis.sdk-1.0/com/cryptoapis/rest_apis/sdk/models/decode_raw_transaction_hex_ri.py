...
class DecodeRawTransactionHexRI(BaseModel):
    ...
    transaction_id: StrictStr = Field(description="Represents the decoded transaction hex.", alias="transactionId")
    __properties: ClassVar[List[str]] = ["blockchainSpeficicData", "size", "transactionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "blockchainSpeficicData": DecodeRawTransactionHexRIS.from_dict(obj["blockchainSpeficicData"]) if obj.get("blockchainSpeficicData") is not None else None,
            "size": obj.get("size"),
