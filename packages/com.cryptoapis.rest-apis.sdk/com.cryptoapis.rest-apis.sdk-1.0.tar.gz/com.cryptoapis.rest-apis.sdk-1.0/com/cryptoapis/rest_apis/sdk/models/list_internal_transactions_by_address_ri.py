...
class ListInternalTransactionsByAddressRI(BaseModel):
    ...
    operation_type: StrictStr = Field(description="Defines the call type of the internal transaction.", alias="operationType")
    parent_hash: StrictStr = Field(description="Defines the specific hash of the parent transaction.", alias="parentHash")
    ...
    timestamp: StrictInt
    __properties: ClassVar[List[str]] = ["amount", "minedInBlockHash", "minedInBlockHeight", "operationID", "operationType", "parentHash", "recipient", "sender", "timestamp"]
