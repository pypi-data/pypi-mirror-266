...
class ListTransactionsByBlockHeightRIBSB(BaseModel):
    ...
    vout: List[ListTransactionsByBlockHeightRIBSBVoutInner] = Field(description="Represents the transaction outputs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vout": [ListTransactionsByBlockHeightRIBSBVoutInner.from_dict(_item) for _item in obj["vout"]] if obj.get("vout") is not None else None
        })
        return _obj
