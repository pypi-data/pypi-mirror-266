...
class TokensForwardingSuccessErc721(BaseModel):
    ...
    token_id: StrictStr = Field(description="Specifies the ID of the token.", alias="tokenId")
    contract_address: StrictStr = Field(description="Specifies the address of the contract.", alias="contractAddress")
    __properties: ClassVar[List[str]] = ["name", "symbol", "tokenId", "contractAddress"]
