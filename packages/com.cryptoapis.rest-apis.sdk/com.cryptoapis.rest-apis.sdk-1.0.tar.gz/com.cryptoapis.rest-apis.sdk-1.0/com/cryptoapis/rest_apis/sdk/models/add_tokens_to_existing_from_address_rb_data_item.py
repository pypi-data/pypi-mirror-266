...
class AddTokensToExistingFromAddressRBDataItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["callbackSecretKey", "callbackUrl", "confirmationsCount", "feePriority", "fromAddress", "minimumTransferAmount", "toAddress", "tokenData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tokenData": AddTokensToExistingFromAddressRBTokenData.from_dict(obj["tokenData"]) if obj.get("tokenData") is not None else None
        })
        return _obj
