...
class BroadcastTransactionFailDataItem(BaseModel):
    ...
    error_message: StrictStr = Field(description="Represents the error message received for the transaction.", alias="errorMessage")
    __properties: ClassVar[List[str]] = ["blockchain", "network", "transactionId", "errorMessage"]
