...
class ListTransactionsByBlockHeightRIBSL(BaseModel):
    ...
    vin: List[ListTransactionsByBlockHeightRIBSLVinInner] = Field(description="Represents the transaction inputs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vin": [ListTransactionsByBlockHeightRIBSLVinInner.from_dict(_item) for _item in obj["vin"]] if obj.get("vin") is not None else None,
