...
class BroadcastLocallySignedTransactionRBDataItem(BaseModel):
    ...
    signed_transaction_hex: StrictStr = Field(description="Represents the signed transaction's specific hex.", alias="signedTransactionHex")
    __properties: ClassVar[List[str]] = ["callbackSecretKey", "callbackUrl", "signedTransactionHex"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signedTransactionHex": obj.get("signedTransactionHex")
        })
        return _obj
