...
class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRBDataItem(BaseModel):
    ...
    token_identifier: StrictStr = Field(description="Token identifier - for BITCOIN BASED should be property id e.g 31 for ETHEREUM BASED shoud be contract e.g 0xdac17f958d2ee523a2206206994597c13d831ec7", alias="tokenIdentifier")
    __properties: ClassVar[List[str]] = ["amount", "callbackSecretKey", "callbackUrl", "feeLimit", "note", "recipientAddress", "tokenIdentifier"]
