...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scriptPubKey": GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey.from_dict(obj["scriptPubKey"]) if obj.get("scriptPubKey") is not None else None,
            "value": obj.get("value")
        })
        return _obj
