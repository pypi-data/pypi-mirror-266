...
class ListCoinsForwardingAutomationsRI(BaseModel):
    ...
    confirmations_count_trigger: StrictInt = Field(description="Represents the total count of the transaction confirmations before triggering the event.", alias="confirmationsCountTrigger")
    ...
    reference_id: StrictStr = Field(description="Represents a unique ID used to reference the specific forwarding automation.", alias="referenceId")
    to_address: StrictStr = Field(description="Represents the hash of the address the currency is forwarded to.", alias="toAddress")
    __properties: ClassVar[List[str]] = ["callbackUrl", "confirmationsCountTrigger", "createdTimestamp", "feePriority", "fromAddress", "minimumTransferAmount", "referenceId", "toAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "confirmationsCountTrigger": obj.get("confirmationsCountTrigger"),
