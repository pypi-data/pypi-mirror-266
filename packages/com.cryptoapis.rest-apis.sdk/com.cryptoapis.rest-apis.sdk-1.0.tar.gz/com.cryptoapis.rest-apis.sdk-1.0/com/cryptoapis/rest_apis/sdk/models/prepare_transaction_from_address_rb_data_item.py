...
class PrepareTransactionFromAddressRBDataItem(BaseModel):
    ...
    """ # noqa: E501
    additional_data: Optional[StrictStr] = Field(default=None, description="Represents an optional note to add a free text in, explaining or providing additional detail on the transaction request.", alias="additionalData")
    ...
    fee: PrepareTransactionFromAddressRBDataItemFee
    ...
    __properties: ClassVar[List[str]] = ["additionalData", "amount", "nonce", "recipient", "sender", "fee", "transactionType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fee": PrepareTransactionFromAddressRBDataItemFee.from_dict(obj["fee"]) if obj.get("fee") is not None else None,
