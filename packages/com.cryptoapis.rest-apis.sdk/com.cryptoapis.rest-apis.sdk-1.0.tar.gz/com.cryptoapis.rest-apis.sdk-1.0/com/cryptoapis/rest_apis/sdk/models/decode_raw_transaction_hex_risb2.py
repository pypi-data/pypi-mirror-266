...
class DecodeRawTransactionHexRISB2(BaseModel):
    ...
    vin: List[DecodeRawTransactionHexRISB2VinInner] = Field(description="Represents the transaction inputs.")
    vout: List[DecodeRawTransactionHexRISB2VoutInner] = Field(description="Represents the transaction outputs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vin": [DecodeRawTransactionHexRISB2VinInner.from_dict(_item) for _item in obj["vin"]] if obj.get("vin") is not None else None,
            "vout": [DecodeRawTransactionHexRISB2VoutInner.from_dict(_item) for _item in obj["vout"]] if obj.get("vout") is not None else None,
