...
class GetBlockDetailsByBlockHeightRI(BaseModel):
    ...
    height: StrictStr = Field(description="Represents the number of blocks in the blockchain preceding this specific block. Block numbers have no gaps. A blockchain usually starts with block 0 called the \"Genesis block\".")
    next_block_hash: StrictStr = Field(description="Representation of the next block hash.", alias="nextBlockHash")
    ...
    __properties: ClassVar[List[str]] = ["hash", "height", "nextBlockHash", "previousBlockHash", "timestamp", "transactionsCount", "blockchainSpecific"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blockchainSpecific": GetBlockDetailsByBlockHeightRIBS.from_dict(obj["blockchainSpecific"]) if obj.get("blockchainSpecific") is not None else None
        })
        return _obj
