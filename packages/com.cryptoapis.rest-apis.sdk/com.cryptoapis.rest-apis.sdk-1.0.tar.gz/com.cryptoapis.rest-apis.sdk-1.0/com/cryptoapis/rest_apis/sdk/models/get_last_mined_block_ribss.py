...
class GetLastMinedBlockRIBSS(BaseModel):
    """
    Stellar
    """ # noqa: E501
    ...
    fail_transactions: StrictInt = Field(description="Numeric representation of the block failed transactions count", alias="failTransactions")
    protocol_version: StrictStr = Field(description="String representation of protocol version", alias="protocolVersion")
    total_coins: StrictStr = Field(description="Representation of the total coins", alias="totalCoins")
    __properties: ClassVar[List[str]] = ["baseFee", "baseReserve", "failTransactions", "protocolVersion", "totalCoins"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLastMinedBlockRIBSS from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLastMinedBlockRIBSS from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "failTransactions": obj.get("failTransactions"),
