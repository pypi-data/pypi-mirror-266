...
class CreateFungibleTokensTransactionRequestFromAddressRBDataItem(BaseModel):
    ...
    recipient_address: StrictStr = Field(description="Defines the specific recipient address for the transaction.", alias="recipientAddress")
    token_identifier: StrictStr = Field(description="Defines the specific token identifier. For Bitcoin-based transactions it should be the `propertyId` and for Ethereum-based transactions - the `contract`.", alias="tokenIdentifier")
    __properties: ClassVar[List[str]] = ["amount", "callbackSecretKey", "callbackUrl", "feePriority", "note", "recipientAddress", "tokenIdentifier"]
