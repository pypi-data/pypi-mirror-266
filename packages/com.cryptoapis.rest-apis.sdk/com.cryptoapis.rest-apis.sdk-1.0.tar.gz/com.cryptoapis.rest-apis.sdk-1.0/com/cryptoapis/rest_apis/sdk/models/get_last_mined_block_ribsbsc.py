...
class GetLastMinedBlockRIBSBSC(BaseModel):
    ...
    Binance Smart Chain
    """ # noqa: E501
    difficulty: Optional[StrictStr] = Field(default=None, description="String representation of the block difficulty")
    ...
    mined_in_seconds: StrictInt = Field(description="Specifies the amount of time required for the block to be mined in second", alias="minedInSeconds")
