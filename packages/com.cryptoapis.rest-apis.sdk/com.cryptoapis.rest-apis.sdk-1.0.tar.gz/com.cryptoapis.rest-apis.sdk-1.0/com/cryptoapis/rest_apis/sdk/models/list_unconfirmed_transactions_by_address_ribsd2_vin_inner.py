...
class ListUnconfirmedTransactionsByAddressRIBSD2VinInner(BaseModel):
    ...
    value: Optional[StrictStr] = Field(default=None, description="String representation of the amount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scriptSig": ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig.from_dict(obj["scriptSig"]) if obj.get("scriptSig") is not None else None,
