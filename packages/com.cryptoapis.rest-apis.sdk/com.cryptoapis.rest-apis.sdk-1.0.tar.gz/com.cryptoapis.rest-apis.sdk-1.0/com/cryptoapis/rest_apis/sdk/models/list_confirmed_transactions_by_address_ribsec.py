...
class ListConfirmedTransactionsByAddressRIBSEC(BaseModel):
    ...
    internal_transactions_count: StrictInt = Field(description="Represents the total internal transactions count.", alias="internalTransactionsCount")
    ...
    token_transfers_count: StrictInt = Field(description="Represents the total token transfers count.", alias="tokenTransfersCount")
    transaction_status: StrictStr = Field(description="String representation of the transaction status", alias="transactionStatus")
    __properties: ClassVar[List[str]] = ["contract", "gasLimit", "gasPrice", "gasUsed", "inputData", "internalTransactionsCount", "nonce", "tokenTransfersCount", "transactionStatus"]
