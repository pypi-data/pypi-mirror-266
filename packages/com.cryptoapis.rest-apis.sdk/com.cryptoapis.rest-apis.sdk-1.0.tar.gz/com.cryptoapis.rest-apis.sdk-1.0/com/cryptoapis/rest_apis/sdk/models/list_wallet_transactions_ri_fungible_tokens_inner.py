...
class ListWalletTransactionsRIFungibleTokensInner(BaseModel):
    ...
    converted_amount: StrictStr = Field(description="Defines the tokens' converted amount value.", alias="convertedAmount")
    exchange_rate_unit: StrictStr = Field(description="Represents token's exchange rate unit.", alias="exchangeRateUnit")
    ...
    token_decimals: StrictInt = Field(description="Defines the decimals of the token, i.e. the number of digits that come after the decimal coma of the token.", alias="tokenDecimals")
    type: StrictStr = Field(description="Defines the specific token type.")
    __properties: ClassVar[List[str]] = ["amount", "convertedAmount", "exchangeRateUnit", "name", "recipient", "sender", "symbol", "tokenDecimals", "type"]
