...
class EstimateGasLimitRBDataItem(BaseModel):
    ...
    """ # noqa: E501
    additional_data: Optional[StrictStr] = Field(default=None, description="Represents an optional field to add additonal data.", alias="additionalData")
    ...
    __properties: ClassVar[List[str]] = ["additionalData", "amount", "recipient", "sender"]
