...
class BlockHeightReachedRBDataItem(BaseModel):
    ...
    block_height_reached: StrictInt = Field(description="Represents the specified value of block height for which the callback will be received.", alias="blockHeightReached")
    ...
    __properties: ClassVar[List[str]] = ["allowDuplicates", "blockHeightReached", "callbackSecretKey", "callbackUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blockHeightReached": obj.get("blockHeightReached"),
