...
from foundationallm.cli.core import _debug
from foundationallm.cli.core.auth.util import resource_to_scopes
from foundationallm.cli.core.extension import EXTENSIONS_MOD_PREFIX
from foundationallm.cli.core.profiles import ResourceType, CustomResourceType, get_api_version, get_sdk
from foundationallm.cli.core.profiles._shared import get_client_class, SDKProfile
from foundationallm.cli.core.util import get_az_user_agent, is_track2
...
def resolve_client_arg_name(operation, kwargs):
    ...
    if path_comps[0] == 'azure' or path_comps[0] == 'foundationallm':
        if path_comps[1] != 'cli' or _is_vendored_sdk_path(path_comps):
            ...
            # Vendored SDK: foundationallm.cli.command_modules.keyvault.vendored_sdks...
            client_arg_name = 'self'
        else:
            # CLI custom method: foundationallm.cli.command_modules.resource...
...
def get_mgmt_service_client(cli_ctx, client_or_resource_type, subscription_id=None, api_version=None,
    ...
    :param client_or_resource_type: Python SDK mgmt-plane client type or a member of
        foundationallm.cli.core.profiles._shared.ResourceType
...
def _prepare_client_kwargs_track2(cli_ctx):
    ...
    from foundationallm.cli.core.sdk.policies import SafeNetworkTraceLoggingPolicy
...
def _get_mgmt_service_client(cli_ctx,
    ...
    if credential:
        ...
        # Get a credential for the current `fllm login` context
