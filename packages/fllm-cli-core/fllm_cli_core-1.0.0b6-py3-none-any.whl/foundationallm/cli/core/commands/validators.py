...
def get_default_location_from_resource_group(cmd, namespace):
    if not namespace.location:
        ...
        # We don't use try catch here to let foundationallm.cli.core.parser.AzCliCommandParser.validation_error
        # handle exceptions, such as foundationallm.core.exceptions.ResourceNotFoundError
...
def validate_file_or_dict(string):
    ...
    try:
        if os.path.exists(string):
            from foundationallm.cli.core.util import get_file_json
