...
# --------------------------------------------------------------------------------------------
import argparse
from foundationallm.cli.core import AzCommandsLoader, EXCLUDED_PARAMS
...
class GenericUpdateCommandOperation(BaseCommandOperation):     # pylint: disable=too-many-instance-attributes
    ...
    def handler(self, command_args):  # pylint: disable=too-many-locals, too-many-statements, too-many-branches
        ...
        from foundationallm.cli.core.commands import cached_get, cached_put, _is_poller
        from foundationallm.cli.core.util import find_child_item, augment_no_wait_handler_args
        from foundationallm.cli.core.commands.arm import add_usage, remove_usage, set_usage, \
    ...
    def _extract_op_handler_and_args(self, args, op_path):
        from foundationallm.cli.core.commands.arm import EXCLUDED_NON_CLIENT_PARAMS
    ...
    def arguments_loader(self):
        """ Callback function of CLICommand arguments_loader """
        from foundationallm.cli.core.commands.arm import set_usage, add_usage, remove_usage
...
class ShowCommandOperation(BaseCommandOperation):
    ...
    def handler(self, command_args):
        """ Callback function of CLICommand handler """
        from foundationallm.cli.core.commands.arm import show_exception_handler, EXCLUDED_NON_CLIENT_PARAMS
...
class WaitCommandOperation(BaseCommandOperation):
    ...
    def wait(cls, command_args, cli_ctx, getter):
        ...
        from knack.util import CLIError
        from foundationallm.cli.core.azclierror import InvalidArgumentValueError, AzureResponseError
        from foundationallm.cli.core.commands.arm import verify_property
        from foundationallm.cli.core.commands.progress import IndeterminateProgressBar
        import time
