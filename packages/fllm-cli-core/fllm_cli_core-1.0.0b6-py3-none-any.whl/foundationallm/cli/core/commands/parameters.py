...
from foundationallm.cli.core.commands.constants import CLI_PARAM_KWARGS, CLI_POSITIONAL_PARAM_KWARGS
from foundationallm.cli.core.commands.validators import validate_tag, validate_tags, generate_deployment_name
from foundationallm.cli.core.decorators import Completer
from foundationallm.cli.core.profiles import ResourceType
from foundationallm.cli.core.local_context import LocalContextAttribute, LocalContextAction, ALL
...
def get_subscription_locations(cli_ctx):
    from foundationallm.cli.core.commands.client_factory import get_subscription_service_client
...
class AzArgumentContext(ArgumentsContext):
    ...
    def __init__(self, command_loader, scope, **kwargs):
        from foundationallm.cli.core.commands import _merge_kwargs as merge_kwargs
    ...
    def expand(self, dest, model_type, group_name=None, patches=None):
        ...
        # should be moved into foundationallm.cli.core
