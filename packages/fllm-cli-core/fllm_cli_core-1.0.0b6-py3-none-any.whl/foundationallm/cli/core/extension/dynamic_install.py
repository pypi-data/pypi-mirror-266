...
def _get_extension_command_tree(cli_ctx):
    from foundationallm.cli.core._session import EXT_CMD_TREE
    import os
...
def _check_value_in_extensions(cli_ctx, parser, args, no_prompt):  # pylint: disable=too-many-statements, too-many-locals
    ...
    from foundationallm.cli.core.azclierror import NoTTYError
    exit_code = 2
    ...
    from foundationallm.cli.core.extension import get_extension, ExtensionNotInstalledException
    from foundationallm.cli.core.extension._resolve import resolve_from_index, NoExtensionCandidatesError
    try:
    ...
    print_error = True
    if install_ext:
        from foundationallm.cli.core.extension.operations import add_extension
