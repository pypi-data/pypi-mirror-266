...
from foundationallm.cli.core import AzCli
...
class DummyCli(AzCli):
    ...
    def __init__(self, commands_loader_cls=None, random_config_dir=False, **kwargs):
        ...
        from foundationallm.cli.core import MainCommandsLoader
        ...
        from foundationallm.cli.core.util import random_string
        from foundationallm.cli.core._config import GLOBAL_CONFIG_DIR, ENV_VAR_PREFIX, ENV_VAR_TEST_LIVE
    ...
    def get_cli_version(self):
        from foundationallm.cli.core import __version__ as cli_version
        return cli_version
