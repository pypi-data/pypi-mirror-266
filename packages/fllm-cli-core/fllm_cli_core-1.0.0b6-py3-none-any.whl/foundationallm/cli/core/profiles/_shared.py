...
class ResourceType(Enum):  # pylint: disable=too-few-public-methods
    ...
    DATA_KEYVAULT = ('foundationallm.cli.command_modules.keyvault.vendored_sdks.azure_keyvault_t1', 'KeyVaultClient')
    ...
    MGMT_DATALAKE_ANALYTICS = ('foundationallm.cli.command_modules.dla.vendored_sdks.azure_mgmt_datalake_analytics', None)
