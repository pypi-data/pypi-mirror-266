...
from foundationallm.core.exceptions import ServiceRequestError
from foundationallm.core.pipeline.policies import HTTPPolicy


class AAZBearerTokenCredentialPolicy(HTTPPolicy):
    """

    Followed the implement of foundationallm.core.pipeline.policies.BearerTokenCredentialPolicy
    """
    ...
    def on_request(self, request):
        ...
        :param ~foundationallm.core.pipeline.PipelineRequest request: the request
        """
    ...
    def send(self, request):
        ...
        :type request: ~foundationallm.core.pipeline.PipelineRequest
        """
    ...
    def on_challenge(self, request, response):
        ...
        :param ~foundationallm.core.pipeline.PipelineRequest request: the request which elicited an authentication challenge
        :param ~foundationallm.core.pipeline.PipelineResponse response: the resource provider's response
    ...
    def on_response(self, request, response):
        ...
        :type response: ~foundationallm.core.pipeline.PipelineResponse
        """
...
class AAZARMChallengeAuthenticationPolicy(AAZBearerTokenCredentialPolicy):
    ...
    :param ~foundationallm.core.credentials.TokenCredential credential: credential for authorizing requests
    ...
    def on_challenge(self, request, response):  # pylint:disable=unused-argument
        ...
        :param ~foundationallm.core.pipeline.PipelineRequest request: the request which elicited an authentication challenge
        :param ~foundationallm.core.pipeline.PipelineResponse response: ARM's response
        :returns: a bool indicating whether the policy should send the request
        """
