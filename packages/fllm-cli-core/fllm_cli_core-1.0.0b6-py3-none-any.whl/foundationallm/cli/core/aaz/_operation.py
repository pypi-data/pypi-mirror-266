...
from foundationallm.core.exceptions import ClientAuthenticationError, ResourceExistsError, ResourceNotFoundError, \
    HttpResponseError
...
class AAZHttpOperation(AAZOperation):
    ...
    def deserialize_http_content(session):
        from foundationallm.core.pipeline.policies import ContentDecodePolicy
...
class AAZGenericInstanceUpdateOperation(AAZOperation):
    ...
    def _set_properties(self, instance, expression, force_string, flatten):
        from foundationallm.cli.core.commands.arm import _split_key_value_pair, shell_safe_json_parse, index_or_filter_regex
    ...
    def _add_properties(self, instance, argument_values, force_string, flatten):
        from foundationallm.cli.core.commands.arm import shell_safe_json_parse
    ...
    def _find_property(self, instance, path, flatten):
        from foundationallm.cli.core.commands.arm import index_or_filter_regex, shell_safe_json_parse
        try:
            for part in path:
    ...
    def _get_internal_path(path):
        from foundationallm.cli.core.commands.arm import _get_internal_path
