...
from foundationallm.cli.core.extension import get_extension
from foundationallm.cli.core.commands import ExtensionCommandSource
from foundationallm.cli.core.commands import AzCliCommandInvoker
from foundationallm.cli.core.commands.events import EVENT_INVOKER_ON_TAB_COMPLETION
from foundationallm.cli.core.command_recommender import CommandRecommender
from foundationallm.cli.core.azclierror import UnrecognizedArgumentError
from foundationallm.cli.core.azclierror import RequiredArgumentMissingError
from foundationallm.cli.core.azclierror import InvalidArgumentValueError
from foundationallm.cli.core.azclierror import ArgumentUsageError
from foundationallm.cli.core.azclierror import CommandNotFoundError
from foundationallm.cli.core.azclierror import ValidationError
...
class AzCliCommandParser(CLICommandParser):
    """ArgumentParser implementation specialized for the FLLM CLI utility."""
    ...
    def error(self, message):
        ...
        if '--query' in message:
            from foundationallm.cli.core.util import QUERY_REFERENCE
    ...
    def _check_value(self, action, value):
        ...
        if action.choices is not None and value not in action.choices:  # pylint: disable=too-many-nested-blocks
            ...
            if not self.command_source:
                from foundationallm.cli.core.extension.dynamic_install import try_install_extension
                candidates = []
