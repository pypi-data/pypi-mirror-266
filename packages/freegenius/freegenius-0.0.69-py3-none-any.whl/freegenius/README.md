...
FreeGenius AI incorporates four backends: llamcpp, ollama, gemini, and ollama. It also maintains backward compatibility with LetMeDoIt AI in LetMeDoIt Mode. The configuration of the LLM Backend is determined by the value of config.llmBackend, which defaults to 'llamacpp'.
