...
def run_0D_point(Ng,Tg,vturb,molecule,mol_mass,nu_0,Aul,E_u,E_l,gu,gl,QTpath,isotopolog,nu_grid):
    '''
...
def write_0D_output(output_filename,nu_grid,I_nu_line,tau_ret,R_grid,Ng,Tg,vturb):
    '''
