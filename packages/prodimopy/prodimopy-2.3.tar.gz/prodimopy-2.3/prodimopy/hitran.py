...
def read_hitran(filePath,moleculeName,isotopologue:list=[1],lowerLam=1,higherLam=30,sort_label='lambda',quanta=False,format:int=2020,verbose:bool=False):
    ...
    mol_MIR['global_u'] = mol_MIR['global_u'].astype(str)
    mol_MIR['global_l'] = mol_MIR['global_l'].astype(str)
    mol_MIR['local_u'] = mol_MIR['local_u'].astype(str)
    mol_MIR['local_l'] = mol_MIR['local_l'].astype(str)
    if quanta:
