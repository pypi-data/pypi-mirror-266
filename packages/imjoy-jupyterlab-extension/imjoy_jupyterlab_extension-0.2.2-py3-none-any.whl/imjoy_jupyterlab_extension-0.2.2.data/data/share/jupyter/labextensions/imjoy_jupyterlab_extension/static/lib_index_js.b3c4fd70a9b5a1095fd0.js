...
/* harmony import */ var _comm_connection_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./comm-connection.js */ "./lib/comm-connection.js");
/**
    ...
    for (let url of urls) {
        ...
        try {
            if (url.includes("//zenodo.org/record")) {
                url = await (0,_utils_js__WEBPACK_IMPORTED_MODULE_5__.convertZenodoFileUrl)(url);
            }
            else {
                url = await (0,_utils_js__WEBPACK_IMPORTED_MODULE_5__.githubUrlRaw)(url, ".ipynb") || url;
            }
            ...
            try {
                const name = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_3__.PathExt.basename(url).split("?")[0];
                ...
                (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showErrorMessage)(trans._p('showErrorMessage', 'Upload Error'), error);
            }
        }
        catch (reason) {
            ...
            return (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showErrorMessage)(trans.__('Cannot fetch'), reason);
        }
    }
    ...
    constructor(jupyterBaseUrl, labApp, fileBrowser) {
        ...
        (0,imjoy_core_dist_imjoy_loader__WEBPACK_IMPORTED_MODULE_0__.loadImJoyBasicApp)({
            ...
            async function connectPlugin(kernel_id) {
                ...
                await kernel.ready;
                const plugin = await imjoy.pm.connectPlugin(new _comm_connection_js__WEBPACK_IMPORTED_MODULE_6__.Connection({ kernel }));
            ...
            this.resolveNotebookHandler(async (sessionContext, panelNode, buttonNode) => {
                ...
                const _spinner = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.Spinner();
...
//# sourceMappingURL=lib_index_js.b3c4fd70a9b5a1095fd0.js.map