...
class _ClientBase:
    ...
    def _get_tester_status(self, namespace: str, address: str, tester_id: str) -> TestStatus:
        '''
        ...
        tester_status_raw = _call_function(
            ...
            ctypes.c_char_p,
            [namespace.encode(), address.encode(), tester_id],
            return_output=True,
        )
        ...
        return TestStatus({"test_results": tester_status})
    ...
    def tester_start_v1(
        ...
        Args:
            ...
            at_once: The number of threads for load test configuration, default is 1
            duration: The duration of the load test in seconds (e.g. 1s, 1m, 1h)
            stop_on_failure: Whether to stop the test on failure
        Returns:
