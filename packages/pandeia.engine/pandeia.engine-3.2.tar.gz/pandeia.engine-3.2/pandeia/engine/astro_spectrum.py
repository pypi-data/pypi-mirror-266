...
from .constants import PANDEIA_RTOL, PANDEIA_ATOL, CONVERSION_CONSTANT, SPECTRAL_LINE_WINDOW, SPECTRAL_LINE_SUBSAMPLE, SPECTRAL_MAX_SAMPLES, SPECTRAL_MAX_CHUNK, SCENE_FOV_PIXBUFFER, SCENE_MAX_PIXELVAL, PANDEIA_WAVEUNITS, PANDEIA_FLUXUNITS
...
class ConvolvedSceneCube(object):
    ...
    def brightest_pixel_rate(self, spectrum, central_profile_fraction, unique_offset):
        ...
        try:
            ...
            for offset in t.columns:
                ...
                corr_bright.append(integ.trapezoid(corr_rate, self.wave))
        ...
        brightest_pixel_rate = integ.trapezoid(corr_psf_profile_fp_pix_rate * q_yield, self.wave)
    ...
    def ote_rate(self, rate):
        ...
        f_lambda = CONVERSION_CONSTANT * (rate / np.array(self.wave, dtype=np.float32))
