...
a_strategy_choice = {
    'type': 'object',
    'oneOf': [a_strategy_coronagraphy, a_strategy_ifuapphot, a_strategy_ifunodinscene, a_strategy_ifunodoffscene, a_strategy_imagingapphot,
              a_strategy_imagingscanapphot, a_strategy_msaapphot, a_strategy_msafullapphot, a_strategy_msashutterapphot,
...
an_instrument_name = {
    'oneOf': [an_instrument_name_hst, an_instrument_name_jwst],
}
