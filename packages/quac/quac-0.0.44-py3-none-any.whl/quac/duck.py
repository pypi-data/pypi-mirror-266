...
# %% auto 0
__all__ = ['iterable', 'itertype', 'notstriter', 'iterlike', 'iterq', 'listq', 'tupleq', 'nlen', 'len1', 'len2', 'len3', 'len4',
...
class notstriter(itertype[*Ts], Generic[*Ts]):
    '''An iterable but not of `strbytes`'''
    __ducktype__ = (grds.NotStrBytesIterable, )
    
class iterlike(Duck, Generic[*Ts]):
