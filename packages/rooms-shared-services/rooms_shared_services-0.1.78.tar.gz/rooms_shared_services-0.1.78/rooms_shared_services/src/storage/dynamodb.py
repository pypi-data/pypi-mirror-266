...
class DynamodbStorageClient(AbstractStorageClient):
    ...
    def batch_retrieve(self, keys: list[dict[Any, Any]] | None = None, table_items: list[dict] | None = None, request_items: dict[str, dict] | None = None):
        ...
        if resp["UnprocessedKeys"]:
            return self.batch_retrieve(table_items=table_items, request_items=resp["UnprocessedKeys"])
