...
#define CONFIGURE_ARGS " '--prefix=/d/a/pgserver/pgserver/pgbuild/../src/pgserver/pginstall/' '--without-readline' 'PKG_CONFIG_PATH=C:\hostedtoolcache\windows\Python\3.10.11\x64/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 15.5 on x86_64-pc-mingw64, compiled by gcc.exe (x86_64-posix-seh-rev2, Built by MinGW-W64 project) 12.2.0, 64-bit"
