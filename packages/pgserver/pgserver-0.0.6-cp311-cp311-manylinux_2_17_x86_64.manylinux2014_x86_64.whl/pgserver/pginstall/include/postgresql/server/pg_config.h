...
#define CONFIGURE_ARGS " '--prefix=/project/pgbuild/../src/pgserver/pginstall/' '--without-readline' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 15.5 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 10.2.1 20210130 (Red Hat 10.2.1-11), 64-bit"
