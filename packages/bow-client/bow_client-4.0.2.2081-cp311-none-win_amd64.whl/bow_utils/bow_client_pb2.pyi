...
class User(_message.Message):
    __slots__ = ["user_id", "email", "password", "name", "year_born", "country", "marketing", "termsagreed", "company", "profession", "join_date", "email_validated"]
    ...
    def __init__(self, user_id: _Optional[str] = ..., email: _Optional[str] = ..., password: _Optional[str] = ..., name: _Optional[str] = ..., year_born: _Optional[int] = ..., country: _Optional[str] = ..., marketing: bool = ..., termsagreed: bool = ..., company: _Optional[str] = ..., profession: _Optional[str] = ..., join_date: _Optional[int] = ..., email_validated: bool = ...) -> None: ...
