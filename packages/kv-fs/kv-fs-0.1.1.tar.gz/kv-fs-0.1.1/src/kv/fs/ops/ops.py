...
def insert(path: str, data: bytes, *, exists_ok: bool = False) -> Either[FileExistsError | OSError, None]:
...
def update(path: str, data: bytes) -> Either[FileNotFoundError | OSError, None]:
  try:
