...
#define DESCRIPTION "Fast and Portable Cryptography Extension Library for cybergram\n" \
    "tgcyber is part of cybergram, a Telegram MTProto library for Python\n" \
    "You can learn more about cybergram here: https://cybergram.org\n"
...
PyMODINIT_FUNC PyInit_tgcyber(void) {
