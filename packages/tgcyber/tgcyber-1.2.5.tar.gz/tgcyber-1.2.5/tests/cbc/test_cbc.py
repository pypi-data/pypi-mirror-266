...
class TestCBC256NIST(unittest.TestCase):
    ...
    def test_cbc256_encrypt(self):
        ...
        self.assertEqual(tgcyber.cbc256_encrypt(plaintext, key, iv), ciphertext)
    ...
    def test_cbc256_decrypt(self):
        ...
        self.assertEqual(tgcyber.cbc256_decrypt(ciphertext, key, iv), plaintext)
...
class TestCBC256Cryptography(unittest.TestCase):
    ...
    def test_cbc256_{mode}_{name}_{count}(self):
        ...
        self.assertEqual(tgcyber.cbc256_{mode}({input}, key, iv), {output})
    """.replace("\n    ", "\n")
...
class TestCBC256Random(unittest.TestCase):
    ...
    def test_cbc256_random_{mode1}_{count}(self):
        ...
        a = tgcyber.cbc256_{mode1}(data, key, iv)
        b = tgcyber.cbc256_{mode2}(a, key, iv_copy)
