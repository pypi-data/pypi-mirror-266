'''
Module for generating samples from mdl_2fsvj by Euler approximation
...
Here I define function :py:func:`~ajdmom.mdl_2fsvj.euler.r2FSVJ`.
'''
import math
import numpy as np

def r2FSVJ(v_0, par, N, n_segment = 10, h = 1):
  '''Generate samples from mdl_2fsvj by Euler approximation
  ...
  lmbd = par['lambda']; mu_j = par['mu_j']; sigma_j = par['sigma_j']
  # 
