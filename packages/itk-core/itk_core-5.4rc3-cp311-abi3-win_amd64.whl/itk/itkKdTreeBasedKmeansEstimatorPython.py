...
class itkKdTreeBasedKmeansEstimatorKdTreeLSVF3(itk.ITKCommonBasePython.itkObject):
    ...
    def GetOutput(self):
        r"""GetOutput(self) -> itk::SimpleDataObjectDecorator< std::vector< itk::SmartPointer< itk::Statistics::MembershipFunctionBase< itk::Vector< float,3 > > const >,std::allocator< itk::SmartPointer< itk::Statistics::MembershipFunctionBase< itk::Vector< float,3 > > const > > > > const *"""
