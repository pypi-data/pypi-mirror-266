...
class itkBSplineBaseTransformD23(itk.itkTransformBasePython.itkTransformD22):
    ...
    def SetCoefficientImages(self, images):
        ...
        Parameters
        ----------
        images: itk::FixedArray< itk::SmartPointer< itk::Image< double,2 > >,2 > const &
    ...
    def GetCoefficientImages(self):
        r"""GetCoefficientImages(self) -> itk::FixedArray< itk::SmartPointer< itk::Image< double,2 > >,2 > const"""
...
class itkBSplineBaseTransformD33(itk.itkTransformBasePython.itkTransformD33):
    ...
    def SetCoefficientImages(self, images):
        ...
        Parameters
        ----------
        images: itk::FixedArray< itk::SmartPointer< itk::Image< double,3 > >,3 > const &

        """
        return _itkBSplineBaseTransformPython.itkBSplineBaseTransformD33_SetCoefficientImages(self, images)

    def GetCoefficientImages(self):
        r"""GetCoefficientImages(self) -> itk::FixedArray< itk::SmartPointer< itk::Image< double,3 > >,3 > const"""
