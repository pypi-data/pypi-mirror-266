...
python /home/vincent/Documents/programmation/space_collector_player/sample_player_client.py -p $PORT -u TEAM1 &
sleep 1
python /home/vincent/Documents/programmation/space_collector_player/sample_player_client.py -p $PORT -u TEAM2 &
sleep 1
