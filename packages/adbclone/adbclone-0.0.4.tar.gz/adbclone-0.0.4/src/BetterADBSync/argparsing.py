...
def get_cli_args(docstring: str, version: str) -> Args:
    ...
    parser_logging_verbosity.add_argument(
        "-v",
        "--verbose",
    ...
    parser_adb = parser.add_argument_group(
        title="ADB arguments",
    ...
    parser_direction = parser.add_subparsers(
        title="direction", dest="direction", required=True
    )

    parser_direction_push = parser_direction.add_parser(
        "push", help="Push from computer to phone"
    )
    parser_direction_push.add_argument(
        "direction_push_local", metavar="LOCAL", help="Local path"
    )
    parser_direction_push.add_argument(
        "direction_push_android", metavar="ANDROID", help="Android path"
    )

    parser_direction_pull = parser_direction.add_parser(
        "pull", help="Pull from phone to computer"
    )
    parser_direction_pull.add_argument(
        "direction_pull_android", metavar="ANDROID", help="Android path"
    )
    parser_direction_pull.add_argument(
        "direction_pull_local", metavar="LOCAL", help="Local path"
    )
