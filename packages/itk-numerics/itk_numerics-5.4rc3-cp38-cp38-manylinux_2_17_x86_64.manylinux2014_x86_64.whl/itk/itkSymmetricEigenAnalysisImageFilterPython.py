...
class itkSymmetricEigenAnalysisImageFilterISSRTD33_Superclass(itkSymmetricEigenAnalysisImageFilterISSRTD33_Superclass_Superclass):
    ...
    def GetFunctor(self, *args):
        r"""
        GetFunctor(self) -> itk::Functor::SymmetricEigenAnalysisFunction< itk::SymmetricSecondRankTensor< double,3 >,itk::SymmetricSecondRankTensor< double,3 > >
        GetFunctor(self) -> itk::Functor::SymmetricEigenAnalysisFunction< itk::SymmetricSecondRankTensor< double,3 >,itk::SymmetricSecondRankTensor< double,3 > > const &
        """
    ...
    def SetFunctor(self, functor):
        ...
        Parameters
        ----------
        functor: itk::Functor::SymmetricEigenAnalysisFunction< itk::SymmetricSecondRankTensor< double,3 >,itk::SymmetricSecondRankTensor< double,3 > > const &
