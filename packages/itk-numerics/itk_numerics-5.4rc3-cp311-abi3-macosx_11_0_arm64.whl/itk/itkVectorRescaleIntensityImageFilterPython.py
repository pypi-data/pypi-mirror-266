...
class itkVectorRescaleIntensityImageFilterIVF32IVF32_Superclass(itk.itkInPlaceImageFilterAPython.itkInPlaceImageFilterIVF32IVF32):
    ...
    def GetFunctor(self, *args):
        r"""
        GetFunctor(self) -> itk::Functor::VectorMagnitudeLinearTransform< itk::Vector< float,3 >,itk::Vector< float,3 > >
        GetFunctor(self) -> itk::Functor::VectorMagnitudeLinearTransform< itk::Vector< float,3 >,itk::Vector< float,3 > > const &
        """
    ...
    def SetFunctor(self, functor):
        ...
        Parameters
        ----------
        functor: itk::Functor::VectorMagnitudeLinearTransform< itk::Vector< float,3 >,itk::Vector< float,3 > > const &
