...
class SpeechRecognitionModel():
    ...
    async def audioToText(self, audiofile,min_silence_len:int=1000,keep_silence:int=500):
        """
        converts any audio file to text, handles conversion and splitting of large files
        """
