...
class DeletedMessagesHandler(Handler):
    ...
    (private, group, channel). It is intended to be used with :meth:`~cybergram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~cybergram.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~cybergram.types.Message`):
    ...
    async def check(self, client: "cybergram.Client", messages: List[Message]):
