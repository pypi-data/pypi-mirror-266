...
from cybergram.errors import PhoneMigrate, NetworkMigrate
from cybergram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~cybergram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
