...
async def compose(
    clients: List["cybergram.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``cybergram`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~cybergram.Client.run`.

    Parameters:
        clients (List of :obj:`~cybergram.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from cybergram import Client, compose
