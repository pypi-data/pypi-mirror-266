...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~cybergram.Client.stop` and then :meth:`~cybergram.Client.start` in a row in
        ...
        Returns:
            :obj:`~cybergram.Client`: The restarted client itself.
