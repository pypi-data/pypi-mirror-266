...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~cybergram.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, cybergram.Client):
                self.add_handler(cybergram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        cybergram.handlers.ChosenInlineResultHandler(func, self),
