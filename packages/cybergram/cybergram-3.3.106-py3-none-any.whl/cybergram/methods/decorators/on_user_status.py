...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~cybergram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, cybergram.Client):
                self.add_handler(cybergram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        cybergram.handlers.UserStatusHandler(func, self),
