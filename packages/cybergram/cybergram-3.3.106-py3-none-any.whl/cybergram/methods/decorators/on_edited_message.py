...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~cybergram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, cybergram.Client):
                self.add_handler(cybergram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        cybergram.handlers.EditedMessageHandler(func, self),
