...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~cybergram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, cybergram.Client):
                self.add_handler(cybergram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        cybergram.handlers.CallbackQueryHandler(func, self),
