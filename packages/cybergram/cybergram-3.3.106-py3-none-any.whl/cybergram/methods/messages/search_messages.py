...
class SearchMessages:
    ...
    async def search_messages(
        ...
        If you want to get the messages count only, see :meth:`~cybergram.Client.search_messages_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~cybergram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~cybergram.types.Message` objects.
