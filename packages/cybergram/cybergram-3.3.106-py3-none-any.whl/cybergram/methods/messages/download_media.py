...
from cybergram.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~cybergram.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~cybergram.Client.stop_transmission`, None is returned.
