...
import cybergram
from cybergram import StopTransmission, enums
from cybergram import raw
from cybergram import types
from cybergram import utils
from cybergram.errors import FilePartMissing
from cybergram.file_id import FileType


class SendAudio:
    async def send_audio(
        self: "cybergram.Client",
        ...
        For sending voice messages, use the :meth:`~cybergram.Client.send_voice` method instead.
        ...
        Parameters:
            ...
            caption_entities (List of :obj:`~cybergram.types.MessageEntity`):
            ...
            reply_markup (:obj:`~cybergram.types.InlineKeyboardMarkup` | :obj:`~cybergram.types.ReplyKeyboardMarkup` | :obj:`~cybergram.types.ReplyKeyboardRemove` | :obj:`~cybergram.types.ForceReply`, *optional*):
        ...
        Returns:
            :obj:`~cybergram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~cybergram.Client.stop_transmission`, None is returned.
