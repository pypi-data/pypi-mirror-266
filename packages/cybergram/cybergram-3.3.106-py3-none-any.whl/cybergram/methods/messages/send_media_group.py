...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~cybergram.types.InputMediaPhoto`, :obj:`~cybergram.types.InputMediaVideo`, :obj:`~cybergram.types.InputMediaAudio` and :obj:`~cybergram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~cybergram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from cybergram.types import InputMediaPhoto, InputMediaVideo
