...
from cybergram.enums import MessageEntityType
from cybergram.errors import PeerIdInvalid
from . import utils
...
class Parser(HTMLParser):
    ...
    def __init__(self, client: "cybergram.Client"):
        super().__init__()
...
class HTML:
    def __init__(self, client: Optional["cybergram.Client"]):
        self.client = client
