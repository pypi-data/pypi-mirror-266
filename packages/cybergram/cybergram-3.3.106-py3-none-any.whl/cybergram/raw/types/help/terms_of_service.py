...
class TermsOfService(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.help.TermsOfService`.
    ...
    Parameters:
        id (:obj:`DataJSON <cybergram.raw.base.DataJSON>`):
            N/A

        text (``str``):
            N/A

        entities (List of :obj:`MessageEntity <cybergram.raw.base.MessageEntity>`):
            N/A
