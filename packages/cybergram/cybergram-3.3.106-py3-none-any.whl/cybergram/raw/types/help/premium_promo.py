...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <cybergram.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <cybergram.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <cybergram.raw.base.PremiumSubscriptionOption>`):
            N/A
