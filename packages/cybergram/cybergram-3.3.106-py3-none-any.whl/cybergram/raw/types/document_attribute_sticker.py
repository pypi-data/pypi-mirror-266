...
class DocumentAttributeSticker(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.DocumentAttribute`.
    ...
    Parameters:
        ...
        stickerset (:obj:`InputStickerSet <cybergram.raw.base.InputStickerSet>`):
            N/A

        mask (``bool``, *optional*):
            N/A

        mask_coords (:obj:`MaskCoords <cybergram.raw.base.MaskCoords>`, *optional*):
            N/A
