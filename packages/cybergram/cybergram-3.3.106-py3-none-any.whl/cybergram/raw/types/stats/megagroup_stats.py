...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <cybergram.raw.base.StatsDateRangeDays>`):
            N/A

        members (:obj:`StatsAbsValueAndPrev <cybergram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <cybergram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <cybergram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <cybergram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <cybergram.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <cybergram.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <cybergram.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <cybergram.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <cybergram.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <cybergram.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <cybergram.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <cybergram.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <cybergram.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <cybergram.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <cybergram.raw.base.StatsGroupTopInviter>`):
            N/A

        users (List of :obj:`User <cybergram.raw.base.User>`):
            N/A
