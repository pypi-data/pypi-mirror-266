...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <cybergram.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <cybergram.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <cybergram.raw.base.Update>`):
            N/A

        chats (List of :obj:`Chat <cybergram.raw.base.Chat>`):
            N/A

        users (List of :obj:`User <cybergram.raw.base.User>`):
            N/A

        intermediate_state (:obj:`updates.State <cybergram.raw.base.updates.State>`):
            N/A
