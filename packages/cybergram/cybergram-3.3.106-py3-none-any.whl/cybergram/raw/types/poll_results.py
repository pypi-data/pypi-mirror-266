...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <cybergram.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <cybergram.raw.base.MessageEntity>`, *optional*):
            N/A
