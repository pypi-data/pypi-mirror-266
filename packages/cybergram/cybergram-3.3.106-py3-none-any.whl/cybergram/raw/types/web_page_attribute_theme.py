...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <cybergram.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <cybergram.raw.base.ThemeSettings>`, *optional*):
            N/A
