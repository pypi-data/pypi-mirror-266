...
class PasswordSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.account.PasswordSettings`.
    ...
    Parameters:
        ...
        secure_settings (:obj:`SecureSecretSettings <cybergram.raw.base.SecureSecretSettings>`, *optional*):
            N/A
