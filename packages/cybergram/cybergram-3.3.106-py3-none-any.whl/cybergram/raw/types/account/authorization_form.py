...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <cybergram.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <cybergram.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <cybergram.raw.base.SecureValueError>`):
            N/A
