...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <cybergram.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <cybergram.raw.base.VideoSize>`, *optional*):
            N/A
