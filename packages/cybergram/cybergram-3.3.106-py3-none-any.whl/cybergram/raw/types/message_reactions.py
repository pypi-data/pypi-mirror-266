...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <cybergram.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <cybergram.raw.base.MessagePeerReaction>`, *optional*):
            N/A
