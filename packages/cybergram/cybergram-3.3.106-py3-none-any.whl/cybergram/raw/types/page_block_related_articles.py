...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <cybergram.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <cybergram.raw.base.PageRelatedArticle>`):
            N/A
