...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <cybergram.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <cybergram.raw.base.PopularContact>`):
            N/A
