...
class Found(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results (List of :obj:`Peer <cybergram.raw.base.Peer>`):
            N/A

        results (List of :obj:`Peer <cybergram.raw.base.Peer>`):
            N/A
