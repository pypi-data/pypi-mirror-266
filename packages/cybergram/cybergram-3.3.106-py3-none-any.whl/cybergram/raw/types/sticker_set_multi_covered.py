...
class StickerSetMultiCovered(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.StickerSetCovered`.
    ...
    Parameters:
        set (:obj:`StickerSet <cybergram.raw.base.StickerSet>`):
            N/A

        covers (List of :obj:`Document <cybergram.raw.base.Document>`):
            N/A
