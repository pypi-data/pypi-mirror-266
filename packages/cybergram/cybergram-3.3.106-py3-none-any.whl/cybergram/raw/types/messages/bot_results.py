...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <cybergram.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <cybergram.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <cybergram.raw.base.InlineBotWebView>`, *optional*):
            N/A
