...
class RecentStickers(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.messages.RecentStickers`.
    ...
    Parameters:
        ...
        packs (List of :obj:`StickerPack <cybergram.raw.base.StickerPack>`):
            N/A

        stickers (List of :obj:`Document <cybergram.raw.base.Document>`):
            N/A
