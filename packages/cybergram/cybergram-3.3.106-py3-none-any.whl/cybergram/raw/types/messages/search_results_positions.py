...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <cybergram.raw.base.SearchResultsPosition>`):
            N/A
