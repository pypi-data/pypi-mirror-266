...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <cybergram.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <cybergram.raw.base.Message>`):
            N/A
        ...
        state (:obj:`updates.State <cybergram.raw.base.updates.State>`):
            N/A
