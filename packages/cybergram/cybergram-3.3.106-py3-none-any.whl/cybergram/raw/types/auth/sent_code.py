...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <cybergram.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <cybergram.raw.base.auth.CodeType>`, *optional*):
            N/A
