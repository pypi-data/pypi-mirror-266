...
class ChatInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.ChatInvite`.
    ...
    Parameters:
        ...
        photo (:obj:`Photo <cybergram.raw.base.Photo>`):
            N/A
        ...
        participants (List of :obj:`User <cybergram.raw.base.User>`, *optional*):
            N/A
