...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <cybergram.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <cybergram.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <cybergram.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <cybergram.raw.base.InputDocument>`, *optional*):
            N/A
