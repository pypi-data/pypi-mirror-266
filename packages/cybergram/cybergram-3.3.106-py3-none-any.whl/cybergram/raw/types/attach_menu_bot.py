...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <cybergram.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <cybergram.raw.base.AttachMenuBotIcon>`):
            N/A
