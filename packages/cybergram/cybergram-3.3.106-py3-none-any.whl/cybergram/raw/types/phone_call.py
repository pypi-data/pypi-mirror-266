...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <cybergram.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <cybergram.raw.base.PhoneConnection>`):
            N/A
