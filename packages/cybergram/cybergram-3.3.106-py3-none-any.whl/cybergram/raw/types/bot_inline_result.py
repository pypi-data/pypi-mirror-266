...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <cybergram.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <cybergram.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <cybergram.raw.base.WebDocument>`, *optional*):
            N/A
