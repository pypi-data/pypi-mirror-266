...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <cybergram.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <cybergram.raw.base.ExportedChatlistInvite>`):
            N/A
