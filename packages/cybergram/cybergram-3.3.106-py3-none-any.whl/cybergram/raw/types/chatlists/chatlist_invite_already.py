...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~cybergram.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <cybergram.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <cybergram.raw.base.Peer>`):
            N/A
