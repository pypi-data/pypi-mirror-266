...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <cybergram.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <cybergram.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <cybergram.raw.base.account.EmailVerified>`
    """
