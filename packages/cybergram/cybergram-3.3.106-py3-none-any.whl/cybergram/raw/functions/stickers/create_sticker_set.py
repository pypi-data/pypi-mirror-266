...
class CreateStickerSet(TLObject):  # type: ignore
    ...
    Parameters:
        user_id (:obj:`InputUser <cybergram.raw.base.InputUser>`):
            N/A
        ...
        stickers (List of :obj:`InputStickerSetItem <cybergram.raw.base.InputStickerSetItem>`):
            N/A
        ...
        thumb (:obj:`InputDocument <cybergram.raw.base.InputDocument>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.StickerSet <cybergram.raw.base.messages.StickerSet>`
    """
