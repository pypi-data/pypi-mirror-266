...
class GetInlineBotResults(TLObject):  # type: ignore
    ...
    Parameters:
        bot (:obj:`InputUser <cybergram.raw.base.InputUser>`):
            N/A
        ...
        geo_point (:obj:`InputGeoPoint <cybergram.raw.base.InputGeoPoint>`, *optional*):
            N/A

    Returns:
        :obj:`messages.BotResults <cybergram.raw.base.messages.BotResults>`
    """
