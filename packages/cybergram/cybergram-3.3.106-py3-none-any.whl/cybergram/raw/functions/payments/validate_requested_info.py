...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <cybergram.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <cybergram.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <cybergram.raw.base.payments.ValidatedRequestedInfo>`
    """
