...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <cybergram.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <cybergram.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <cybergram.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <cybergram.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <cybergram.raw.base.photos.Photo>`
    """
