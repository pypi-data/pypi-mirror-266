...
from cybergram.crypto import aes, rsa, prime
from cybergram.errors import SecurityCheckMismatch
from cybergram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "cybergram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
