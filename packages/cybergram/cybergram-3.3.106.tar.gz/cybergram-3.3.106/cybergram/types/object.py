...
class Object:
    def __init__(self, client: "cybergram.Client" = None):
        self._client = client

    def bind(self, client: "cybergram.Client"):
        """Bind a Client instance to this and to all nested cybergram objects.

        Parameters:
            client (:obj:`~cybergram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing cybergram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/cybergramchat/167281
