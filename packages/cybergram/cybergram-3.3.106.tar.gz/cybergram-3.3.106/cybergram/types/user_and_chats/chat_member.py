...
import cybergram
from cybergram import raw, types, utils, enums
...
class ChatMember(Object):
    ...
    Parameters:
        status (:obj:`~cybergram.enums.ChatMemberStatus`):
            The member's status in the chat.

        user (:obj:`~cybergram.types.User`, *optional*):
            Information about the user.

        chat (:obj:`~cybergram.types.Chat`, *optional*):
        ...
        invited_by (:obj:`~cybergram.types.User`, *optional*):
        ...
        promoted_by (:obj:`~cybergram.types.User`, *optional*):
            Administrators only. Information about the user who promoted this member as administrator.

        restricted_by (:obj:`~cybergram.types.User`, *optional*):
