...
class InputMedia(Object):
    ...
    - :obj:`~cybergram.types.InputMediaAnimation`
    - :obj:`~cybergram.types.InputMediaDocument`
    - :obj:`~cybergram.types.InputMediaAudio`
    - :obj:`~cybergram.types.InputMediaPhoto`
    - :obj:`~cybergram.types.InputMediaVideo`
    """
