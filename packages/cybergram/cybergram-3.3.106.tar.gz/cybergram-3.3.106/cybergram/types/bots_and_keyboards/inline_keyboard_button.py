...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~cybergram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~cybergram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~cybergram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~cybergram.types.CallbackGame`, *optional*):
