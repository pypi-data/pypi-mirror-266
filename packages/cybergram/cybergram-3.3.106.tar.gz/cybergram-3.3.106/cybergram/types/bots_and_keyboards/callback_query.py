...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    Parameters:
        ...
        from_user (:obj:`~cybergram.types.User`):
            Sender.
        ...
        message (:obj:`~cybergram.types.Message`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the data of this callback query. Only applicable when using :obj:`Filters.regex <cybergram.Filters.regex>`.
    """
    ...
    @staticmethod
    async def _parse(client: "cybergram.Client", callback_query, users) -> "CallbackQuery":
        message = None
    ...
    async def answer(self, text: str = None, show_alert: bool = None, url: str = None, cache_time: int = 0):
        """Bound method *answer* of :obj:`~cybergram.types.CallbackQuery`.
    ...
    async def edit_message_text(
        ...
        Bound method *edit_message_text* of :obj:`~cybergram.types.CallbackQuery`.
        ...
        Parameters:
            ...
            reply_markup (:obj:`~cybergram.types.InlineKeyboardMarkup`, *optional*):
                An InlineKeyboardMarkup object.

        Returns:
            :obj:`~cybergram.types.Message` | ``bool``: On success, if the edited message was sent by the bot, the edited
    ...
    async def edit_message_caption(
        ...
        Bound method *edit_message_caption* of :obj:`~cybergram.types.CallbackQuery`.
    ...
    async def edit_message_media(
        ...
        Bound method *edit_message_media* of :obj:`~cybergram.types.CallbackQuery`.

        Parameters:
            media (:obj:`~cybergram.types.InputMedia`):
    ...
    async def edit_message_reply_markup(
        ...
        Bound method *edit_message_reply_markup* of :obj:`~cybergram.types.CallbackQuery`.

        Parameters:
            reply_markup (:obj:`~cybergram.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.
