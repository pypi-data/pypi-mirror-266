...
class BotCommandScope(Object):
    ...
    - :obj:`~cybergram.types.BotCommandScopeDefault`
    - :obj:`~cybergram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~cybergram.types.BotCommandScopeAllGroupChats`
    - :obj:`~cybergram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~cybergram.types.BotCommandScopeChat`
    - :obj:`~cybergram.types.BotCommandScopeChatAdministrators`
    - :obj:`~cybergram.types.BotCommandScopeChatMember`
