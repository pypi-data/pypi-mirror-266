...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <cybergram.api.functions>` package and may accept compound
        data types from :obj:`types <cybergram.api.types>` as well as bare types such as ``int``, ``str``, etc...

        .. note::

            This is a utility method intended to be used **only** when working with raw
            :obj:`functions <cybergram.api.functions>` (i.e: a Telegram API method you wish to use which is not
