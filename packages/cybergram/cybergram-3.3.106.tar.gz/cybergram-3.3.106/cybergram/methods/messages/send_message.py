...
import cybergram
from cybergram import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Parameters:
            ...
            entities (List of :obj:`~cybergram.types.MessageEntity`):
        ...
        Returns:
            :obj:`~cybergram.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **cybergram**!")

                # Disable web page previews
                await app.send_message("me", "https://docs.cybergram.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.cybergram.org")]
                        ]))
        """
