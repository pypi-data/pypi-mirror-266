...
import cybergram
from cybergram import raw, utils
from cybergram import types, enums
...
class SendPoll:
    async def send_poll(
        ...
        Parameters:
            ...
            type (:obj`~cybergram.enums.PollType`, *optional*):
                Poll type, :obj:`~cybergram.enums.PollType.QUIZ` or :obj:`~cybergram.enums.PollType.REGULAR`.
                Defaults to :obj:`~cybergram.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~cybergram.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~cybergram.types.MessageEntity`):
        ...
        Returns:
            :obj:`~cybergram.types.Message`: On success, the sent poll message is returned.
