...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~cybergram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, cybergram.Client):
                self.add_handler(cybergram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        cybergram.handlers.ChatJoinRequestHandler(func, self),
