...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~cybergram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, cybergram.Client):
                self.add_handler(cybergram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        cybergram.handlers.DeletedMessagesHandler(func, self),
