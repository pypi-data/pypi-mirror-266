...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~cybergram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, cybergram.Client):
                self.add_handler(cybergram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        cybergram.handlers.InlineQueryHandler(func, self),
