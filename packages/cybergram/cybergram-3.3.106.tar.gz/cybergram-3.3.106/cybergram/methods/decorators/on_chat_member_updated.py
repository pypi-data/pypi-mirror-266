...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        This does the same thing as :meth:`~cybergram.Client.add_handler` using the
        :obj:`~cybergram.handlers.ChatMemberUpdatedHandler`.

        Parameters:
            filters (:obj:`~cybergram.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, cybergram.Client):
                self.add_handler(cybergram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        cybergram.handlers.ChatMemberUpdatedHandler(func, self),
