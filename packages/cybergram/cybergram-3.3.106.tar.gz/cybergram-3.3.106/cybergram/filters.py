...
from cybergram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "cybergram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~cybergram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~cybergram.handlers.MessageHandler` the *update* argument will be a :obj:`~cybergram.types.Message`; in a :obj:`~cybergram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~cybergram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~cybergram.filters.command` or :meth:`~cybergram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~cybergram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~cybergram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~cybergram.types.Message`.
    ...
    async def func(flt, client: cybergram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~cybergram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~cybergram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~cybergram.types.InlineQuery`: The filter will match ``query``.
