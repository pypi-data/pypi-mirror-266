...
class ChosenInlineResultHandler(Handler):
    ...
    It is intended to be used with :meth:`~cybergram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~cybergram.Client.on_chosen_inline_result` decorator.
    ...
    Other parameters:
        ...
        chosen_inline_result (:obj:`~cybergram.types.ChosenInlineResult`):
