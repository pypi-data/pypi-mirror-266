...
import cybergram
from cybergram import __version__, __license__
from cybergram import enums
from cybergram import raw
from cybergram import utils
from cybergram.crypto import aes
from cybergram.errors import CDNFileHashMismatch
from cybergram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from cybergram.handlers.handler import Handler
from cybergram.methods import Methods
from cybergram.session import Auth, Session
from cybergram.storage import FileStorage, MemoryStorage
from cybergram.types import User, TermsOfService
from cybergram.utils import ainput
...
class Client(Methods):
    """cybergram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~cybergram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where cybergram will store the session files.
            Defaults to the parent directory of the main script.

        plugins (``dict``, *optional*):
            Smart Plugins settings as dict, e.g.: *dict(root="plugins")*.

        parse_mode (:obj:`~cybergram.enums.ParseMode`, *optional*):
    ...
    APP_VERSION = f"cybergram {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to cybergram (version {__version__})")
        print(f"cybergram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~cybergram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.cybergram.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except cybergram.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
