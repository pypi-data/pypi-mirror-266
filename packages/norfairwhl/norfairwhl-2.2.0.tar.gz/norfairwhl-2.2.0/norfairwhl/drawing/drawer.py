...
from norfairwhl.drawing.color import Color, ColorType
from norfairwhl.tracker import Detection, TrackedObject

try:
    import cv2
except ImportError:
    from norfairwhl.utils import DummyOpenCVImport
