...
def getArticles(field, number=20, dropna=True | False):
    ...
    :param field: section of the Articles,'news', 'innovation', 'business', 'culture'
    :param dropna: Drop rows which contain missing values, True | False
    :return: None
    """
    if field not in ['news', 'innovation', 'business', 'culture']:
...
def from_fields(fields=[], number=10, timeout=6):
    r"""GET the Article from BBC
    :param fields: sections of the Articles, 'innovation', 'business', 'culture'
