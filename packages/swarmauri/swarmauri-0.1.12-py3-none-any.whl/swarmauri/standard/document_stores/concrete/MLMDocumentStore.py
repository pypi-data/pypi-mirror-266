...
class MLMDocumentStore(IDocumentStore, IRetriever):
    def __init__(self):
    ...
    def add_document(self, document: IDocument) -> None:
        ...
        for _count, _d in enumerate(documents) if _d.content]
    ...
    def add_documents(self, documents: List[IDocument]) -> None:
        ...
        embedded_documents = [EmbeddedDocument(doc_id=_d.id, 
            content=_d.content, 
            metadata=_d.metadata, 
            embedding=embeddings[_count]) for _count, _d in enumerate(documents) 
            if _d.content]
