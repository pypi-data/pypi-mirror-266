...
class BERTDocumentStore(IDocumentStore, IRetriever):
    ...
    def add_document(self, document: IDocument) -> None:
        ...
        # Optionally trigger fine-tuning on each document add or batch of adds.
        # This example assumes labels are stored within document metadata for supervised tasks.
        # You can customize this process based on your use case and data structure.
