...
def test_account_can_be_updated(api, account, acc_user):
    ...
    assert account['monthly_charging_enabled'] == True == acc_updated['monthly_charging_enabled']
    updated = account.read()
    assert updated['monthly_charging_enabled'] == True == account['monthly_charging_enabled']
...
def test_user_can_be_created(api, account, account_params, acc_user, acc_user2, acc_user2_params):
