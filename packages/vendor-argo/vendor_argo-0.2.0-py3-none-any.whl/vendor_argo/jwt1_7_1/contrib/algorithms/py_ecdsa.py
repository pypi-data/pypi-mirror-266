...
from vendor_argo.jwt1_7_1.algorithms import Algorithm
from vendor_argo.jwt1_7_1.compat import string_types, text_type
...
class ECAlgorithm(Algorithm):
    ...
    def verify(self, msg, key, sig):
        try:
            return key.verify(
                sig, msg, hashfunc=self.hash_alg, sigdecode=ecdsa.util.sigdecode_string
            )
