    ...
    if record_type == "pim":
        ...
        for trial_info in trial_info_array:
            ...
            if dir_exist:
                ...
                frame_count = get_frame_count(float(e_start_time), left_timestamp_array)
                frame_start_time = round(frame_count / left_v_frame_rate, 2)
        ...
        for trial_info in trial_info_array:
            ...
            if dir_exist:
                e_start_time = trial_info["start_time"]
                e_duration = trial_info["duration"]
                frame_count = get_frame_count(float(e_start_time), right_timestamp_array)
                frame_start_time = round(frame_count / right_v_frame_rate, 2)
        ...
        for trial_info in trial_info_array:
            ...
            if dir_exist:
                e_start_time = trial_info["start_time"]
                e_duration = trial_info["duration"]
                frame_count = get_frame_count(float(e_start_time), timestamp_array)
                frame_start_time = round(frame_count / v_frame_rate, 2)
...
def main():
    ...
    parser.add_argument('--version', action='version', version='8.2.0'),
