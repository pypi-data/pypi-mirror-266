...
def get_stock_price(stock_name: str):
    data = kite.ltp("NSE:"+stock_name)
    return data["NSE:"+stock_name]["last_price"]


def get_stock_instrument_token(stock_name: str):
    data = kite.ltp("NSE:"+stock_name)
    return data["NSE:"+stock_name]["instrument_token"]


def get_fno_price(fno_name: str):
    return kite.ltp("NFO:"+fno_name)


def get_fno_instrument_token(stock_name: str):
    data = kite.ltp("NFO:"+stock_name)
    return data["NFO:"+stock_name]["instrument_token"]
...
def modify_order(variety, order_id, quantity, price):
...
def modify_order_with_order_type(variety, order_id, quantity, order_type):

    order_id = kite.modify_order(
        variety=variety, order_id=order_id, quantity=quantity, order_type=order_type)
    return order_id
