...
```commandline
from scPECA import scPECA
import scPECA
import os

data_path = os.path.join(os.path.dirname(scPECA.__file__), 'Cones')# demo data path
pkg_path = os.path.dirname(package_name.__file__)
demo = scPECA.scPECA(data_path, 'Cones', 'hg38', pkg_path) # Create a scPECA class
