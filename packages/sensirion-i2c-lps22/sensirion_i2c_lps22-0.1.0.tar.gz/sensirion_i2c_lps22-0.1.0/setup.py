...
version_line = open("sensirion_i2c_lps22/version.py", "rt").read()
...
setup(
    name='sensirion_i2c_lps22',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='I2C driver for the Sensirion LPS22 sensor family',
    license='BSD',
    keywords="""Sensirion LPS22
        I2C
        LPS22""",
    project_urls={
