"""
This Python module, celi-framework.processor, is part of a larger system designed to automate the drafting of documents using language models.
...
from celi-framework.core.job_description import ToolImplementations, generate_tool_descriptions
from celi-framework.core.mt_factory import MasterTemplateFactory
from openai.types.chat.chat_completion import Choice
from celi-framework.utils.codex import MongoDBUtilitySingleton
from celi-framework.utils.llmcore_utils import (
    FinalOutput,
    IsPromptError,
    ParserFactory,
    parse,
)
from celi-framework.utils.llms import ToolDescription, ask_split
from celi-framework.utils.log import app_logger
from celi-framework.utils.token_counters import get_master_counter_instance, token_counter_og
