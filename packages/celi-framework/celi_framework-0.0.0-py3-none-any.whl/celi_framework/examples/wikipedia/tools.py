...
from celi-framework.core.job_description import ToolImplementations
from celi-framework.core.templates import (
    make_draft_setting_output_prompt,
    make_table_setting_output_prompt,
)
from celi-framework.examples.wikipedia.index import get_wikipedia_index
from celi-framework.utils.codex import MongoDBUtilitySingleton
from celi-framework.utils.llms import quick_ask
from celi-framework.utils.token_counters import get_master_counter_instance
from celi-framework.utils.utils import format_toc, get_section_context_as_text
...
class WikipediaToolImplementations(ToolImplementations):
    ...
    def ask_question_about_target(self, prompt: str):
        """
        ...
        """
        result = self._get_codex().check_llm_cache(
        ...
        if result:
            ...
            self._get_codex().cache_llm_response(
