...
from agricore_sp_models.common_models import OrganicProductionType, ProductGroupJsonDTO, LandRentJsonDTO, LandRentDTO
...
class DecoupledSubsidiesDTO(BaseModel):
    # Amount received for the Green subsidy [€]
    pGreen: float
    # Amount received for the Basic subsidy [€]
    pBasic: float
    # Amount received for the Pension subsidy [€]
    pPension: float
