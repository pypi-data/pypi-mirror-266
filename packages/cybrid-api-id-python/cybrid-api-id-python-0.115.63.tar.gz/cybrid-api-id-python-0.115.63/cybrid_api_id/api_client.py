...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ApplicationsIdpApi()
        api_instance.delete_bank_application  # this is an instance of the class Endpoint
        api_instance.delete_bank_application()  # this invokes api_instance.delete_bank_application.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_bank_application.callable or self.callable in this class
