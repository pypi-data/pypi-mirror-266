...
valid_legacy_flags = (
        ...
        'iam_user_default_password_2024_03_15'
    )
...
class ITargetGroup(IPortProtocol, IResource, IMonitorable, IDeployable):
    ...
    target_type = zope.schema.Choice(
        title="Target Type",
        description="Must be one of 'instance', 'ip', 'lambda', or 'alb'.",
        default="instance",
        vocabulary=vocabulary.target_group_target_types,
    )
    targets = zope.schema.List(
        title="List of target references",
        value_type=PacoReference(
...
.. code-block:: yaml
    ...
    """
    static_ips = zope.schema.List(
        title="List of paco references to static EIPs",
        value_type=PacoReference(
            title="Static IP",
