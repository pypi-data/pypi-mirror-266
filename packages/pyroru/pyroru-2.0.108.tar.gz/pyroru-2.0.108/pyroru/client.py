...
import pyroru
from pyroru import __version__, __license__
from pyroru import enums
from pyroru import raw
from pyroru import utils
from pyroru.crypto import aes
from pyroru.errors import CDNFileHashMismatch
from pyroru.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from pyroru.handlers.handler import Handler
from pyroru.methods import Methods
from pyroru.session import Auth, Session
from pyroru.storage import FileStorage, MemoryStorage
from pyroru.types import User, TermsOfService
from pyroru.utils import ainput
...
class Client(Methods):
    ...
    async def authorize(self) -> User:
        ...
        print(f"PyRU Бесплатное ПО на основе Pyroru.\n")
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("Ключ API необходим для новых авторизаций. "
                                     "Больше информации ( EN ): https://docs.pyroru.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except pyroru.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
