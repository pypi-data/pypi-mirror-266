...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~pyroru.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~pyroru.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~pyroru.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~pyroru.types.CallbackGame`, *optional*):
