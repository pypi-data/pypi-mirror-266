...
class BotCommandScope(Object):
    ...
    - :obj:`~pyroru.types.BotCommandScopeDefault`
    - :obj:`~pyroru.types.BotCommandScopeAllPrivateChats`
    - :obj:`~pyroru.types.BotCommandScopeAllGroupChats`
    - :obj:`~pyroru.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~pyroru.types.BotCommandScopeChat`
    - :obj:`~pyroru.types.BotCommandScopeChatAdministrators`
    - :obj:`~pyroru.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "pyroru.Client") -> "raw.base.BotCommandScope":
