...
class ChatMember(Object):
    ...
    Parameters:
        status (:obj:`~pyroru.enums.ChatMemberStatus`):
        ...
        invited_by (:obj:`~pyroru.types.User`, *optional*):
