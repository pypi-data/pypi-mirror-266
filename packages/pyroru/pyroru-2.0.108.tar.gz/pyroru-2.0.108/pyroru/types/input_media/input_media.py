...
class InputMedia(Object):
    ...
    - :obj:`~pyroru.types.InputMediaAnimation`
    - :obj:`~pyroru.types.InputMediaDocument`
    - :obj:`~pyroru.types.InputMediaAudio`
    - :obj:`~pyroru.types.InputMediaPhoto`
    - :obj:`~pyroru.types.InputMediaVideo`
    """
