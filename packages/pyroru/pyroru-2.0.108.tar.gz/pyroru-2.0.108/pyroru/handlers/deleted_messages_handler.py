...
import pyroru
from pyroru.filters import Filter
from pyroru.types import Message
from .handler import Handler


class DeletedMessagesHandler(Handler):
    """The deleted messages handler class. Used to handle deleted messages coming from any chat
    (private, group, channel). It is intended to be used with :meth:`~pyroru.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~pyroru.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~pyroru.types.Message`):
    ...
    async def check(self, client: "pyroru.Client", messages: List[Message]):
