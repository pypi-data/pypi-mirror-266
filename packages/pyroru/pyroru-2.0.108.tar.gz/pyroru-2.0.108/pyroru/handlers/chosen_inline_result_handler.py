...
class ChosenInlineResultHandler(Handler):
    ...
    It is intended to be used with :meth:`~pyroru.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~pyroru.Client.on_chosen_inline_result` decorator.
    ...
    Other parameters:
        ...
        chosen_inline_result (:obj:`~pyroru.types.ChosenInlineResult`):
