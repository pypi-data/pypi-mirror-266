...
async def compose(
    clients: List["pyroru.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``pyroru`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~pyroru.Client.run`.

    Parameters:
        clients (List of :obj:`~pyroru.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from pyroru import Client, compose
