...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~pyroru.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroru.Client):
                self.add_handler(pyroru.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroru.handlers.ChatMemberUpdatedHandler(func, self),
