...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~pyroru.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroru.Client):
                self.add_handler(pyroru.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroru.handlers.CallbackQueryHandler(func, self),
