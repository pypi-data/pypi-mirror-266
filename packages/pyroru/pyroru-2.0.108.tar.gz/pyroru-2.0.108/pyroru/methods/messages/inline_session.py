...
from pyroru.errors import AuthBytesInvalid
from pyroru.session import Session
from pyroru.session.auth import Auth


async def get_session(client: "pyroru.Client", dc_id: int):
