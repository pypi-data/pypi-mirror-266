...
import pyroru
from pyroru import StopTransmission, enums
from pyroru import raw
from pyroru import types
from pyroru import utils
from pyroru.errors import FilePartMissing
from pyroru.file_id import FileType
...
class SendDocument:
    async def send_document(
        ...
        Parameters:
            ...
            caption_entities (List of :obj:`~pyroru.types.MessageEntity`):
            ...
            reply_markup (:obj:`~pyroru.types.InlineKeyboardMarkup` | :obj:`~pyroru.types.ReplyKeyboardMarkup` | :obj:`~pyroru.types.ReplyKeyboardRemove` | :obj:`~pyroru.types.ForceReply`, *optional*):
        ...
        Returns:
            :obj:`~pyroru.types.Message` | ``None``: On success, the sent document message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyroru.Client.stop_transmission`, None is returned.
