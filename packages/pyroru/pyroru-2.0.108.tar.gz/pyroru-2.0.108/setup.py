...
with open("pyroru/__init__.py", encoding="utf-8") as f:
...
setup(
    name="pyroru",
    version=version,
    description="RU Version Pyroru",
    long_description=readme,
    long_description_content_type="text/markdown",
    url="https://github.com/pyroru",
    author="Sasibacka",
    license="LGPLv3",
    classifiers=[
    ...
    project_urls={
        "Tracker": "https://github.com/pyroru/pyroru/issues",
        "Community": "https://t.me/pyroru",
        "Source": "https://github.com/pyroru/pyroru",
        "Documentation": "https://docs.pyroru.org",
    },
    python_requires="~=3.7",
    package_data={
        "pyroru": ["py.typed"],
