...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <pyroru.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <pyroru.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <pyroru.raw.base.payments.ValidatedRequestedInfo>`
    """
