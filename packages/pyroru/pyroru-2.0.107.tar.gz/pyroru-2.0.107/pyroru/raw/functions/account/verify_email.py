...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <pyroru.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <pyroru.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <pyroru.raw.base.account.EmailVerified>`
    """
