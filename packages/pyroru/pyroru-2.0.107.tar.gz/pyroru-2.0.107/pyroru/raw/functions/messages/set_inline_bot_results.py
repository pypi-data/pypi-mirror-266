...
class SetInlineBotResults(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        results (List of :obj:`InputBotInlineResult <pyroru.raw.base.InputBotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <pyroru.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <pyroru.raw.base.InlineBotWebView>`, *optional*):
            N/A
