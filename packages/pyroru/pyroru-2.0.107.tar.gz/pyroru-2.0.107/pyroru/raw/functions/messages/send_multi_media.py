...
class SendMultiMedia(TLObject):  # type: ignore
    ...
    Parameters:
        peer (:obj:`InputPeer <pyroru.raw.base.InputPeer>`):
            N/A

        multi_media (List of :obj:`InputSingleMedia <pyroru.raw.base.InputSingleMedia>`):
            N/A
        ...
        send_as (:obj:`InputPeer <pyroru.raw.base.InputPeer>`, *optional*):
            N/A

    Returns:
        :obj:`Updates <pyroru.raw.base.Updates>`
    """
