...
class RequestSimpleWebView(TLObject):  # type: ignore
    ...
    Parameters:
        bot (:obj:`InputUser <pyroru.raw.base.InputUser>`):
            N/A
        ...
        theme_params (:obj:`DataJSON <pyroru.raw.base.DataJSON>`, *optional*):
            N/A

    Returns:
        :obj:`SimpleWebViewResult <pyroru.raw.base.SimpleWebViewResult>`
    """
