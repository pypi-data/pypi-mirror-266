...
class AddStickerToSet(TLObject):  # type: ignore
    ...
    Parameters:
        stickerset (:obj:`InputStickerSet <pyroru.raw.base.InputStickerSet>`):
            N/A

        sticker (:obj:`InputStickerSetItem <pyroru.raw.base.InputStickerSetItem>`):
            N/A

    Returns:
        :obj:`messages.StickerSet <pyroru.raw.base.messages.StickerSet>`
    """
