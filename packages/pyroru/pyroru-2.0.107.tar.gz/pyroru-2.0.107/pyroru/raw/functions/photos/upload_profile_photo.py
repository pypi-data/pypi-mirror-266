...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <pyroru.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <pyroru.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <pyroru.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <pyroru.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <pyroru.raw.base.photos.Photo>`
    """
