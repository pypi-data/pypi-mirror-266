...
class ChannelAdminLogEventsFilter:  # type: ignore
    ...
    Constructors:
        ...
        .. currentmodule:: pyroru.raw.types
    ...
    QUALNAME = "pyroru.raw.base.ChannelAdminLogEventsFilter"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.pyroru.org/telegram/base/channel-admin-log-events-filter")
