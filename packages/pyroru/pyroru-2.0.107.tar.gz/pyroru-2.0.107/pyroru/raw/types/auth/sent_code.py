...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <pyroru.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <pyroru.raw.base.auth.CodeType>`, *optional*):
            N/A
