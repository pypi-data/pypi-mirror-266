...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <pyroru.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <pyroru.raw.base.VideoSize>`, *optional*):
            N/A
