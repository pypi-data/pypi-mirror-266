...
class MessageActionSecureValuesSentMe(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.MessageAction`.
    ...
    Parameters:
        values (List of :obj:`SecureValue <pyroru.raw.base.SecureValue>`):
            N/A

        credentials (:obj:`SecureCredentialsEncrypted <pyroru.raw.base.SecureCredentialsEncrypted>`):
            N/A
