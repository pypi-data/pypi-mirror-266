...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pyroru.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pyroru.raw.base.MessagePeerReaction>`, *optional*):
            N/A
