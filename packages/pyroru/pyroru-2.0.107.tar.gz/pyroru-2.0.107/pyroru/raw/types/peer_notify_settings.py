...
class PeerNotifySettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.PeerNotifySettings`.
    ...
    Parameters:
        ...
        ios_sound (:obj:`NotificationSound <pyroru.raw.base.NotificationSound>`, *optional*):
            N/A

        android_sound (:obj:`NotificationSound <pyroru.raw.base.NotificationSound>`, *optional*):
            N/A

        other_sound (:obj:`NotificationSound <pyroru.raw.base.NotificationSound>`, *optional*):
            N/A
