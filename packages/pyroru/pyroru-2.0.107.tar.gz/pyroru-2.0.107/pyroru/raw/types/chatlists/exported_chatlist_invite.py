...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <pyroru.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <pyroru.raw.base.ExportedChatlistInvite>`):
            N/A
