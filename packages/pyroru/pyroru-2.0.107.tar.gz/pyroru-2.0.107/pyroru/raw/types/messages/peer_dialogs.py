...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <pyroru.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <pyroru.raw.base.Message>`):
            N/A
