...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.messages.StickerSet`.
    ...
    Parameters:
        ...
        packs (List of :obj:`StickerPack <pyroru.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <pyroru.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <pyroru.raw.base.Document>`):
            N/A
