...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <pyroru.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <pyroru.raw.base.VideoSize>`, *optional*):
            N/A
