...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <pyroru.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <pyroru.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <pyroru.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <pyroru.raw.base.InputDocument>`, *optional*):
            N/A
