...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pyroru.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pyroru.raw.base.Reaction>`, *optional*):
            N/A
