...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pyroru.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pyroru.raw.base.PopularContact>`):
            N/A
