...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        ...
        members (:obj:`StatsAbsValueAndPrev <pyroru.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <pyroru.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <pyroru.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <pyroru.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <pyroru.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <pyroru.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <pyroru.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <pyroru.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <pyroru.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <pyroru.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <pyroru.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <pyroru.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <pyroru.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <pyroru.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <pyroru.raw.base.StatsGroupTopInviter>`):
            N/A
