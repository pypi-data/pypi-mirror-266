...
class AutoSaveSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.account.AutoSaveSettings`.
    ...
    Parameters:
        users_settings (:obj:`AutoSaveSettings <pyroru.raw.base.AutoSaveSettings>`):
            N/A

        chats_settings (:obj:`AutoSaveSettings <pyroru.raw.base.AutoSaveSettings>`):
            N/A

        broadcasts_settings (:obj:`AutoSaveSettings <pyroru.raw.base.AutoSaveSettings>`):
            N/A

        exceptions (List of :obj:`AutoSaveException <pyroru.raw.base.AutoSaveException>`):
            N/A

        chats (List of :obj:`Chat <pyroru.raw.base.Chat>`):
            N/A
