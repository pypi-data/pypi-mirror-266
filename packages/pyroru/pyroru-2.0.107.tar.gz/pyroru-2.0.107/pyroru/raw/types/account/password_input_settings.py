...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <pyroru.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <pyroru.raw.base.SecureSecretSettings>`, *optional*):
            N/A
