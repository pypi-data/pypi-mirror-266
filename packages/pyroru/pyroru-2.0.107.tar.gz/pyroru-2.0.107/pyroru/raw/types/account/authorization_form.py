...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pyroru.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pyroru.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pyroru.raw.base.SecureValueError>`):
            N/A
