...
class BotInlineMediaResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <pyroru.raw.base.BotInlineMessage>`):
            N/A

        photo (:obj:`Photo <pyroru.raw.base.Photo>`, *optional*):
            N/A

        document (:obj:`Document <pyroru.raw.base.Document>`, *optional*):
            N/A
