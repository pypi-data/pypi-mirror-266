...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <pyroru.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <pyroru.raw.base.AttachMenuBotIcon>`):
            N/A
