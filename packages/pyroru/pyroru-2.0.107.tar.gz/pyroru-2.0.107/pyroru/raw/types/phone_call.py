...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <pyroru.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <pyroru.raw.base.PhoneConnection>`):
            N/A
