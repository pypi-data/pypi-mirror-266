...
class TermsOfService(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.help.TermsOfService`.
    ...
    Parameters:
        id (:obj:`DataJSON <pyroru.raw.base.DataJSON>`):
            N/A

        text (``str``):
            N/A

        entities (List of :obj:`MessageEntity <pyroru.raw.base.MessageEntity>`):
            N/A
