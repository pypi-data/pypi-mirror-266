...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pyroru.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pyroru.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pyroru.raw.base.PremiumSubscriptionOption>`):
            N/A
