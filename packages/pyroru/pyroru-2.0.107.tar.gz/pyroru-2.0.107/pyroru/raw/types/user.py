...
class User(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.User`.
    ...
    Parameters:
        ...
        photo (:obj:`UserProfilePhoto <pyroru.raw.base.UserProfilePhoto>`, *optional*):
            N/A

        status (:obj:`UserStatus <pyroru.raw.base.UserStatus>`, *optional*):
            N/A
        ...
        emoji_status (:obj:`EmojiStatus <pyroru.raw.base.EmojiStatus>`, *optional*):
            N/A
