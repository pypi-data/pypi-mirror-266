...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <pyroru.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <pyroru.raw.base.MessageEntity>`, *optional*):
            N/A
