...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <pyroru.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <pyroru.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <pyroru.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <pyroru.raw.base.updates.State>`):
            N/A
