...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroru.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <pyroru.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <pyroru.raw.base.ThemeSettings>`, *optional*):
            N/A
