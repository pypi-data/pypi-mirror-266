...
class InputMediaInvoice(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        provider_data (:obj:`DataJSON <pyroru.raw.base.DataJSON>`):
            N/A

        photo (:obj:`InputWebDocument <pyroru.raw.base.InputWebDocument>`, *optional*):
            N/A

        start_param (``str``, *optional*):
            N/A

        extended_media (:obj:`InputMedia <pyroru.raw.base.InputMedia>`, *optional*):
            N/A
