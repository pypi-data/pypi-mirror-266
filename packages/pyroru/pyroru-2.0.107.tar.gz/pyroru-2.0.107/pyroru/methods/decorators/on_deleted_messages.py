...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~pyroru.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroru.Client):
                self.add_handler(pyroru.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroru.handlers.DeletedMessagesHandler(func, self),
