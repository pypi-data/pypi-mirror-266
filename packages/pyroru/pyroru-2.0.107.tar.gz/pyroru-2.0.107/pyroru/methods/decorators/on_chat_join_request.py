...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~pyroru.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroru.Client):
                self.add_handler(pyroru.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroru.handlers.ChatJoinRequestHandler(func, self),
