...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~pyroru.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroru.Client):
                self.add_handler(pyroru.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroru.handlers.EditedMessageHandler(func, self),
