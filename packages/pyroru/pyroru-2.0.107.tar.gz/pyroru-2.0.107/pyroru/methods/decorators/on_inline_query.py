...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~pyroru.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroru.Client):
                self.add_handler(pyroru.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroru.handlers.InlineQueryHandler(func, self),
