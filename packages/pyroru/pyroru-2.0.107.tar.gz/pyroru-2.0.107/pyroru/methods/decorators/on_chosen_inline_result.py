...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~pyroru.handlers.ChosenInlineResultHandler`.

        Parameters:
            filters (:obj:`~pyroru.filters`, *optional*):
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroru.Client):
                self.add_handler(pyroru.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroru.handlers.ChosenInlineResultHandler(func, self),
