...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyroru.types.InputMediaPhoto`, :obj:`~pyroru.types.InputMediaVideo`, :obj:`~pyroru.types.InputMediaAudio` and :obj:`~pyroru.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyroru.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyroru.types import InputMediaPhoto, InputMediaVideo
