...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyroru.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pyroru.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyroru.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pyroru". Get the first 50 results
                async for message in app.search_global("pyroru", limit=50):
                    print(message.text)
