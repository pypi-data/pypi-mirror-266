...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~pyroru.Client.stop` and then :meth:`~pyroru.Client.start` in a row in
        ...
        Returns:
            :obj:`~pyroru.Client`: The restarted client itself.
