...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <pyroru.api.functions>` package and may accept compound
        data types from :obj:`types <pyroru.api.types>` as well as bare types such as ``int``, ``str``, etc...

        .. note::

            This is a utility method intended to be used **only** when working with raw
            :obj:`functions <pyroru.api.functions>` (i.e: a Telegram API method you wish to use which is not
