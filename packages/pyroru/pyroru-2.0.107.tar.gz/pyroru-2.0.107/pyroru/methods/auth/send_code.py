...
from pyroru.errors import PhoneMigrate, NetworkMigrate
from pyroru.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~pyroru.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
