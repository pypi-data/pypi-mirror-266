...
try:
    ...
    log.warning(
        "TgCrypto не установлен! "
        "PyRU Будет работать, но в разы медленнее. "
        "Больше информации ( EN ): https://docs.pyroru.org/topics/speedups"
        "Установить TgCrypto: pip install tgcrypto"
    )
