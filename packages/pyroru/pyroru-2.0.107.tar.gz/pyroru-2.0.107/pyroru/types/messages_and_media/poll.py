...
import pyroru
from pyroru import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~pyroru.types.PollOption`):
        ...
        type (:obj:`~pyroru.enums.PollType`, *optional*):
            Poll type.
        ...
        explanation_entities (List of :obj:`~pyroru.types.MessageEntity`, *optional*):
