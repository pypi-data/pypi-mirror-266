...
class MenuButton(Object):
    ...
    - :obj:`~pyroru.types.MenuButtonCommands`
    - :obj:`~pyroru.types.MenuButtonWebApp`
    - :obj:`~pyroru.types.MenuButtonDefault`

    If a menu button other than :obj:`~pyroru.types.MenuButtonDefault` is set for a private chat, then it is applied
    ...
    async def write(self, client: "pyroru.Client") -> "raw.base.BotMenuButton":
