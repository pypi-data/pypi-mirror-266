...
from pyroru.enums import MessageEntityType
from pyroru.errors import PeerIdInvalid
from . import utils
...
class Parser(HTMLParser):
    ...
    def __init__(self, client: "pyroru.Client"):
        super().__init__()
...
class HTML:
    def __init__(self, client: Optional["pyroru.Client"]):
        self.client = client
