...
from pyroru.connection import Connection
from pyroru.crypto import mtproto
...
from pyroru.raw.all import layer
from pyroru.raw.core import TLObject, MsgContainer, Int, FutureSalts
    ...
    async def invoke(
        ...
        while True:
            try:
                ...
                log.warning('[%s] Ожидание %s секунд перед продолжением (требуется для "%s")',
