...
from Rryyz.utils import get_file, cache_dir
from Rryyz.transforms import Compose, Flatten, ToFloat, Normalize


class Dataset:
    def __init__(self, train=True, transform=None, target_transform=None):
        self.train = train
        # transform对单个数据进行预处理，target_transform对单个标签进行预处理
    ...
    def __getitem__(self, index):
        ...
        # 如果没有标签数据，返回标签数据为None，这是无监督学习的情况
