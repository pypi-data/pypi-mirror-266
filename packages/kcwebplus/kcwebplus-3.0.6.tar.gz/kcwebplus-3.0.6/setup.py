...
setup(
    ...
    install_requires = ['kcweb>=5.28','pillow==10.3.0','pyOpenSSL==23.2.0','chardet==4.0.0','apscheduler==3.6.3','qrcode==6.1','pillow==9.0.0','psutil>=5.8.0','oss2>=2.12.1','websocket-client==1.3.1','cryptography==41.0.7'], #第三方包
    package_data = {
