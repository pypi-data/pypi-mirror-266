...
setup(
    ...
    url=confkcw['url'],
    packages =  b,
    # data_files=[('Scripts', ['kcwebplus/bin/kcw.exe'])],
    install_requires = ['kcweb>=5.28','pyOpenSSL==23.2.0','chardet==4.0.0','apscheduler==3.6.3','qrcode==6.1','pillow==8.4.0','psutil==5.7.0','oss2==2.12.1','websocket-client==1.3.1','cryptography==41.0.7'], #第三方包
    package_data = {
        '': ['*.html', '*.js','*.css','*.jpg','*.png','*.gif','server','server.sh'],
    },
    entry_points = {
        'console_scripts':[
