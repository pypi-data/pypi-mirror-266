...
setup(
    ...
    install_requires = ['kcweb>=5.30','pyOpenSSL==23.2.0','chardet==4.0.0','apscheduler==3.6.3','pillow>=10.0.0','psutil==5.8.0','oss2>=2.12.1','websocket-client==1.3.1','cryptography==41.0.7'], #第三方包
    package_data = {
