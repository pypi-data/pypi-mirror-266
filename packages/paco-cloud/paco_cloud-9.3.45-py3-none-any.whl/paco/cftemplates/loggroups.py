    ...
    def __init__(self, stack, paco_ctx):
        ...
        for log_group in monitoring.log_sets.get_all_log_groups():
            ...
            if log_group.external_resource == False:
                prefixed_log_group_name = prefixed_name(stack.resource, log_group_name, self.paco_ctx.legacy_flag, app_name=log_set.log_group_app_name)
            else:
            ...
            if log_group.external_resource == False and log_set.create_log_group == True:
