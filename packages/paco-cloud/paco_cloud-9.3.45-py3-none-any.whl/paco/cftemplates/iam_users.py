...
class IAMUsers(StackTemplate):
    ...
    def add_iam_user(self, iam_user):
        ...
        if iam_user.console_access_enabled == True:
            ...
            if self.paco_ctx.legacy_flag('iam_user_default_password_2024_03_15') == True:
                pass_param_name = self.create_cfn_logical_id('Password'+utils.md5sum(str_data=user_password))
            else:
                pass_param_name = self.create_cfn_logical_id('Password'+utils.md5sum(str_data=iam_user.username))
