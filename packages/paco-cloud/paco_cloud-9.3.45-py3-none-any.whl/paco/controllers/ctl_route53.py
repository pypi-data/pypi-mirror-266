...
class Route53Controller(Controller):
    ...
    def init(self, command=None, model_obj=None):
        ...
        if model_obj and isinstance(model_obj, dict) == False and model_obj.paco_ref_parts.startswith('resource.route53') == False:
            model_obj = None

        self.init_stack_groups(model_obj)
        self.paco_ctx.log_finish('Init', self.config)

    def init_stack_groups(self, model_obj):
