...
Applications contain a mandatory ``groups:`` field which is container of ResourceGroup objects.
...
.. Attention:: ResourceGroups and individual Resources both have an ``order`` field. When resources are
    created, they will be created based on the value of these ``order`` fields. First, the ResourceGroup
