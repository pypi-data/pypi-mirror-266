...
class SyncSketchAPI:
    ...
    def _get_json_response(
        ...
        if postData or method == "post":
            method = "post"
            r = requests.post(
                url, params=params, data=json.dumps(postData), headers=headers
            )
            ...
            method = "delete"
            r = requests.patch(
                url, params=params, data={"active": False}, headers=headers
            )
        else:
    ...
    def update_account(self, account_id, data):
        ...
        return self._get_json_response(
            "/api/v1/account/%s/" % account_id, patchData=data
        )
    ...
    def update_project(self, project_id, data):
        ...
        return self._get_json_response(
            "/api/v1/project/%s/" % project_id, patchData=data
        )
    ...
    def delete_project(self, project_id):
        ...
        """
        return self._get_json_response(
            "/api/v1/project/%s/" % project_id, patchData=dict(active=False)
        )
    ...
    def duplicate_project(
        ...
        return self._get_json_response(
            "/api/v2/project/%s/duplicate/" % project_id, postData=config
        )
    ...
    def archive_project(self, project_id):
        ...
        return self._get_json_response(
            "/api/v1/project/%s/" % project_id, patchData=dict(is_archived=True)
        )
    ...
    def restore_project(self, project_id):
        ...
        return self._get_json_response(
            "/api/v1/project/%s/" % project_id, patchData=dict(is_archived=False)
        )
    ...
    def sort_review_items(self, review_id, items):
        ...
        return self._get_json_response(
            "/api/v2/review/%s/sort_items/" % review_id, putData=dict(items=items)
        )
    ...
    def delete_review(self, review_id):
        ...
        """
        return self._get_json_response(
            "/api/v1/review/%s/" % review_id, patchData=dict(active=False)
        )
    ...
    def add_media_by_url(
        self, review_id, media_url, artist_name="", noConvertFlag=False
    ):
        """
    ...
    def add_media_v2(
        self, review_id, filepath, file_name="", item_uuid=None, noConvertFlag=False
    ):
        ...
        if not upload_response.ok:
            print(
                "Upload process failed while uploading file to S3.\nS3 response:\n{}".format(
    ...
    def delete_item(self, item_id):
        ...
        """
        return self._get_json_response(
            "/api/v1/item/%s/" % item_id, patchData=dict(active=False)
        )
    ...
    def add_comment(self, item_id, text, review_id, frame=0):
        ...
        return self._get_json_response(
            "/api/v1/frame/", method="post", postData=post_data
        )
    ...
    def get_flattened_annotations(
        self, review_id, item_id, with_tracing_paper=False, return_as_base64=False
    ):
        """
    ...
    def get_grease_pencil_overlays(self, review_id, item_id, homedir=None):
        ...
        while request_processing:
            ...
            # check the url again
            r = requests.get(
                check_celery_url, params=self.api_params, headers=self.headers
            )
    ...
    def get_connections_by_user_id(
        self, user_id, account_id, include_inactive=None, include_archived=None
    ):
        """
    ...
    def shotgun_create_config(
        self, syncsketch_account_id, syncsketch_project_id=None, data=None
    ):
        """
        ...
        test_response = self._get_json_response(
            "/api/v2/shotgun/config/test/", postData=test_data, raw_response=True
        )
        if test_response.status_code == 200:
            return self._get_json_response(
                "/api/v2/shotgun/config/", postData=post_data, raw_response=True
            )
        else:
            raise Exception(
                "Shotgun configuration test failed. Please check your Shotgrid config settings."
            )

    def shotgun_get_playlists(
        self, syncsketch_account_id, syncsketch_project_id, shotgun_project_id=None
    ):
        """
    ...
    def shotgun_sync_review_items(
        self, syncsketch_project_id, playlist_code, playlist_id, review_id=None
    ):
        """
        ...
        if "items" in response:
            for item in response["items"]:
                ...
                item_sync_url = (
                    "/api/v2/shotgun/sync-items/project/{}/review/{}/".format(
                        syncsketch_project_id, response["review_id"]
                    )
                )
                item_data = self._get_json_response(
                    item_sync_url, method="post", postData=data
                )
    ...
    def get_shotgun_sync_review_items_progress(self, task_id):
        ...
        """
        print(
            "Deprecated.  Response is printed in the shotgun_sync_review_items() function"
        )
