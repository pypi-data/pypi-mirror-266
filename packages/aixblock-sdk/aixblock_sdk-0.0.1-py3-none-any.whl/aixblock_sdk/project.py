...
class Project(Client):
    ...
    def get_task(self, task_id):
        ...
        -------
        dict:
            dict of task data containing all initial data and annotation results in [Label Studio JSON format](https://wow-ai.com/guide/tasks.html#Basic-aixblock-JSON-format)
    ...
    def upload_checkpoint(self, checkpoint, checkpoint_id):
        ...
        if isinstance(checkpoint, (str, Path)):
            ...
            with open(checkpoint, mode='rb') as f:
                response = self.make_request(
                    method='POST',
                    url=f'/api/checkpoint_model_marketplace/upload/{checkpoint_id}?project_id={self.id}',
                    files={'file': f},
                )
        else:
