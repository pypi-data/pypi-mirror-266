import os
import pytest
import oemof_tabular_plugins.general.pre_processing as gen_pre_p
...
# @pytest.mark.usefixtures("example_case")
def test_required_columns_missing_raises_error():
    gen_pre_p.pre_processing(os.path.join(test_inputs, "no_annuity_costs"), wacc=1, suffix="test")
