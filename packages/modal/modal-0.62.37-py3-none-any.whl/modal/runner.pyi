...
async def _create_all_objects(app: modal.app._LocalApp, indexed_objects: typing.Dict[str, modal.object._Object], new_app_state: int, environment_name: str, output_mgr: typing.Union[modal._output.OutputManager, None] = None):
    ...


async def _disconnect(app: modal.app._LocalApp, reason: typing.Union[int, None] = None, exc_str: typing.Union[str, None] = None):
    ...
