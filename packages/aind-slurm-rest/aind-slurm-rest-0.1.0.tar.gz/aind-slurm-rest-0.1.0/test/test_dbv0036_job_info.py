...
class TestDbv0036JobInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0036JobInfo:
        """Test Dbv0036JobInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0036JobInfo`
        """
        model = Dbv0036JobInfo()
        if include_optional:
            return Dbv0036JobInfo(
                errors = [
                    ...
                    aind_slurm_rest.models.dbv0/0/36_job.dbv0.0.36_job(
                        ...
                        time = aind_slurm_rest.models.dbv0_0_37_job_time.dbv0_0_37_job_time(
                            ...
                            user = aind_slurm_rest.models.dbv0_0_37_job_time_user.dbv0_0_37_job_time_user(
                                ...
                                microseconds = 56, ), 
                            limit = 56, ), 
                        association = aind_slurm_rest.models.dbv0/0/36_association_short_info.dbv0.0.36_association_short_info(
                            account = '', 
                            cluster = '', 
                            partition = '', ), 
                        cluster = '', 
                        constraints = '', 
                        derived_exit_code = aind_slurm_rest.models.dbv0/0/36_job_exit_code.dbv0.0.36_job_exit_code(
                            status = '', 
                            return_code = 56, 
                        ...
                        reservation = aind_slurm_rest.models.dbv0_0_37_job_reservation.dbv0_0_37_job_reservation(
                            id = 56, 
                            name = 56, ), 
                        state = aind_slurm_rest.models.dbv0_0_36_job_state.dbv0_0_36_job_state(
                            current = '', 
                            previous = '', ), 
                        steps = [
                            aind_slurm_rest.models.dbv0/0/36_job_step.dbv0.0.36_job_step(
                        ...
                        tres = aind_slurm_rest.models.dbv0_0_36_job_tres.dbv0_0_36_job_tres(), 
                        user = '', 
