...
class TestDbv0036AssociationsInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Dbv0036AssociationsInfo:
        """Test Dbv0036AssociationsInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Dbv0036AssociationsInfo`
        """
        model = Dbv0036AssociationsInfo()
        if include_optional:
            return Dbv0036AssociationsInfo(
                errors = [
