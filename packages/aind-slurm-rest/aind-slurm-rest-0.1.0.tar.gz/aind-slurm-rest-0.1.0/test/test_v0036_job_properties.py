...
class TestV0036JobProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0036JobProperties:
        """Test V0036JobProperties
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0036JobProperties`
        """
        model = V0036JobProperties()
        if include_optional:
            return V0036JobProperties(
                account = '',
