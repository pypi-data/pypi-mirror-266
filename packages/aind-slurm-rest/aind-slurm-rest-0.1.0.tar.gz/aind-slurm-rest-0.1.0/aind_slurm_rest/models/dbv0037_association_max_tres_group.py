...
class Dbv0037AssociationMaxTresGroup(BaseModel):
    ...
    Max TRES per group
    """ # noqa: E501
    minutes: Optional[List[Dbv0037TresListInner]] = Field(default=None, description="TRES list of attributes")
    active: Optional[List[Dbv0037TresListInner]] = Field(default=None, description="TRES list of attributes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "minutes": [Dbv0037TresListInner.from_dict(_item) for _item in obj["minutes"]] if obj.get("minutes") is not None else None,
            "active": [Dbv0037TresListInner.from_dict(_item) for _item in obj["active"]] if obj.get("active") is not None else None
        })
        return _obj
