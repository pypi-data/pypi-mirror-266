...
class Dbv0037Diag(BaseModel):
    ...
    statistics: Optional[Dbv0037DiagStatistics] = None
    __properties: ClassVar[List[str]] = ["errors", "statistics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statistics": Dbv0037DiagStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None
        })
        return _obj
