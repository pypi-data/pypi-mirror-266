...
class Dbv0037JobInfo(BaseModel):
    ...
    jobs: Optional[List[Dbv0037Job]] = Field(default=None, description="Array of jobs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobs": [Dbv0037Job.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None
        })
        return _obj
