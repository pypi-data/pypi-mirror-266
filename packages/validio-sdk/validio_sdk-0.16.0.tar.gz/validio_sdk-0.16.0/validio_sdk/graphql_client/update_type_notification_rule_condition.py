...
class UpdateTypeNotificationRuleCondition(BaseModel):
    type_notification_rule_condition_update: "UpdateTypeNotificationRuleConditionTypeNotificationRuleConditionUpdate" = Field(
        alias="typeNotificationRuleConditionUpdate"
    )
...
UpdateTypeNotificationRuleConditionTypeNotificationRuleConditionUpdate.model_rebuild()
