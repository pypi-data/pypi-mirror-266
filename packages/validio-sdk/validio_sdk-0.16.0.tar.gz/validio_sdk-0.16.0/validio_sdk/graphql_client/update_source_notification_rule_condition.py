...
class UpdateSourceNotificationRuleCondition(BaseModel):
    source_notification_rule_condition_update: "UpdateSourceNotificationRuleConditionSourceNotificationRuleConditionUpdate" = Field(
        alias="sourceNotificationRuleConditionUpdate"
    )
...
UpdateSourceNotificationRuleConditionSourceNotificationRuleConditionUpdate.model_rebuild()
