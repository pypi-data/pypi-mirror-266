...
class GetValidatorMetricDebugRecords(BaseModel):
    validator_metric_debug_records: "GetValidatorMetricDebugRecordsValidatorMetricDebugRecords" = Field(
...
GetValidatorMetricDebugRecordsValidatorMetricDebugRecords.model_rebuild()
