...
class GetSourceRecommendedValidatorsSourceRecommendedValidators(BaseModel):
    ...
    name: str
    source_config: "GetSourceRecommendedValidatorsSourceRecommendedValidatorsSourceConfig" = Field(
        alias="sourceConfig"
    )
...
GetSourceRecommendedValidatorsSourceRecommendedValidatorsSourceConfigSegmentation.model_rebuild()
