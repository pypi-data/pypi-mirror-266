...
class DbtArtifactMultipartUploadCreate(BaseModel):
    dbt_artifact_multipart_upload_create: "DbtArtifactMultipartUploadCreateDbtArtifactMultipartUploadCreate" = Field(
        alias="dbtArtifactMultipartUploadCreate"
    )
...
DbtArtifactMultipartUploadCreateDbtArtifactMultipartUploadCreateErrors.model_rebuild()
