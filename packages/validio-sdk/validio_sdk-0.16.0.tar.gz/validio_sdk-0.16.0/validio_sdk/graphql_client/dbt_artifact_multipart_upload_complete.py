...
class DbtArtifactMultipartUploadComplete(BaseModel):
    dbt_artifact_multipart_upload_complete: "DbtArtifactMultipartUploadCompleteDbtArtifactMultipartUploadComplete" = Field(
        alias="dbtArtifactMultipartUploadComplete"
    )
...
DbtArtifactMultipartUploadCompleteDbtArtifactMultipartUploadCompleteErrors.model_rebuild()
