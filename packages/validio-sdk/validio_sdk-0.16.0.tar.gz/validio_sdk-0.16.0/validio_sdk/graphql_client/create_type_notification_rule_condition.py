...
class CreateTypeNotificationRuleCondition(BaseModel):
    type_notification_rule_condition_create: "CreateTypeNotificationRuleConditionTypeNotificationRuleConditionCreate" = Field(
        alias="typeNotificationRuleConditionCreate"
    )
...
CreateTypeNotificationRuleConditionTypeNotificationRuleConditionCreate.model_rebuild()
