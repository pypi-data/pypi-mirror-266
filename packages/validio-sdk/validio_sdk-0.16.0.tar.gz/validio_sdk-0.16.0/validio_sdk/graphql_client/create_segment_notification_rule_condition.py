...
class CreateSegmentNotificationRuleCondition(BaseModel):
    segment_notification_rule_condition_create: "CreateSegmentNotificationRuleConditionSegmentNotificationRuleConditionCreate" = Field(
        alias="segmentNotificationRuleConditionCreate"
    )
...
CreateSegmentNotificationRuleConditionSegmentNotificationRuleConditionCreate.model_rebuild()
