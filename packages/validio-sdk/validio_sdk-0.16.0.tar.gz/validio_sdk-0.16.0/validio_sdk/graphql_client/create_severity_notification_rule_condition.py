...
class CreateSeverityNotificationRuleCondition(BaseModel):
    severity_notification_rule_condition_create: "CreateSeverityNotificationRuleConditionSeverityNotificationRuleConditionCreate" = Field(
        alias="severityNotificationRuleConditionCreate"
    )
...
CreateSeverityNotificationRuleConditionSeverityNotificationRuleConditionCreate.model_rebuild()
