...
class DbtArtifactMultipartUploadAppendPart(BaseModel):
    dbt_artifact_multipart_upload_append_part: "DbtArtifactMultipartUploadAppendPartDbtArtifactMultipartUploadAppendPart" = Field(
        alias="dbtArtifactMultipartUploadAppendPart"
    )
...
DbtArtifactMultipartUploadAppendPartDbtArtifactMultipartUploadAppendPartErrors.model_rebuild()
