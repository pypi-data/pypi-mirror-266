...
class UpdateOwnerNotificationRuleCondition(BaseModel):
    owner_notification_rule_condition_update: "UpdateOwnerNotificationRuleConditionOwnerNotificationRuleConditionUpdate" = Field(
        alias="ownerNotificationRuleConditionUpdate"
    )
...
UpdateOwnerNotificationRuleConditionOwnerNotificationRuleConditionUpdate.model_rebuild()
