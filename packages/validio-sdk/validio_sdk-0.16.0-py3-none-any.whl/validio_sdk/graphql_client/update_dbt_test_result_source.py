...
class UpdateDbtTestResultSource(BaseModel):
    dbt_test_result_source_update: "UpdateDbtTestResultSourceDbtTestResultSourceUpdate" = Field(
        alias="dbtTestResultSourceUpdate"
    )
...
UpdateDbtTestResultSourceDbtTestResultSourceUpdate.model_rebuild()
