...
class CreateDbtTestResultSource(BaseModel):
    dbt_test_result_source_create: "CreateDbtTestResultSourceDbtTestResultSourceCreate" = Field(
        alias="dbtTestResultSourceCreate"
    )
...
CreateDbtTestResultSourceDbtTestResultSourceCreate.model_rebuild()
