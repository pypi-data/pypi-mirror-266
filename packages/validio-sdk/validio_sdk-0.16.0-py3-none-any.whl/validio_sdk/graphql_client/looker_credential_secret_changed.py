...
class LookerCredentialSecretChanged(BaseModel):
    looker_credential_secret_changed: "LookerCredentialSecretChangedLookerCredentialSecretChanged" = Field(
        alias="lookerCredentialSecretChanged"
    )
...
LookerCredentialSecretChangedLookerCredentialSecretChanged.model_rebuild()
