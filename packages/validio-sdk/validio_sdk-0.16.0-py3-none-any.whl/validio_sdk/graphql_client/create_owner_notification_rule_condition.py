...
class CreateOwnerNotificationRuleCondition(BaseModel):
    owner_notification_rule_condition_create: "CreateOwnerNotificationRuleConditionOwnerNotificationRuleConditionCreate" = Field(
        alias="ownerNotificationRuleConditionCreate"
    )
...
CreateOwnerNotificationRuleConditionOwnerNotificationRuleConditionCreate.model_rebuild()
