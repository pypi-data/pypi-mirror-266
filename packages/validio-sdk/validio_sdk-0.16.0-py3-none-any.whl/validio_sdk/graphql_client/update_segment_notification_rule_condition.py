...
class UpdateSegmentNotificationRuleCondition(BaseModel):
    segment_notification_rule_condition_update: "UpdateSegmentNotificationRuleConditionSegmentNotificationRuleConditionUpdate" = Field(
        alias="segmentNotificationRuleConditionUpdate"
    )
...
UpdateSegmentNotificationRuleConditionSegmentNotificationRuleConditionUpdate.model_rebuild()
