...
class DatabricksCredentialSecretChanged(BaseModel):
    databricks_credential_secret_changed: "DatabricksCredentialSecretChangedDatabricksCredentialSecretChanged" = Field(
        alias="databricksCredentialSecretChanged"
    )
...
DatabricksCredentialSecretChangedDatabricksCredentialSecretChanged.model_rebuild()
