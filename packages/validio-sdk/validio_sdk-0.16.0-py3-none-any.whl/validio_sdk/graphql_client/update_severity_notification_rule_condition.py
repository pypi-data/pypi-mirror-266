...
class UpdateSeverityNotificationRuleCondition(BaseModel):
    severity_notification_rule_condition_update: "UpdateSeverityNotificationRuleConditionSeverityNotificationRuleConditionUpdate" = Field(
        alias="severityNotificationRuleConditionUpdate"
    )
...
UpdateSeverityNotificationRuleConditionSeverityNotificationRuleConditionUpdate.model_rebuild()
