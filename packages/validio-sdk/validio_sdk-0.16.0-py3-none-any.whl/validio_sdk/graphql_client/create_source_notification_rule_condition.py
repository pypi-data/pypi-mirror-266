...
class CreateSourceNotificationRuleCondition(BaseModel):
    source_notification_rule_condition_create: "CreateSourceNotificationRuleConditionSourceNotificationRuleConditionCreate" = Field(
        alias="sourceNotificationRuleConditionCreate"
    )
...
CreateSourceNotificationRuleConditionSourceNotificationRuleConditionCreate.model_rebuild()
