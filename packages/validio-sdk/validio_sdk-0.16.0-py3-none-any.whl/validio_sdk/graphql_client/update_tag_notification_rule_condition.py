...
class UpdateTagNotificationRuleCondition(BaseModel):
    tag_notification_rule_condition_update: "UpdateTagNotificationRuleConditionTagNotificationRuleConditionUpdate" = Field(
        alias="tagNotificationRuleConditionUpdate"
    )
...
UpdateTagNotificationRuleConditionTagNotificationRuleConditionUpdate.model_rebuild()
