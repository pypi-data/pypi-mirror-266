...
class UpdateDatabricksCredential(BaseModel):
    databricks_credential_update: "UpdateDatabricksCredentialDatabricksCredentialUpdate" = Field(
        alias="databricksCredentialUpdate"
    )
...
UpdateDatabricksCredentialDatabricksCredentialUpdate.model_rebuild()
