...
class CreateDatabricksCredential(BaseModel):
    databricks_credential_create: "CreateDatabricksCredentialDatabricksCredentialCreate" = Field(
        alias="databricksCredentialCreate"
    )
...
CreateDatabricksCredentialDatabricksCredentialCreate.model_rebuild()
