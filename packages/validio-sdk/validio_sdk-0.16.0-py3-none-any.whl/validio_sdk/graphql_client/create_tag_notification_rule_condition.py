...
class CreateTagNotificationRuleCondition(BaseModel):
    tag_notification_rule_condition_create: "CreateTagNotificationRuleConditionTagNotificationRuleConditionCreate" = Field(
        alias="tagNotificationRuleConditionCreate"
    )
...
CreateTagNotificationRuleConditionTagNotificationRuleConditionCreate.model_rebuild()
