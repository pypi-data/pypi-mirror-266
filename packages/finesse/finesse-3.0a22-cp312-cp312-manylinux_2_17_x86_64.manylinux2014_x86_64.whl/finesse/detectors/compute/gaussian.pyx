...
cdef c_bp_detector_output(DetectorWorkspace dws) noexcept:
...
cdef c_bp_q_detector_output(DetectorWorkspace dws) noexcept:
    cdef BPDetectorWorkspace ws = <BPDetectorWorkspace> dws
...
cdef c_cp_detector_output(DetectorWorkspace dws) noexcept:
...
cdef c_cp_detector_abcd_output(DetectorWorkspace dws) noexcept:
...
cdef c_cp_detector_from_mode_output(DetectorWorkspace dws) noexcept:
...
cdef c_cp_detector_mode_output(DetectorWorkspace dws) noexcept:
    cdef CPDetectorModeWorkspace ws = <CPDetectorModeWorkspace> dws
...
cdef c_astig_detector_output(DetectorWorkspace dws) noexcept:
...
cdef c_mode_mismatch_detector_output(DetectorWorkspace dws) noexcept:
...
cdef c_acc_gouy_detector_output(DetectorWorkspace dws) noexcept:
    cdef:
