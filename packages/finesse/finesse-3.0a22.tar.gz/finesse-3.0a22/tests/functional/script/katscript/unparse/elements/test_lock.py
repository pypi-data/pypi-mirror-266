...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            True,
            False,
            "lock lock1 pdh1_I m1.Rcx 1.0 1e-09 disabled=false offset=0.0",
        ),
        (
            "lock1",
            ["pdh1.outputs.I", "m1.Rcx", 1, 1e-9],
            ...
            True,
            True,
            "lock lock1 error_signal=pdh1_I feedback=m1.Rcx gain=1.0 accuracy=1e-09 disabled=false offset=0.0",
        ),
