...
def get_ext_modules() -> Sequence[Extension]:
    ...
    # TODO check here whether all pyx files exist and whether there are any missing?
    ext_kwargs = {
        Path("enums.pyx"): default_ext_args,
        Path("cymath/*.pyx"): {**default_ext_args, **open_mp_args},
        ...
        Path("element.pyx"): default_ext_args,
        Path("cmatrix.pyx"): {**default_ext_args, **cmatrix_args},
        Path("knm/*.pyx"): {**default_ext_args, **open_mp_args},
        Path("simulations/base.pyx"): default_ext_args,
        Path("simulations/basematrix.pyx"): default_ext_args,
        Path("simulations/KLU.pyx"): default_ext_args,
...
def check_pyx_files(pyx_files: KeysView[Path]) -> None:
    ...
    pyx_in_repo = set(FINESSE_DIR.rglob("*.pyx"))
