...
cdef class CCSMatrix:
    ...
    cpdef _declare_submatrix(self, SuiteSparse_long _from, SuiteSparse_long _to,
                        unicode name, callback=?, type_=?) noexcept
    cpdef set_rhs(self, SuiteSparse_long index, complex_t value, unsigned rhs_index=?) noexcept
    ...
    cpdef construct(self, complex_t diagonal_fill=?) noexcept
    ...
    cpdef clear_rhs(self, unsigned rhs_index=?) noexcept
