...
cdef class FillFuncWrapper:
    ...
    @staticmethod
    cdef FillFuncWrapper make_from_ptr(fptr_c_fill f) noexcept

cdef class GouyFuncWrapper:
    cdef fptr_c_gouy func
    @staticmethod
    cdef GouyFuncWrapper make_from_ptr(fptr_c_gouy f) noexcept
...
cdef class ConnectorWorkspace(ElementWorkspace):
    ...
    cdef setup_quantum_noise(self) noexcept
