    ...
    def _add_parser_arguments(self):  # pylint: disable=too-many-statements
        ...
        self.parser.add_argument(
            *CLI_ARGUMENTS[MOUNT_STORAGE],
            ...
            + "(e.g, fovus --mount-storage --windows-drive Z)",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            *CLI_ARGUMENTS[AUTO_DELETE_DAYS],
            ...
            help="Set the auto-delete timer. The timer starts to tick upon job completion or termination. "
            + "The job will be permanently deleted when this timer expires.",
        )
        self.parser.add_argument(
