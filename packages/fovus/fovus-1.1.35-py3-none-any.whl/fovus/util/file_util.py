...
class FileUtil:
    ...
    def get_files_in_job_directory(
        ...
        for directory_path, dirs, filenames in os.walk(root_directory_path):
            ...
            dirs[:] = [
                ...
                and FileUtil.include_exclude_allows_path(
                    os.path.relpath(os.path.join(directory_path, dirname), root_directory_path) + os.sep,
                    False,
                    exclude_input_list,
                )
            ]
        ...
        empty_folderpath_list = [
            folderpath
            for folderpath in empty_folderpath_list
        ...
        task_directories = [
            dirname for dirname in [*local_folderpath_list, *empty_folderpath_list] if "/" not in dirname
        ]
