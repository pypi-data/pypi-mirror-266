...
from tradescope.exceptions import DDosProtection, OperationalException, TemporaryError
from tradescope.exchange import Exchange
from tradescope.exchange.common import retrier
from tradescope.exchange.types import OHLCVResponse, Tickers
from tradescope.misc import deep_merge_dicts, json_load
...
class Binance(Exchange):
    ...
    def dry_run_liquidation_price(
        ...
        if self.trading_mode == TradingMode.FUTURES:
            ...
            raise OperationalException(
                "Tradescope only supports isolated futures for leverage trading")
