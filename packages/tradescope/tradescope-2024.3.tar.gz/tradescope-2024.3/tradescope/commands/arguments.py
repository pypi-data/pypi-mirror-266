...
from tradescope.commands.cli_options import AVAILABLE_CLI_OPTIONS
from tradescope.constants import DEFAULT_CONFIG
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        from tradescope.commands import (start_analysis_entries_exits, start_backtesting,
                                         ...
                                         start_list_timeframes, start_list_tradeAI_models,
                                         start_lookahead_analysis, start_new_config,
                                         start_new_strategy, start_plot_dataframe,
                                         start_plot_profit, start_recursive_analysis,
                                         start_show_config, start_show_trades,
