...
from tradescope.constants import UNLIMITED_STAKE_AMOUNT, Config
from tradescope.optimize.optimize_reports.optimize_reports import generate_periodic_breakdown_stats
...
def text_table_add_metrics(strat_results: Dict) -> str:
    if len(strat_results['trades']) > 0:
        ...
        # command stores these results and newer version of tradescope must be able to handle old
