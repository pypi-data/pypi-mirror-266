...
from tradescope.tradeai.base_models.BasePyTorchClassifier import BasePyTorchClassifier
...
class PyTorchMLPClassifier(BasePyTorchClassifier):
    """
    This class implements the fit method of ITradeaiModel.
    ...
    parameters are passed via `model_training_parameters` under the tradeai
