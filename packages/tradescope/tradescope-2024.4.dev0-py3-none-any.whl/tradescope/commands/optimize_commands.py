...
from tradescope.exceptions import ConfigurationError, OperationalException
from tradescope.util import fmt_coin
...
def start_backtesting(args: Dict[str, Any]) -> None:
    ...
    logger.info('Starting tradescope in Backtesting mode')
...
def start_backtesting_show(args: Dict[str, Any]) -> None:
    ...
    from tradescope.data.btanalysis import load_backtest_stats
    from tradescope.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: Dict[str, Any]) -> None:
    ...
    try:
        ...
        from tradescope.optimize.hyperopt import Hyperopt
    ...
    logger.info('Starting tradescope in Hyperopt mode')
    ...
    try:
        ...
        logger.info("Another running instance of tradescope Hyperopt detected.")
        logger.info("Simultaneous execution of multiple Hyperopt commands is not supported. "
                    "Hyperopt module is resource hungry. Please run your Hyperopt sequentially "
                    "or on separate machines.")
        logger.info("Quitting now.")
        # TODO: return False here in order to help tradescope to exit
...
def start_edge(args: Dict[str, Any]) -> None:
    ...
    :return: None
    """
    from tradescope.optimize.edge_cli import EdgeCli

    # Initialize configuration
    config = setup_optimize_configuration(args, RunMode.EDGE)
    logger.info('Starting tradescope in Edge mode')
