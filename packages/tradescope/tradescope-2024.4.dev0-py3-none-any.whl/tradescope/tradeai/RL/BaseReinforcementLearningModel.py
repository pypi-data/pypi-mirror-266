...
class BaseReinforcementLearningModel(ITradeaiModel):
    """
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.max_threads = min(self.tradeai_info['rl_config'].get(
            'cpu_count', 1), max(int(self.max_system_threads / 2), 1))
        th.set_num_threads(self.max_threads)
        self.reward_params = self.tradeai_info['rl_config']['model_reward_parameters']
        ...
        self.model_type = self.tradeai_info['rl_config']['model_type']
        self.rl_config = self.tradeai_info['rl_config']
        ...
        self.policy_type = self.tradeai_info['rl_config']['policy_type']
    ...
    def train(
        ...
        if self.tradeai_info.get('data_split_parameters', {}).get('test_size', 0.1) != 0:
            (dd["test_features"],
             dd["test_labels"],
    ...
    def set_train_and_eval_environments(self, data_dictionary: Dict[str, DataFrame],
        ...
        :param dk: TradeaiDataKitchen = the datakitchen for the current pair
        """
    ...
    @abstractmethod
    def fit(self, data_dictionary: Dict[str, Any], dk: TradeaiDataKitchen, **kwargs):
        """
    ...
    def predict(
        ...
        :do_predict: np.array of 1s and 0s to indicate places where tradeai needed to remove
    ...
    def rl_model_predict(self, dataframe: DataFrame,
                         dk: TradeaiDataKitchen, model: Any) -> DataFrame:
        """
        A helper function to make predictions in the Reinforcement learning module.
        :param dataframe: DataFrame = the dataframe of features to make the predictions on
        :param dk: TradeaiDatakitchen = data kitchen for the current pair
    ...
    def build_ohlc_price_dataframes(self, data_dictionary: dict,
                                    pair: str, dk: TradeaiDataKitchen) -> Tuple[DataFrame,
                                                                               DataFrame]:
        """
    ...
    def drop_ohlc_from_df(self, df: DataFrame, dk: TradeaiDataKitchen):
        """
    ...
    def load_model_from_disk(self, dk: TradeaiDataKitchen) -> Any:
        """
