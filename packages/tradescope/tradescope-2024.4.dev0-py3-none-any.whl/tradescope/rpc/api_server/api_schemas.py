...
from tradescope.constants import IntOrInf
from tradescope.enums import MarginMode, OrderTypeValues, SignalDirection, TradingMode
...
class TradeAIModelListResponse(BaseModel):
...
class BacktestTradeAIInputs(BaseModel):
    identifier: str
...
class BacktestRequest(BaseModel):
    ...
    tradeai: Optional[BacktestTradeAIInputs] = None
