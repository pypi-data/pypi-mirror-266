...
from tradescope.optimize.hyperopt_epoch_filters import hyperopt_filter_epochs
from tradescope.optimize.optimize_reports import generate_wins_draws_losses
        ...
        for epochs_tmp in HyperoptTools._read_results(results_file):
            if total_epochs == 0 and epochs_tmp[0].get('is_best') is None:
                raise OperationalException(
                    ...
                    "of Tradescope and cannot be loaded.")
