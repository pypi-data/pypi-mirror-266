...
from tradescope.configuration import TimeRange, validate_config_consistency
from tradescope.constants import DATETIME_PRINT_FORMAT, Config, IntOrInf, LongShort
from tradescope.data import history
from tradescope.data.btanalysis import find_existing_backtest_stats, trade_list_to_dataframe
...
from tradescope.types import BacktestResultType, get_BacktestResultType_default
from tradescope.util.migrations import migrate_data
...
class Backtesting:
        ...
        if exit_.exit_flag:
            ...
            if exit_.exit_type in (ExitType.EXIT_SIGNAL, ExitType.CUSTOM_EXIT,
                ...
                if order_type == 'limit':
                    ...
                    # tradescope does not support this in live, and the order would fill immediately
                    if trade.is_short:
    ...
    def get_valid_price_and_stake(
        ...
        if order_type == 'limit':
            ...
            # which tradescope does not support in live.
