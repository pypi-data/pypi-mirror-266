...
from tradescope.configuration.deprecated_settings import process_temporary_deprecated_settings
from tradescope.configuration.directory_operations import create_datadir, create_userdata_dir
from tradescope.configuration.environment_vars import enironment_vars_to_dict
from tradescope.configuration.load_config import load_file, load_from_files
from tradescope.constants import Config
from tradescope.enums import NON_UTIL_MODES, TRADE_MODES, CandleType, RunMode, TradingMode
from tradescope.exceptions import OperationalException
from tradescope.loggers import setup_logging
from tradescope.misc import deep_merge_dicts, parse_db_uri_for_logging
...
class Configuration:
    ...
    def load_config(self) -> Dict[str, Any]:
        ...
        from tradescope.commands.arguments import NO_CONF_ALLOWED
