...
from tradescope.misc import round_dict
...
class IHyperOpt(ABC):
    """
    Interface for tradescope hyperopt
    ...
    def roi_space(self) -> List[Dimension]:
        ...
        It's used by Tradescope by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy Tradescope roi_space()
