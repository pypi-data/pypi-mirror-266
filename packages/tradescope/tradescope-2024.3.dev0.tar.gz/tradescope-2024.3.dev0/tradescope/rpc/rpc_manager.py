...
from tradescope.enums import NO_ECHO_MESSAGES, RPCMessageType
from tradescope.rpc import RPC, RPCHandler
...
class RPCManager:
    ...
    def __init__(self, tradescope) -> None:
        ...
        self._rpc = RPC(tradescope)
        config = tradescope.config
        # Enable telegram
        if config.get('telegram', {}).get('enabled', False):
            logger.info('Enabling rpc.telegram ...')
            from tradescope.rpc.telegram import Telegram
