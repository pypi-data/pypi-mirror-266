...
class TradeaiExampleStrategy(IStrategy):
    """
    Example strategy showing how the user connects their own
    ITradeaiModel to the strategy.

    Warning! This is a showcase of functionality,
    which means that it is designed to show various functions of TradeAI
    ...
    def set_tradeai_targets(self, dataframe: DataFrame, metadata: Dict, **kwargs) -> DataFrame:
        ...
        *Only functional with TradeAI enabled strategies*
        ...
        # tradeai/prediction_models/CatboostRegressorMultiTarget.py,
        # tradescope trade --tradeaimodel CatboostRegressorMultiTarget
