class TradescopeException(Exception):
    """
    Tradescope base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(TradescopeException):
    """
...
class DependencyException(TradescopeException):
    """
...
class StrategyError(TradescopeException):
    """
