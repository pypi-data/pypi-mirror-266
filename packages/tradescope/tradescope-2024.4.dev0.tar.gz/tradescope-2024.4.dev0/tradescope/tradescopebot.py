"""
Tradescope is the main module of this bot. It contains the class Tradescope()
"""
import logging
import traceback
...
from tradescope.configuration import validate_config_consistency
from tradescope.constants import BuySell, Config, EntryExecuteMode, ExchangeConfig, LongShort
from tradescope.data.converter import order_book_to_dataframe
...
class TradescopeBot(LoggingMixin):
    """
    Tradescope is the main class of the bot.
    ...
    def __init__(self, config: Config) -> None:
        ...
        # initialization, even before Tradescopebot has a chance to start its throttling,
        # so anything in the Tradescopebot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, tradescope may try to recreate stoploss_on_exchange orders
