...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for tradescope strategies
    ...
    def load_tradeAI_model(self) -> None:
        if self.config.get('tradeai', {}).get('enabled', False):
            ...
            # Gracious failures if tradeAI is disabled but "start" is called.
            class DummyClass:
                def start(self, *args, **kwargs):
                    raise OperationalException(
                        'tradeAI is not enabled. '
    ...
    def confirm_trade_entry(self, pair: str, order_type: str, amount: float, rate: float,
        ...
        For full documentation please go to https://www.tradescope.khulnasoft.com/en/latest/strategy-advanced/
    ...
    def adjust_entry_price(self, trade: Trade, order: Optional[Order], pair: str,
        ...
        For full documentation please go to https://www.tradescope.khulnasoft.com/en/latest/strategy-callbacks/
    ...
    def populate_any_indicators(self, pair: str, df: DataFrame, tf: str,
        ...
        This method is *only* used in TradeaiDataKitchen class and therefore
        it is only called if TradeAI is active.
    ...
    def feature_engineering_expand_all(self, dataframe: DataFrame, period: int,
        ...
        *Only functional with TradeAI enabled strategies*
        ...
        https://www.tradescope.khulnasoft.com/en/latest/tradeai-parameter-table/#feature-parameters

        https://www.tradescope.khulnasoft.com/en/latest/tradeai-feature-engineering/#defining-the-features
    ...
    def feature_engineering_standard(
        ...
        *Only functional with TradeAI enabled strategies*
        ...
        https://www.tradescope.khulnasoft.com/en/latest/tradeai-feature-engineering
...
###
    ...
    def __informative_pairs_tradeai(self) -> ListPairsWithTimeframes:
        """
        Create informative-pairs needed for TradeAI
        """
        if self.config.get('tradeai', {}).get('enabled', False):
    ...
    def gather_informative_pairs(self) -> ListPairsWithTimeframes:
        ...
        informative_pairs.extend(self.__informative_pairs_tradeai())
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by tradescope itself, but intended to be used if users lock pairs
