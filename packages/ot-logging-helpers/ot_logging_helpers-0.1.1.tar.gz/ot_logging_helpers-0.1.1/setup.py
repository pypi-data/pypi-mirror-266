...
setup(
    ...
    name='ot_logging_helpers',  # Required
    ...
    description='Python Logging Helpers',  # Optional
    ...
    url='https://github.com/orthanc-team/ot-logging-helpers',  # Optional
    ...
    #
    packages=["ot_logging_helpers"],  # Required
