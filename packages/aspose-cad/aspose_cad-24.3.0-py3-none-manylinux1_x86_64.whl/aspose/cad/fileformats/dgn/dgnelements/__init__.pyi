...
class DgnMultiTextElement(DgnTextElement):
    ...
    def add_text(self, text : aspose.cad.fileformats.dgn.dgnelements.DgnTextElement) -> None:
        '''Adds text element
    ...
    @property
    def strings(self) -> List[aspose.cad.fileformats.dgn.dgnelements.DgnTextElement]:
        '''Gets lines'''
        ...
