...
class HandleCodes:
    ...
    @classmethod
    @soft_ownership_reference.setter
    def soft_ownership_reference(cls, value : int):
        '''Soft ownership reference: the owner does not need the owned object. The owned object
        cannot exist by itself. Code - 2'''
        ...
    ...
    @classmethod
    @hard_ownership_reference.setter
    def hard_ownership_reference(cls, value : int):
        '''Hard ownership reference: the owner needs the owned object. The owned object cannot exist
        by itself. Code - 3'''
        ...
    ...
    @classmethod
    @soft_pointer_reference.setter
    def soft_pointer_reference(cls, value : int):
        '''Soft pointer reference: the referencing object does not need the referenced object and vice
        versa. Code - 4'''
        ...
    ...
    @classmethod
    @hard_pointer_reference.setter
    def hard_pointer_reference(cls, value : int):
        '''Hard pointer reference: the referencing object needs the referenced object, but both are
        owned by another object. Code - 5'''
        ...
    ...
    @classmethod
    @handle_plus_one_reference.setter
    def handle_plus_one_reference(cls, value : int):
        '''The handle plus one reference. Code - 6'''
        ...
    ...
    @classmethod
    @handle_minus_one_reference.setter
    def handle_minus_one_reference(cls, value : int):
        '''The handle minus one reference. Code - 8'''
        ...
    ...
    @classmethod
    @handle_plus_offset_reference.setter
    def handle_plus_offset_reference(cls, value : int):
        '''The handle plus offset reference. Code - 10 (0xA)'''
        ...
    ...
    @classmethod
    @handle_minus_offset_reference.setter
    def handle_minus_offset_reference(cls, value : int):
        '''The handle minus offset reference. Code - 12 (0xC)'''
        ...
