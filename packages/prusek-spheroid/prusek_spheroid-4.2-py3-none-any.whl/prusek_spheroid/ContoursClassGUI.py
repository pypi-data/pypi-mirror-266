...
class Contours(BaseImageProcessing):
    ...
    def __init__(self, master, adresaDatasetu, adresa_output, projekt, algorithm, parameters, show_img, function,
        ...
        try:
            # Attempt to load the model and scaler from the primary location
            ...
            self.model = joblib.load("prusek_spheroid/gradient_boosting_classifier.joblib")
            self.scaler = joblib.load("prusek_spheroid/scaler.joblib")
