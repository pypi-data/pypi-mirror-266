...
class ImagePromptJson(BaseModel):
    ...
    ImagePromptJson
    """ # noqa: E501
    cn_img: Optional[CnImg1] = None
    cn_stop: Optional[CnStop1] = None
    cn_weight: Optional[CnWeight1] = None
    cn_type: Optional[ControlNetType] = Field(default=None, description="ControlNet type for image prompt")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cn_img": CnImg1.from_dict(obj["cn_img"]) if obj.get("cn_img") is not None else None,
            "cn_stop": CnStop1.from_dict(obj["cn_stop"]) if obj.get("cn_stop") is not None else None,
            "cn_weight": CnWeight1.from_dict(obj["cn_weight"]) if obj.get("cn_weight") is not None else None,
