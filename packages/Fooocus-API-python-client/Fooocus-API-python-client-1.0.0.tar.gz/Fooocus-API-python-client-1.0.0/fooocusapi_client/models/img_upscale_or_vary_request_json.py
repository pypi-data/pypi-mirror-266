...
class ImgUpscaleOrVaryRequestJson(BaseModel):
    """
    ...
    uov_method: Optional[UpscaleOrVaryMethod] = None
    upscale_value: Optional[UpscaleValue1] = None
    input_image: StrictStr = Field(description="Init image for upsacale or outpaint as base64")
    image_prompts: Optional[List[ImgInpaintOrOutpaintRequestJsonImagePromptsInner]] = None
    __properties: ClassVar[List[str]] = ["prompt", "negative_prompt", "style_selections", "performance_selection", "aspect_ratios_selection", "image_number", "image_seed", "sharpness", "guidance_scale", "base_model_name", "refiner_model_name", "refiner_switch", "loras", "advanced_params", "require_base64", "async_process", "webhook_url", "uov_method", "upscale_value", "input_image", "image_prompts"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of upscale_value
        if self.upscale_value:
            _dict['upscale_value'] = self.upscale_value.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uov_method": obj.get("uov_method"),
            "upscale_value": UpscaleValue1.from_dict(obj["upscale_value"]) if obj.get("upscale_value") is not None else None,
