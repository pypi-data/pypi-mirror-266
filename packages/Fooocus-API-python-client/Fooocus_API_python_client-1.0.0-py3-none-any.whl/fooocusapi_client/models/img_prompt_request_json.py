...
class ImgPromptRequestJson(BaseModel):
    """
    ...
    image_prompts: List[ImgInpaintOrOutpaintRequestJsonImagePromptsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "input_image": InputImage.from_dict(obj["input_image"]) if obj.get("input_image") is not None else None,
