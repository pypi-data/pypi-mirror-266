...
class JobHistoryResponse(BaseModel):
    ...
    JobHistoryResponse
    """ # noqa: E501
    queue: Optional[List[JobHistoryInfo]] = None
    history: Optional[List[JobHistoryInfo]] = None
    __properties: ClassVar[List[str]] = ["queue", "history"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queue": [JobHistoryInfo.from_dict(_item) for _item in obj["queue"]] if obj.get("queue") is not None else None,
            "history": [JobHistoryInfo.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None
        })
        return _obj
