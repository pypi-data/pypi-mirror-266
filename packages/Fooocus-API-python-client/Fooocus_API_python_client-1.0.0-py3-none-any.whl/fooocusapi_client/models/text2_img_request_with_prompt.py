...
class Text2ImgRequestWithPrompt(BaseModel):
    """
    ...
    image_prompts: Optional[List[ImagePromptJson]] = None
    __properties: ClassVar[List[str]] = ["prompt", "negative_prompt", "style_selections", "performance_selection", "aspect_ratios_selection", "image_number", "image_seed", "sharpness", "guidance_scale", "base_model_name", "refiner_model_name", "refiner_switch", "loras", "advanced_params", "require_base64", "async_process", "webhook_url", "image_prompts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image_prompts": [ImagePromptJson.from_dict(_item) for _item in obj["image_prompts"]] if obj.get("image_prompts") is not None else None
        })
        return _obj
