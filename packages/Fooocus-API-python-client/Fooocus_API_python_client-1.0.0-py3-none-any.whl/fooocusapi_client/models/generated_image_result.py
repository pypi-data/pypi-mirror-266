...
class GeneratedImageResult(BaseModel):
    ...
    """ # noqa: E501
    var_base64: ModelBase64 = Field(alias="base64")
    url: Url
    seed: StrictStr = Field(description="The seed associated with this image")
    finish_reason: GenerationFinishReason
    __properties: ClassVar[List[str]] = ["base64", "url", "seed", "finish_reason"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "base64": ModelBase64.from_dict(obj["base64"]) if obj.get("base64") is not None else None,
