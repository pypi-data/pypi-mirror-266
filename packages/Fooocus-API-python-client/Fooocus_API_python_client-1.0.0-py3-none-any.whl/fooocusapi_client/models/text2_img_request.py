...
class Text2ImgRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prompt", "negative_prompt", "style_selections", "performance_selection", "aspect_ratios_selection", "image_number", "image_seed", "sharpness", "guidance_scale", "base_model_name", "refiner_model_name", "refiner_switch", "loras", "advanced_params", "require_base64", "async_process", "webhook_url"]
