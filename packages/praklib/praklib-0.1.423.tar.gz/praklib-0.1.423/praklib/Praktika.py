...
def unumpy_graf(unumpy_array_x, unumpy_array_y, xlabel, ylabel, linelabel, scatterlabel,
        grid=True, show=True, scatter=True, line=False, err=True, xlim=(0,0), ylim =(0,0), loc="upper right",
        scattercolor="red", linecolor="teal", marker="x"):
    graf(unp.nominal_values(unumpy_array_x), unp.nominal_values(unumpy_array_y),
         unp.std_devs(unumpy_array_x), unp.std_devs(unumpy_array_y), xlabel, ylabel, linelabel, scatterlabel,
         grid, show, scatter, line, err, xlim, ylim, loc,
         scattercolor, linecolor, marker)
