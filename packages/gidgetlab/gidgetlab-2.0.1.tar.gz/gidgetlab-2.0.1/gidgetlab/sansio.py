...
def create_headers(
    ...
    `authenticated request <https://docs.gitlab.com/ee/api/rest/#authentication>`_.
    `Personal/group/project access tokens <https://docs.gitlab.com/ee/api/rest/#personalprojectgroup-access-tokens>`_
    as well as `Oauth 2.0 tokens <https://docs.gitlab.com/ee/api/rest/#oauth-20-tokens>`_ are supported.
