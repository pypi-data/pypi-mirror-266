...
class AnomalyResult(BaseModel):
    ...
    scores: Optional[List[List[float]]] = Field(None, description="Raw anomaly scores. For visual anomaly detection, the scores corresponds to each grid cell in the image's spatial matrix.")
