...
Page1View = create_test_view("""    
    ...
    {% silica 'django_silica.tests.test_class_property_modification.Component' change_prop='True' %}
""")


Page2View = create_test_view("""   
    <h1>Page 2</h1>
    {% silica 'django_silica.tests.test_class_property_modification.Component' change_prop='False' %}
""")
