...
But wait there is more! use background colors, filled Variants which can be accessed by calling their specific name and 'Bg' postfix as in background.

For more info check out [GitHub - trmnl-colors]("https://github.com/Idrisvohra9/trmnl-colors")
