...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "useInvoiceListStore": () => (/* binding */ useInvoiceListStore),
...
/* harmony import */ var _api_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/api/index */ "./src/api/index.ts");
...
/* harmony import */ var _api_meilisearch_useMeiliSearchIndex_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/api/meilisearch/useMeiliSearchIndex.js */ "./src/api/meilisearch/useMeiliSearchIndex.js");
/* harmony import */ var _helpers_meilisearch__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @/helpers/meilisearch */ "./src/helpers/meilisearch.ts");
/* harmony import */ var _views_invoices_list_columnsDef__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/views/invoices/list/columnsDef */ "./src/views/invoices/list/columnsDef.js");
...
var useTaskConfigStore = (0,_formConfig__WEBPACK_IMPORTED_MODULE_3__["default"])('task');
var useTaskStore = (0,pinia__WEBPACK_IMPORTED_MODULE_10__.defineStore)('task', {
  state: function state() {
    return {
      loading: true,
      error: false,
  ...
  actions: {
    setAddUrl: function setAddUrl(url) {
      _api_index__WEBPACK_IMPORTED_MODULE_4__["default"].tasks.setCollectionUrl(url);
    },
      ...
      return (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              return _context.abrupt("return", _api_index__WEBPACK_IMPORTED_MODULE_4__["default"].tasks.create(data));
            case 3:
            case "end":
              return _context.stop();
          }
...
var useInvoiceListStore = (0,pinia__WEBPACK_IMPORTED_MODULE_10__.defineStore)('invoice_list', function () {
  // Default params
  var defaultParams = {
    page: 0,
    items_per_page: 20,
    ...
    search: '',
    filters: {},
    columns: _views_invoices_list_columnsDef__WEBPACK_IMPORTED_MODULE_9__["default"].map(function (col) {
      return col.name;
    })
  };
  // update defaults with current url params
  var urlParams = Object.fromEntries(new URLSearchParams(window.location.search));
  var updatedParams = _objectSpread(_objectSpread({}, defaultParams), urlParams);

  // Storage parameters take precedence over defaults
  var paramsRef = (0,_vueuse_core__WEBPACK_IMPORTED_MODULE_11__.useStorage)('invoiceList:params', defaultParams, localStorage, {
    mergeDefaults: true
  });
  var params = (0,vue__WEBPACK_IMPORTED_MODULE_5__.reactive)(paramsRef.value);
  var loading = (0,vue__WEBPACK_IMPORTED_MODULE_5__.reactive)({
    loading: true
  });
  var result = (0,vue__WEBPACK_IMPORTED_MODULE_5__.ref)(0);
  var search = /*#__PURE__*/function () {
    var _ref = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2() {
      var invoiceIndex;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            (0,_helpers_meilisearch__WEBPACK_IMPORTED_MODULE_8__.updateListUrl)(params);
            invoiceIndex = (0,_api_meilisearch_useMeiliSearchIndex_js__WEBPACK_IMPORTED_MODULE_7__.useMeiliSearchIndex)('invoices');
            _context2.next = 6;
  ...
  var sort = /*#__PURE__*/function () {
    var _ref2 = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee3(sortColumn, sortDirection) {
