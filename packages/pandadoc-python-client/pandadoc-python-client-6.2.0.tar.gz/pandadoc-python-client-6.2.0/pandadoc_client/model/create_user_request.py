...
def lazy_import():
    ...
    globals()['CreateUserRequestUser'] = CreateUserRequestUser
    globals()['CreateUserRequestWorkspaces'] = CreateUserRequestWorkspaces
...
class CreateUserRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'user': (CreateUserRequestUser,),  # noqa: E501
            'workspaces': ([CreateUserRequestWorkspaces],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, workspaces, license, *args, **kwargs):  # noqa: E501
        """CreateUserRequest - a model defined in OpenAPI

        Args:
            user (CreateUserRequestUser):
            workspaces ([CreateUserRequestWorkspaces]): Info for adding a user to a workspace(s)
            license (str):
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, workspaces, license, *args, **kwargs):  # noqa: E501
        """CreateUserRequest - a model defined in OpenAPI
