...
def download_dataset(
    ...
    while not downloaded and attempts > 0:
        headers = {"Authorization": f"ACCESS_TOKEN {session._access_token}"}
...
def get_datasets(
    ...
    headers = {
        "Authorization": f"ACCESS_TOKEN {session._access_token}",
...
class DataCenter:
    ...
    def upload_dataset(
        ...
        with open(tmpfile, "rb") as fh:
            ...
            headers = {"Authorization": f"ACCESS_TOKEN {self._access_token}"}
            data = {
                "remotepath": remotepath,
                "comments": comments,
                "public": public,
